...
(function() {
  ...
  // Duck punch of $.ui.mouse _mouseInit and _mouseDestroy method to support touch events.
  // "Duck punch" is a technique of modifying runtime code without altering the original
  // source.  It relies on duck typing.  If it walks like a duck and talks like a duck,
  // then it must be a duck.  Punch the duck until it makes the noise you want.
  ...
  // Duck punch of $.ui.draggable _mouseCapture to exclude an "oj-resizable-handle" selector check.
  // The forked resizable uses oj-resizable-handle. Draggable checks for ui-resizable-handle.
  // This exta check helps prevent drag and resize from fighting each other.
  var _draggableProto = $.ui["draggable"].prototype ? $.ui["draggable"].prototype : {}.prototype;
  var _draggableMouseCapture = _mouseProto["_mouseCapture"];

  _draggableProto["_mouseCapture"] = function(event)
  {
    if ($(event.target).is(".oj-resizable-handle"))
      return false;
    else
      return _draggableMouseCapture.call(this, event);
  };
  ...
  oj.__registerWidget("oj.ojResizable", $['oj']['baseComponent'], {
    ...
    _ComponentCreate: function()
    {
      ...
      this.element['mouse']("option", "cancel", o["cancel"]);
  ...
  oj.__registerWidget("oj.ojDialog", $['oj']['baseComponent'], {
    ...
    _makeDraggable: function() {
      ...
      this.uiDialog.draggable({
        ...
        addClasses: false,
        cancel: ".oj-resize-handle .oj-dialog-content, .oj-dialog-header-close",
        handle: ".oj-dialog-header",
        containment: "document",
        start: function(event, ui) {

          that.uiDialog.addClass("oj-dialog-dragging");
          that._blockFrames();
        ...
        stop: function(event, ui) {
          ...
          that.uiDialog.removeClass("oj-dialog-dragging");
          that._unblockFrames();
          that._positionDescendents();
