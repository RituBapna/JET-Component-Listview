 ...
 */
"use strict";
define(['ojs/ojcore', 'jquery', 'ojs/ojcomponentcore', 'ojs/ojdomscroller', 'promise'], function(oj, $)
{
/**
...
/** @lends oj._ojListView.prototype */
{
    ...
    _buildList: function(root)
    {
        ...
        // touch specific instruction text for screen reader
    ...
    {
        var totalHeight = 0, animationPromise, animationResolve;
        ...
        if (animate)
        {
            ...
            // Resolve animationPromise in m_expandTransitionEndListener()
            groupItem.on("transitionend", {'animationResolve': animationResolve}, this.m_expandTransitionEndListener);
    ...
    {
        var groupItem, item, animationResolve;
        ...
        this.AnimateExpandComplete(groupItem);
        animationResolve = event.data["animationResolve"];
        animationResolve(null); // resolve animationPromise
    ...
    {
        var totalHeight = 0, groupItem, animationPromise, animationResolve, self = this;
        ...
        if (animate)
        {
            ...
            // resolve animationPromise in m_collapseTransitionEndListener
            groupItem.on("transitionend", {'animationResolve': animationResolve}, this.m_collapseTransitionEndListener);
