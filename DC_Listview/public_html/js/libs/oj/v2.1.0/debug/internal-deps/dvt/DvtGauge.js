...
DvtGaugeDefaults.SKIN_ALTA = {
  ...
  'color': '#393737',
  'metricLabel': {'style': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;")},
  '_statusMessageStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"),
  'title': {'style': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;")},
...
DvtGaugeDefaults.VERSION_1 = {
  ...
  'metricLabel': {
    'rendered': 'auto',
    'scaling': 'auto',
    'style': new dvt.CSSStyle('font-family: tahoma, sans-serif;'),
    'textType': 'number'
  },
  '_statusMessageStyle': new dvt.CSSStyle('font-family: tahoma, sans-serif;'),
  'title': {
    'style': new dvt.CSSStyle('font-family: tahoma, sans-serif;'),
    'position': 'auto'
  },
...
DvtStatusMeterGaugeDefaults.VERSION_1 = {
  ...
  'indicatorSize': 1,
  'innerRadius': .7,
  'metricLabel': {'style': new dvt.CSSStyle('font-family: tahoma, sans-serif;'), 'position': 'auto'},
...
DvtDialGaugeDefaults.VERSION_1 = {
  ...
  'tickLabel': {
    'scaling': 'auto',
    'style': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;")
  }
};
/**
...
DvtRatingGaugeRenderer._createShapes = function(gauge, container, stateOptions) {
  ...
  for (var i = 0; i < options['max']; i++) {
    ...
    if (stateOptions['source'])
      shape = new dvt.ImageMarker(context, cx + shapeWidth / 2, cy + shapeHeight / 2, shapeWidth, shapeHeight, stateOptions['source']);
