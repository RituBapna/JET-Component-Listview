...
DvtNBoxDefaults.VERSION_1 = {
  ...
  'styleDefaults': {
    ...
    'columnLabelStyle': new dvt.CSSStyle('font-size: 12px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
    'rowLabelStyle': new dvt.CSSStyle('font-size: 12px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
    'columnsTitleStyle': new dvt.CSSStyle('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
    'rowsTitleStyle': new dvt.CSSStyle('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
    'cellDefaults': {'style': new dvt.CSSStyle('background-color:#e9e9e9'),
      ...
      'labelStyle': new dvt.CSSStyle('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;font-weight:bold'),
      'countLabelStyle': new dvt.CSSStyle('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
      'bodyCountLabelStyle': new dvt.CSSStyle('color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
    ...
    '__drawerDefaults': {'background': '#e9e9e9',
      ...
      'labelStyle': new dvt.CSSStyle('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;font-weight:bold'),
      'countLabelStyle': new dvt.CSSStyle('font-size: 14px; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;font-weight:bold'),
      'countBorderRadius': 1},
    'nodeDefaults': {'color': '#FFFFFF',
      'labelStyle': new dvt.CSSStyle('font-size: 12px; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
      'secondaryLabelStyle': new dvt.CSSStyle('font-size: 11px; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'),
      'alphaFade': 0.2,
      'borderRadius': 1,
      'hoverColor': '#FFFFFF',
    ...
    '__legendDefaults': {'sectionStyle': 'font-size: 12px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif; font-weight:bold',
      ...
      'markerColor': '#808080'},
    '__categoryNodeDefaults': {'labelStyle': new dvt.CSSStyle('font-family:"Helvetica Neue", Helvetica, Arial, sans-serif')}
  },
  '__layout': {
    'componentGap': 8,
    'titleGap': 4,
 ...
 * @class
 */
var DvtNBoxNode = function DvtNBoxNode() {};

// TODO NAMESPACE: getTypeName is failing if the type isn't defined here, but it works for other classes in the toolkit. Investigate.
...
DvtNBoxNodeRenderer._renderNodeIndicator = function(nbox, node, nodeContainer, nodeLayout) {
  ...
  if (indicatorIcon) {
    ...
    if (indicatorIcon[dvt.NBoxConstants.SOURCE]) {
      ...
      if (indicatorIconBorderRadius)
        indicatorMarker.setBorderRadius(indicatorIconBorderRadius);
    }
    else {
...
DvtNBoxNodeRenderer._renderNodeIcon = function(nbox, node, nodeContainer, nodeLayout) {
  ...
  if (icon) {
    ...
    if (icon[dvt.NBoxConstants.SOURCE]) {
      ...
      if (iconBorderRadius)
        iconMarker.setBorderRadius(iconBorderRadius);
    }
    else {
