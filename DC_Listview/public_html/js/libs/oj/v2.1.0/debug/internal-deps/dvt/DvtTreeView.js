...
DvtTreeDefaults.VERSION_1 = {
  ...
  'nodeDefaults': {
    'labelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 11px;")
  },
  'selectionMode': 'multiple',
  'sorting': 'off',
  '_statusMessageStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"),
  'styleDefaults': {
    '_attributeTypeTextStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;font-weight:bold;color:#4F4F4F"),
    '_attributeValueTextStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;"),
    '_currentTextStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;"),
    '_drillTextStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;font-size:12px;"),
    '_labelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;")
  },
  'touchResponse' : 'auto',
...
DvtTreemapDefaults.VERSION_1 = {
  ...
  'nodeDefaults': {
    'header': {
      ...
      'isolate': 'auto',
      'labelHalign': 'start',
      'labelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px;color:#252525;"),
      'selectedBackgroundColor': '#dae9f5',
      'selectedInnerColor': '#FFFFFF',
      'selectedOuterColor': '#000000',
      'useNodeColor': 'off',

      '_hoverLabelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px;color:#252525;"),
      '_selectedLabelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px;color:#252525;"),

      '_drillableLabelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; color:#145c9e;"),
      '_drillableHoverLabelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; color:#145c9e;"),
      '_drillableSelectedLabelStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px; color:#145c9e;")
    },
    'hoverColor': '#ebeced',
