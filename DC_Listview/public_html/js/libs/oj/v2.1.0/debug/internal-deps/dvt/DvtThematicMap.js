...
DvtThematicMapJsonParser.prototype._createMarker = function(layer, dataLayer, data, isParentAreaDataLayer) {
  ...
  var marker;
  if (data['source']) {
    marker = new dvt.ImageMarker(this._tmap.getCtx(), center.x, center.y, w * sx, h * sy,
    ...
    marker = new dvt.SimpleMarker(this._tmap.getCtx(), shapeType, this._tmap.getSkinName(), center.x, center.y, w * sx, h * sy);
  }
