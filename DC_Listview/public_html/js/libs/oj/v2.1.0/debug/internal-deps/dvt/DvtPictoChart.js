...
DvtPictoChartDefaults.VERSION_1 = {
  ...
  '_gapRatio': 0.25,
  '_textStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 13px; color: #252525;"),
...
var DvtPictoChartShapeMarker = function(picto, shape, cx, cy, width, height, id) {
  DvtPictoChartShapeMarker.superclass.Init.call(this, picto.getCtx(), shape, dvt.CSSStyle.SKIN_ALTA, cx, cy, width, height, true, id);
  this._picto = picto;
};
