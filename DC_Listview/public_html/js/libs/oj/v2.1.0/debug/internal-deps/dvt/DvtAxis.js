...
DvtAxisDefaults.SKIN_ALTA = {
  ...
  'tickLabel': {'style': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; white-space:normal;")},
  'titleStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 12px;")
};
...
DvtAxisDefaults.VERSION_1 = {
  ...
  'tickLabel': {
    'scaling': 'auto',
    'style': new dvt.CSSStyle('font-family: tahoma, sans-serif; font-size: 11px; color: #333333;'), 'rotation': 'auto', 'rendered': 'on'
  },
  'titleStyle': new dvt.CSSStyle('font-family: tahoma, sans-serif; font-size: 11px; color: #737373;'),
