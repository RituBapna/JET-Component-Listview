...
dvt.TimelineOverview.prototype.addMarker = function(node, sz)
{
  ...
  var displayable = new dvt.SimpleMarker(this.getCtx(), marker, null, cx, cy, width, height, null, itemId);
...
dvt.TimelineOverview.prototype.applyState = function(drawable, state)
{
  ...
  if (requiresBorderMarker)
  {
    ...
    if (borderMarker == null)
    {
      ...
      borderMarker = new dvt.SimpleMarker(this.getCtx(), markerType, null, cx, cy, width, height, null, drawable.getId() + '_border');
    ...
    if (requiresGlowMarker)
    {
      if (glowMarker == null)
      {
        ...
        glowMarker = new dvt.SimpleMarker(this.getCtx(), markerType, null, cx, cy, width, height, null, drawable.getId() + '_glow');
