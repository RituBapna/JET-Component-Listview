...
DvtLegendDefaults.SKIN_ALTA = {
  ...
  'textStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"),
  'titleStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 11px; color: #333333;"),
  '_sectionTitleStyle': new dvt.CSSStyle("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size: 11px; color: #333333;")
};
...
DvtLegendDefaults.VERSION_1 = {
  ...
  'borderColor': null,
  'textStyle': new dvt.CSSStyle('font-family: tahoma, sans-serif; font-size: 11px; color: #333333;'),
  'titleStyle': new dvt.CSSStyle('font-family: tahoma, sans-serif; font-size: 12px; color: #003d5b;'),
  'titleHalign': 'start',
  'hiddenCategories': [],
...
DvtLegendRenderer._createImage = function(legend, x, y, symbolWidth, symbolHeight, rowHeight, item) {
  ...
  return new dvt.Image(context, item['source'], x, imageY, symbolWidth, symbolHeight);
};
