...
define(["ojs/ojcore", "jquery", "knockout", "ojs/ojknockout", "ojs/ojmessaging"], function($oj$$8$$, $$$$8$$, $ko$$2$$) {
  ...
  $oj$$8$$.$ValueBinding$.$_update$ = function $$oj$$8$$$$ValueBinding$$$_update$$($name$$103$$, $value$$174$$, $element$$61_updateProps$$1$$, $component$$9$$, $ictObs_valueAccessor$$16$$) {
    $element$$61_updateProps$$1$$ = {};
    ...
    if ($name$$103$$ === $oj$$8$$.$ValueBinding$.$_OPTION_DISABLED$ || $name$$103$$ === $oj$$8$$.$ValueBinding$.$_OPTION_READONLY$) {
      return $icTracker$$ = $ictObs_valueAccessor$$16$$ && $ictObs_valueAccessor$$16$$.peek() || null, null !== $icTracker$$ && $ko$$2$$.isWriteableObservable($ictObs_valueAccessor$$16$$) && $icTracker$$.$_update$.call($icTracker$$, $component$$9$$, $name$$103$$, $value$$174$$) && $ictObs_valueAccessor$$16$$.valueHasMutated(), $element$$61_updateProps$$1$$[$name$$103$$] = $value$$174$$, $element$$61_updateProps$$1$$;
    }
  };
  ...
  $oj$$8$$.$ValueBinding$.$_afterCreate$ = function $$oj$$8$$$$ValueBinding$$$_afterCreate$$($property$$18$$, $element$$62$$, $component$$10$$, $optionsSet_valueAccessor$$17$$) {
    $optionsSet_valueAccessor$$17$$ = $optionsSet_valueAccessor$$17$$.call();
    var $isICTOptionSet$$;
    $property$$18$$ === $oj$$8$$.$ValueBinding$.$_ATTRIBUTE_INVALID_COMPONENT_TRACKER$ && ($isICTOptionSet$$ = $optionsSet_valueAccessor$$17$$[$property$$18$$] ? !0 : !1) && $oj$$8$$.$ValueBinding$.$_registerInvalidComponentTrackerWriteback$($property$$18$$, $optionsSet_valueAccessor$$17$$, $element$$62$$, $component$$10$$);
    return{};
  };
  $oj$$8$$.$ValueBinding$.$_beforeDestroy$ = function $$oj$$8$$$$ValueBinding$$$_beforeDestroy$$($icTracker$$1_property$$19$$, $element$$63_jelem$$7$$, $component$$11$$, $ictObs$$1_valueAccessor$$18$$) {
    $element$$63_jelem$$7$$ = $$$$8$$($element$$63_jelem$$7$$);
    $ictObs$$1_valueAccessor$$18$$ = $ictObs$$1_valueAccessor$$18$$.call()[$icTracker$$1_property$$19$$];
    $icTracker$$1_property$$19$$ === $oj$$8$$.$ValueBinding$.$_ATTRIBUTE_INVALID_COMPONENT_TRACKER$ && $element$$63_jelem$$7$$ && ($element$$63_jelem$$7$$.off($oj$$8$$.$ValueBinding$.$_EVENT_OPTIONCHANGE$, $oj$$8$$.$ValueBinding$.$_updateInvalidComponentTracker$), $ictObs$$1_valueAccessor$$18$$ && $ko$$2$$.isWriteableObservable($ictObs$$1_valueAccessor$$18$$) && ($icTracker$$1_property$$19$$ = $ictObs$$1_valueAccessor$$18$$.peek(), $icTracker$$1_property$$19$$.$_remove$.call($icTracker$$1_property$$19$$, 
    $component$$11$$) && $ictObs$$1_valueAccessor$$18$$.valueHasMutated()));
  };
  $oj$$8$$.$ValueBinding$.$_updateInvalidComponentTracker$ = function $$oj$$8$$$$ValueBinding$$$_updateInvalidComponentTracker$$($event$$73$$, $JSCompiler_OptimizeArgumentsArray_p0$$) {
    var $ictObs$$2$$ = $event$$73$$.data.$tracker$, $icTracker$$2$$, $component$$12$$ = $event$$73$$.data.$component$, $option$$26$$ = $JSCompiler_OptimizeArgumentsArray_p0$$.option, $msgs$$6$$ = $JSCompiler_OptimizeArgumentsArray_p0$$.value;
  ...
  $oj$$8$$.$ValueBinding$.$_registerInvalidComponentTrackerWriteback$ = function $$oj$$8$$$$ValueBinding$$$_registerInvalidComponentTrackerWriteback$$($ictObs$$3_property$$20$$, $messagesShown_options$$215$$, $element$$64_jElem$$, $component$$13_eventData$$3$$) {
    $ictObs$$3_property$$20$$ = $messagesShown_options$$215$$[$ictObs$$3_property$$20$$];
    var $messagesHidden$$, $icTracker$$3$$;
    $element$$64_jElem$$ = $$$$8$$($element$$64_jElem$$);
  ...
  $oj$$8$$.$InvalidComponentTracker$.prototype.$focusOnFirstInvalid$ = function $$oj$$8$$$$InvalidComponentTracker$$$$focusOnFirstInvalid$$() {
    var $firstInvalid$$ = null, $self$$53$$ = this, $updateCounter$$ = this.$_updateCounter$;
    this.invalidShown && ($firstInvalid$$ = this.$_getFirstInvalidComponent$());
    setTimeout(function() {
      ($firstInvalid$$ = $updateCounter$$ === $self$$53$$.$_updateCounter$ ? $firstInvalid$$ || $self$$53$$.$_getFirstInvalidComponent$() : $self$$53$$.$_getFirstInvalidComponent$()) && $firstInvalid$$.call($firstInvalid$$, "Focus");
    }, 1);
