  ...
  (function() {
    ...
    $_DATA_ATTR_PAGE_NUM$:"data-oj-pagenum", $_OPTION_ENABLED$:"enabled", $_OPTION_DISABLED$:"disabled", $_TAB_INDEX$:"tabindex", $_MODE$:{$_LOAD_MORE$:"loadMore", $_PAGE$:"page"}, $_PAGE_OPTION_LAYOUT$:{$_AUTO$:"auto", $_ALL$:"all", $_INPUT$:"input", $_RANGE_TEXT$:"rangeText", $_PAGES$:"pages", $_NAV$:"nav"}, $_PAGE_OPTION_DEFAULT_MAX_PAGE_LINKS$:6, $_TYPE$:{$_NUMBERS$:"numbers", $_DOTS$:"dots"}, firstPage:function() {
      ...
      if (null != this.$_getData$()) {
        ...
        if (this.$_isTotalSizeConfidenceActual$() && $page$$1$$ + 1 <= this.$_getTotalPages$() - 1 || 0 > this.$_getTotalPages$() || !this.$_isTotalSizeConfidenceActual$()) {
    ...
    }, $_events$:{"mouseup .oj-pagingcontrol-loadmore-link":function($event$$74$$) {
      this.loadNext();
      $$$$10$$($event$$74$$.target).data("_mouseup", !0);
      $event$$74$$.preventDefault();
    }, "click .oj-pagingcontrol-loadmore-link":function($event$$75$$) {
      $$$$10$$($event$$75$$.target).data("_mouseup") ? $$$$10$$($event$$75$$.target).data("_mouseup", !1) : this.loadNext();
      $event$$75$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-dot":function($event$$76$$) {
      var $pageNum$$ = $$$$10$$($event$$76$$.currentTarget).attr("data-oj-pagenum"), $self$$54$$ = this;
      this.page($pageNum$$).then(function() {
        $self$$54$$ = null;
      }, function($err$$8$$) {
        var $errSummary$$1$$ = $self$$54$$.$getTranslatedString$($self$$54$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
        $oj$$10$$.$Logger$.error($errSummary$$1$$ + "\n" + $err$$8$$);
        $self$$54$$ = null;
      });
      $event$$76$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-page":function($event$$77$$) {
      var $pageNum$$1$$ = $$$$10$$($event$$77$$.currentTarget).attr("data-oj-pagenum"), $self$$55$$ = this;
      this.page($pageNum$$1$$).then(function() {
        $self$$55$$ = null;
      }, function($err$$9$$) {
        var $errSummary$$2$$ = $self$$55$$.$getTranslatedString$($self$$55$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
        $oj$$10$$.$Logger$.error($errSummary$$2$$ + "\n" + $err$$9$$);
        $self$$55$$ = null;
      });
      $event$$77$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-first":function($event$$78$$) {
      if (!$$$$10$$($event$$78$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$56$$ = this;
        this.firstPage().then(function() {
          $self$$56$$ = null;
        }, function($err$$10$$) {
          var $errSummary$$3$$ = $self$$56$$.$getTranslatedString$($self$$56$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$3$$ + "\n" + $err$$10$$);
          $self$$56$$ = null;
        });
      }
      $event$$78$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-previous":function($event$$79$$) {
      if (!$$$$10$$($event$$79$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$57$$ = this;
        this.previousPage().then(function() {
          $self$$57$$ = null;
        }, function($err$$11$$) {
          var $errSummary$$4$$ = $self$$57$$.$getTranslatedString$($self$$57$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$4$$ + "\n" + $err$$11$$);
          $self$$57$$ = null;
        });
      }
      $event$$79$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-next":function($event$$80$$) {
      if (!$$$$10$$($event$$80$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$58$$ = this;
        this.nextPage().then(function() {
          $self$$58$$ = null;
        }, function($err$$12$$) {
          var $errSummary$$5$$ = $self$$58$$.$getTranslatedString$($self$$58$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$5$$ + "\n" + $err$$12$$);
          $self$$58$$ = null;
        });
      }
      $event$$80$$.preventDefault();
    }, "click .oj-pagingcontrol-nav-last":function($event$$81$$) {
      if (!$$$$10$$($event$$81$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$)) {
        var $self$$59$$ = this;
        this.lastPage().then(function() {
          $self$$59$$ = null;
        }, function($err$$13$$) {
          var $errSummary$$6$$ = $self$$59$$.$getTranslatedString$($self$$59$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
          $oj$$10$$.$Logger$.error($errSummary$$6$$ + "\n" + $err$$13$$);
          $self$$59$$ = null;
        });
      }
      $event$$81$$.preventDefault();
    }, "keypress .oj-pagingcontrol-nav-input":function($event$$82$$) {
      13 == $event$$82$$.which && $event$$82$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-first":function($event$$83$$) {
    ...
    }, "mousedown .oj-pagingcontrol-nav-previous":function($event$$84$$) {
      $$$$10$$($event$$84$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$84$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$84$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-next":function($event$$85$$) {
      $$$$10$$($event$$85$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$85$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$85$$.preventDefault();
    }, "mousedown .oj-pagingcontrol-nav-last":function($event$$86$$) {
      $$$$10$$($event$$86$$.currentTarget).hasClass(this.$_MARKER_STYLE_CLASSES$.$_DISABLED$) || $$$$10$$($event$$86$$.target).addClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$86$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-first":function($event$$87$$) {
      $$$$10$$($event$$87$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$87$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-previous":function($event$$88$$) {
      $$$$10$$($event$$88$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$88$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-next":function($event$$89$$) {
      $$$$10$$($event$$89$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$89$$.preventDefault();
    }, "mouseup .oj-pagingcontrol-nav-last":function($event$$90$$) {
      $$$$10$$($event$$90$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$90$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-first":function($event$$91$$) {
      $$$$10$$($event$$91$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$91$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-previous":function($event$$92$$) {
      $$$$10$$($event$$92$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$92$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-next":function($event$$93$$) {
      $$$$10$$($event$$93$$.target).removeClass(this.$_MARKER_STYLE_CLASSES$.$_ACTIVE$);
      $event$$93$$.preventDefault();
    }, "mouseleave .oj-pagingcontrol-nav-last":function($event$$94$$) {
      ...
      this.$_queueRefresh$();
    }, $_handleDataPage$:function($event$$96$$) {
      $event$$96$$.page != $event$$96$$.previousPage && this.$_queueRefresh$();
    }, $_handleDataReset$:function() {
      this.$_invokeDataPage$(0, !1);
    }, $_handleDataRefresh$:function() {
      this.$_queueRefresh$();
    }, $_handleDataSort$:function($event$$99$$) {
      this.options.mode == this.$_MODE$.$_LOAD_MORE$ && this.$_handleDataReset$($event$$99$$);
    }, $_handleDataRowAdd$:function($event$$100$$) {
      this.options.mode == this.$_MODE$.$_PAGE$ && this.$_isOperationOnCurrentPage$($event$$100$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handleDataRowRemove$:function($event$$101$$) {
      0 < this.$_getTotalPages$() && this.$_getCurrentPage$() > this.$_getTotalPages$() - 1 ? this.$_invokeDataPage$(this.$_getTotalPages$() - 1, !0) : this.$_isOperationOnCurrentPage$($event$$101$$) ? this.$_invokeDataPage$(this.$_getCurrentPage$(), !0) : this.$_queueRefresh$();
    }, $_handlePageChange$:function($event$$102$$, $data$$69$$) {
      var $page$$5$$ = $data$$69$$.value;
      if ($page$$5$$ != this.$_getCurrentPage$() + 1 && !isNaN($page$$5$$) && 0 < $page$$5$$) {
        var $page$$5$$ = Math.round($page$$5$$), $self$$61$$ = this;
        this.page($page$$5$$ - 1).then(function() {
          $self$$61$$ = null;
        }, function($err$$14$$) {
          var $errSummary$$7$$ = $self$$61$$.$getTranslatedString$($self$$61$$.$_BUNDLE_KEY$.$_ERR_PAGE_INVALID_SUMMARY$);
      ...
      var $data$$70$$ = this.$_getData$(), $self$$62$$ = this;
      return new Promise(function($resolve$$24$$, $reject$$24$$) {
        null != $data$$70$$ ? ($data$$70$$.setPage($page$$6$$, {pageSize:$self$$62$$.options.pageSize}).then(function() {
          $resolve$$24$$(null);
        }, function($error$$24$$) {
          $reject$$24$$($error$$24$$);
        }), $self$$62$$ = $data$$70$$ = null) : ($self$$62$$ = null, $resolve$$24$$(null));
      });
      ...
      if (!this.$_isTotalSizeConfidenceActual$() || $data$$71$$.totalSize() > this.$_currentStartIndex$ && this.$_isTotalSizeConfidenceActual$()) {
        ...
        return new Promise(function($resolve$$25$$, $reject$$25$$) {
          $data$$71$$.fetch({startIndex:$self$$63$$.$_currentStartIndex$, pageSize:$pageSize$$}).then(function($result$$28$$) {
            $resolve$$25$$($result$$28$$);
          }, function() {
            $reject$$25$$(null);
          });
          $self$$63$$ = $data$$71$$ = null;
        });
      }
      return Promise.resolve();
    }, $_isOperationOnCurrentPage$:function($event$$103$$) {
      var $data$$72$$ = this.$_getData$(), $pageSize$$1$$ = this.options.pageSize, $i$$134$$;
      for ($i$$134$$ = 0;$i$$134$$ < $event$$103$$.indexes.length;$i$$134$$++) {
        var $rowIdx$$ = $event$$103$$.indexes[$i$$134$$], $startIndex$$4$$ = $data$$72$$.getStartItemIndex(), $endIndex$$ = $startIndex$$4$$ + $pageSize$$1$$;
      ...
      this.$_pendingPageFetch$ = this.$_pendingPageFetch$.then(function() {
        $self$$64$$.$_pageFetchCount$--;
        if (0 == $self$$64$$.$_pageFetchCount$ && !$self$$64$$.$_componentDestroyed$) {
          $self$$64$$.$_pendingPageFetch$ = void 0;
          var $data$$74$$ = $self$$64$$.$_getData$();
          null != $data$$74$$ && $data$$74$$.setPage($self$$64$$.$_pageFetchLatestPage$, {pageSize:$self$$64$$.options.pageSize}).then(function() {
            $self$$64$$ = $data$$74$$ = null;
          }, function($error$$26$$) {
            $self$$64$$.$_pageFetchCount$--;
            0 >= $self$$64$$.$_pageFetchCount$ && ($self$$64$$.$_pendingPageFetch$ = void 0, $oj$$10$$.$Logger$.error($error$$26$$), $self$$64$$ = null);
          });
        }
      }, function($error$$27$$) {
        $self$$64$$.$_pageFetchCount$--;
        0 >= $self$$64$$.$_pageFetchCount$ && ($self$$64$$.$_pendingPageFetch$ = void 0, $oj$$10$$.$Logger$.error($error$$27$$), $self$$64$$ = null);
      });
      ...
      this.$_pendingRefreshes$ = this.$_pendingRefreshes$.then(function() {
        $self$$65$$.$_refreshCount$--;
        0 != $self$$65$$.$_refreshCount$ || $self$$65$$.$_componentDestroyed$ || ($self$$65$$.$_pendingRefreshes$ = void 0, $self$$65$$.$_refresh$(), $self$$65$$._trigger("ready"), $self$$65$$ = null);
      }, function($error$$28$$) {
        $self$$65$$.$_refreshCount$--;
        0 == $self$$65$$.$_refreshCount$ && ($self$$65$$.$_pendingRefreshes$ = void 0, $oj$$10$$.$Logger$.error($error$$28$$), $self$$65$$ = null);
      });
      ...
      if (!this.$_isResizeListenerAdded$) {
        var $self$$66$$ = this;
        $oj$$10$$.$DomUtils$.$addResizeListener$($element$$65$$[0], function() {
          $self$$66$$.$_queueRefresh$();
        }, 50);
      ...
      if ($oj$$10$$.$DomUtils$.$isTouchSupported$() && this.options.mode == this.$_MODE$.$_PAGE$) {
        ...
        if (null != $pagingControlNavArrowSection$$2$$) {
          ...
          if ("vertical" == this.options.pageOptions.orientation) {
            ...
            this.$_hammerSwipeUp$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipeup", function($event$$104$$) {
              $event$$104$$.preventDefault();
              $self$$67$$.nextPage();
            });
            this.$_hammerSwipeDown$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipedown", function($event$$105$$) {
              $event$$105$$.preventDefault();
              $self$$67$$.previousPage();
            });
          } else {
            $options$$218$$ = {recognizers:[[$Hammer$$2$$.Swipe, {direction:$Hammer$$2$$.DIRECTION_HORIZONTAL}]]}, this.$_hammerSwipeLeft$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swipeleft", function($event$$106$$) {
              $event$$106$$.preventDefault();
              $self$$67$$.nextPage();
            }), this.$_hammerSwipeRight$ = $pagingControlNavArrowSection$$2$$.$ojHammer$($options$$218$$).on("swiperight", function($event$$107$$) {
      ...
      $parent$$8$$.find("*").each(function() {
        $self$$68$$.$_UnregisterChildNode$(this);
      });
      $self$$68$$ = null;
      ...
      if (0 <= $currentPage_pageAfterCurrent$$) {
        ...
        $numLinks_pageList$$.sort(function($a$$83$$, $b$$57$$) {
          return $a$$83$$ - $b$$57$$;
        });
