...
D.$DvtTreemap$$ = function $$DvtTreemap$$$($context$$656$$, $callback$$178$$, $callbackObj$$125$$) {
  this.Init($context$$656$$, $callback$$178$$, $callbackObj$$125$$)
};
(0,D.$goog$exportPath_$$)("DvtTreemap", D.$DvtTreemap$$);
D.$DvtObj$$.$createSubclass$(D.$DvtTreemap$$, D.$DvtBaseTreeView$$, "DvtTreemap");
D.$DvtTreemap$$.newInstance = function $$DvtTreemap$$$newInstance$($context$$657$$, $callback$$179$$, $callbackObj$$126$$) {
  return new D.$DvtTreemap$$($context$$657$$, $callback$$179$$, $callbackObj$$126$$)
};
D.$JSCompiler_prototypeAlias$$ = D.$DvtTreemap$$.prototype;
D.$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$658$$, $callback$$180$$, $callbackObj$$127$$) {
  D.$DvtTreemap$$.$superclass$.Init.call(this, $context$$658$$, $callback$$180$$, $callbackObj$$127$$);
...
D.$JSCompiler_prototypeAlias$$.$ApplyParsedProperties$ = function $$JSCompiler_prototypeAlias$$$$ApplyParsedProperties$$($options$$318_props$$24$$) {
  ...
  this.$_layout$ = "sliceAndDiceHorizontal" == $options$$318_props$$24$$.layout ? new D.$DvtSliceAndDiceLayout$$(D.$JSCompiler_alias_TRUE$$) : "sliceAndDiceVertical" == $options$$318_props$$24$$.layout ? new D.$DvtSliceAndDiceLayout$$(D.$JSCompiler_alias_FALSE$$) : new D.$DvtSquarifyingLayout$$;
  this.$_isolatedNodes$ = [];
  var $isolateRowKey$$inline_9231$$ = $options$$318_props$$24$$.isolatedNode;
  if($isolateRowKey$$inline_9231$$ && this.$_root$) {
    var $allNodes$$inline_9232$$ = (0,D.$JSCompiler_StaticMethods_getDescendantNodes$$)(this.$_root$);
    $allNodes$$inline_9232$$.push(this.$_root$);
    for(var $i$$inline_9233$$ = 0;$i$$inline_9233$$ < $allNodes$$inline_9232$$.length;$i$$inline_9233$$++) {
      if($allNodes$$inline_9232$$[$i$$inline_9233$$].getId() == $isolateRowKey$$inline_9231$$) {
        this.$_isolatedNodes$.push($allNodes$$inline_9232$$[$i$$inline_9233$$]);
        break
      }
    }
  }
...
D.$JSCompiler_prototypeAlias$$.$Layout$ = function $$JSCompiler_prototypeAlias$$$$Layout$$($availSpace$$135$$) {
  ...
  if(0 < $bufferSpace$$1_gap$$31_numIsolated$$ && this.$_isolateRestoreLayout$) {
    this.$_layout$.$layout$(this, this.$_isolatedNodes$[$bufferSpace$$1_gap$$31_numIsolated$$ - 1], $availSpace$$135$$.x, $availSpace$$135$$.y, $availSpace$$135$$.$w$, $availSpace$$135$$.$h$, D.$JSCompiler_alias_TRUE$$)
  }else {
    this.$_root$ && this.$_layout$.$layout$(this, this.$_root$, $availSpace$$135$$.x, $availSpace$$135$$.y, $availSpace$$135$$.$w$, $availSpace$$135$$.$h$, D.$JSCompiler_alias_FALSE$$);
    for(var $i$$921$$ = 0;$i$$921$$ < $bufferSpace$$1_gap$$31_numIsolated$$;$i$$921$$++) {
      this.$_layout$.$layout$(this, this.$_isolatedNodes$[$i$$921$$], $availSpace$$135$$.x, $availSpace$$135$$.y, $availSpace$$135$$.$w$, $availSpace$$135$$.$h$, D.$JSCompiler_alias_TRUE$$)
    }
  }
};
D.$JSCompiler_prototypeAlias$$.$Render$ = function $$JSCompiler_prototypeAlias$$$$Render$$($container$$222_i$$922$$) {
  (0,D.$JSCompiler_StaticMethods_RenderBackground$$)(this, $container$$222_i$$922$$);
  this.$_breadcrumbs$ && $container$$222_i$$922$$.$addChild$(this.$_breadcrumbs$);
  this.$_legend$ && ($container$$222_i$$922$$.$addChild$(this.$_legend$), this.$_legend$ = D.$JSCompiler_alias_NULL$$);
  if((0,D.$JSCompiler_StaticMethods_HasValidData$$)(this)) {
    this.$_groupTextLayer$ = new D.$DvtContainer$$(this.$getCtx$());
    $container$$222_i$$922$$.$addChild$(this.$_groupTextLayer$);
    this.$_isolatedNode$ ? this.$_isolatedNode$.$render$($container$$222_i$$922$$) : this.$_root$.$hasChildren$() ? (this.$_root$.$renderChildren$($container$$222_i$$922$$), (0,D.$JSCompiler_StaticMethods_UpdateAriaNavigation$$)(this, this.$_root$)) : this.$_root$.$render$($container$$222_i$$922$$);
    this.$_isolatedLayer$ = new D.$DvtContainer$$(this.$getCtx$());
    $container$$222_i$$922$$.$addChild$(this.$_isolatedLayer$);
    this.$_selectedLayer$ = new D.$DvtContainer$$(this.$getCtx$());
    $container$$222_i$$922$$.$addChild$(this.$_selectedLayer$);
    $container$$222_i$$922$$.$addChild$(this.$_groupTextLayer$);
    ...
    $container$$222_i$$922$$.$addChild$(this.$_hoverEffect$);
    for($container$$222_i$$922$$ = 0;$container$$222_i$$922$$ < this.$_isolatedNodes$.length;$container$$222_i$$922$$++) {
      var $displayable$$118$$ = this.$_isolatedNodes$[$container$$222_i$$922$$].$getDisplayable$();
      this.$_isolatedLayer$.$addChild$($displayable$$118$$)
    }
  }else {
    (0,D.$JSCompiler_StaticMethods_RenderEmptyText$$)(this, $container$$222_i$$922$$)
  }
};
...
D.$JSCompiler_prototypeAlias$$.$CreateEventManager$ = function $$JSCompiler_prototypeAlias$$$$CreateEventManager$$($view$$68$$, $context$$659$$, $callback$$181$$, $callbackObj$$128$$) {
  return new D.$DvtTreemapEventManager$$($view$$68$$, $context$$659$$, $callback$$181$$, $callbackObj$$128$$)
};
...
D.$JSCompiler_prototypeAlias$$.$__moveToSelectedLayer$ = function $$JSCompiler_prototypeAlias$$$$__moveToSelectedLayer$$($rect$$51$$) {
  for(var $newIndex$$9$$ = 0, $numChildren$$17$$ = this.$_selectedLayer$.$getNumChildren$(), $i$$924$$ = 0;$i$$924$$ < $numChildren$$17$$;$i$$924$$++) {
    ...
    $rect$$51$$.zIndex > $child$$83$$.zIndex && ($newIndex$$9$$ = $i$$924$$ + 1)
  }
  $newIndex$$9$$ < $numChildren$$17$$ ? this.$_selectedLayer$.$addChildAt$($rect$$51$$, $newIndex$$9$$) : this.$_selectedLayer$.$addChild$($rect$$51$$)
};
D.$JSCompiler_prototypeAlias$$.$__getNodeUnderPoint$ = function $$JSCompiler_prototypeAlias$$$$__getNodeUnderPoint$$($x$$315$$, $y$$282$$) {
  return 0 < this.$_isolatedNodes$.length ? this.$_isolatedNodes$[this.$_isolatedNodes$.length - 1].$getNodeUnderPoint$($x$$315$$, $y$$282$$) : this.$_root$.$getNodeUnderPoint$($x$$315$$, $y$$282$$)
};
...
D.$JSCompiler_StaticMethods__renderIsolateRestore$$ = function $$JSCompiler_StaticMethods__renderIsolateRestore$$$($JSCompiler_StaticMethods__renderIsolateRestore$self$$, $node$$345$$) {
  if("none" != $JSCompiler_StaticMethods__renderIsolateRestore$self$$.$getOptions$().animationOnDataChange) {
    for(var $playables$$inline_9248_selectedNodes$$3$$ = $JSCompiler_StaticMethods__renderIsolateRestore$self$$.$_selectionHandler$ ? $JSCompiler_StaticMethods__renderIsolateRestore$self$$.$_selectionHandler$.getSelection() : [], $descendants$$inline_9249_i$$925$$ = 0;$descendants$$inline_9249_i$$925$$ < $playables$$inline_9248_selectedNodes$$3$$.length;$descendants$$inline_9249_i$$925$$++) {
      $playables$$inline_9248_selectedNodes$$3$$[$descendants$$inline_9249_i$$925$$].$setSelected$(D.$JSCompiler_alias_FALSE$$)
    }
    for(var $playables$$inline_9248_selectedNodes$$3$$ = [(0,D.$JSCompiler_StaticMethods__getIsolateAnimation$$)($node$$345$$)], $descendants$$inline_9249_i$$925$$ = (0,D.$JSCompiler_StaticMethods_getDescendantNodes$$)($node$$345$$), $i$$inline_9250$$ = 0;$i$$inline_9250$$ < $descendants$$inline_9249_i$$925$$.length;$i$$inline_9250$$++) {
      $playables$$inline_9248_selectedNodes$$3$$.push((0,D.$JSCompiler_StaticMethods__getIsolateAnimation$$)($descendants$$inline_9249_i$$925$$[$i$$inline_9250$$]))
    }
    $JSCompiler_StaticMethods__renderIsolateRestore$self$$.$Animation$ = new D.$DvtParallelPlayable$$($JSCompiler_StaticMethods__renderIsolateRestore$self$$.$getCtx$(), $playables$$inline_9248_selectedNodes$$3$$);
...
D.$DvtTreemapNode$$ = function $$DvtTreemapNode$$$($treemap$$, $props$$25$$) {
  ...
  this.$_bIsolated$ = $options$$320$$.isolatedNode != D.$JSCompiler_alias_NULL$$ && $options$$320$$.isolatedNode == this.getId()
};
...
D.$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$) {
  if(this.$_hasLayout$) {
    this.$_shape$ = this.$_createShapeNode$();
    $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$.$addChild$(this.$_shape$);
    ...
    if($afRoot$$11_template$$25$$) {
      ...
      0 < $aw$$4_elAttrs$$2$$ && 0 < $ah$$6$$ && ((0,D.$JSCompiler_StaticMethods_setAvailableWidth$$)($afContext$$64$$, $aw$$4_elAttrs$$2$$), (0,D.$JSCompiler_StaticMethods_setAvailableHeight$$)($afContext$$64$$, $ah$$6$$), $afContext$$64$$.$setFontSize$((0,D.$JSCompiler_StaticMethods_GetTextSize$$)(this)), this.$_contentRoot$ = $afRoot$$11_template$$25$$ = D.$DvtAfComponentFactory$$.$parseAndLayout$($afContext$$64$$, $afRoot$$11_template$$25$$, this.$_shape$), (0,D.$DvtAgent$isRightToLeft$$)($container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$.$getCtx$()) ? 
      ($container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$ = $afRoot$$11_template$$25$$.$getDimensions$(), $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$ = this.$_x$ + this.$_width$ - 4 - 1 - $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$.$w$) : $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$ = this.$_x$ + 4 + 1, (0,D.$JSCompiler_StaticMethods_setTranslate$$)($afRoot$$11_template$$25$$, $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$, 
      this.$_y$ + 2 + 1))
    }else {
      this.$_text$ = this.$_createTextNode$(this.$_shape$), this.$_text$ != D.$JSCompiler_alias_NULL$$ && (this.$_pattern$ && "header" != this.$_textStyle$) && ($container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$ = this.$_text$.$measureDimensions$(), this.$_textBackground$ = new D.$DvtRect$$(this.$_view$.$getCtx$(), $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$.x, $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$.y, $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$.$w$, 
      $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$.$h$), this.$_textBackground$.$setSolidFill$("#FFFFFF"), this.$_textBackground$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), this.$_shape$.$addChild$(this.$_textBackground$), $container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$ = this.$_text$, "node" == this.$_textStyle$ && this.$hasChildren$() ? this.$_view$.$_groupTextLayer$.$addChild$($container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$) : this.$_shape$.$addChild$($container$$223_dim$$89_dims$$72_text$$inline_9264_transX$$9$$))
    }
...
D.$JSCompiler_prototypeAlias$$.$setSelected$ = function $$JSCompiler_prototypeAlias$$$$setSelected$$($nodeDefaults$$4_parentNode$$18_selected$$48$$) {
  ...
  if(this.$_shape$) {
    ...
    if(this.$isSelected$()) {
      var $x$$316$$ = this.$_x$, $y$$283$$ = this.$_y$ + 1, $w$$74$$ = this.$_width$ - 1, $h$$68$$ = this.$_height$ - 1;
      (0,D.$DvtAgent$isPlatformWebkit$$)() && ($y$$283$$ -= 1);
      ...
      this.$_selectionOuter$ = new D.$DvtRect$$(this.$_view$.$getCtx$(), $x$$316$$, $y$$283$$, $w$$74$$, $h$$68$$);
      ...
      this.$_selectionInner$ = new D.$DvtRect$$(this.$_view$.$getCtx$(), $x$$316$$ + 1, $y$$283$$ + 1, $w$$74$$ - 2, $h$$68$$ - 2);
      ...
      D.$JSCompiler_alias_NULL$$))) : ((0,D.$JSCompiler_StaticMethods_removeAllDrawEffects$$)(this.$_shape$), this.$_selectionOuter$ && ((0,D.$JSCompiler_StaticMethods__removeChildShape$$)(this, this.$_selectionOuter$), this.$_selectionOuter$ = D.$JSCompiler_alias_NULL$$), ($nodeDefaults$$4_parentNode$$18_selected$$48$$ = this.$_parent$) && $nodeDefaults$$4_parentNode$$18_selected$$48$$.$_childNodeGroup$ && $nodeDefaults$$4_parentNode$$18_selected$$48$$.$_childNodeGroup$.$addChild$(this.$_shape$))
    }
  }
};
D.$JSCompiler_prototypeAlias$$.$showHoverEffect$ = function $$JSCompiler_prototypeAlias$$$$showHoverEffect$$() {
  if(this.$_shape$ && this.$_hasLayout$) {
    var $nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$ = this.$_view$.$getOptions$().nodeDefaults, $JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$ = $nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$.header, $isolatedNode_points$$80$$ = (0,D.$JSCompiler_StaticMethods___getLastIsolatedNode$$)(this.$_view$);
    if(!($isolatedNode_points$$80$$ != D.$JSCompiler_alias_NULL$$ && $isolatedNode_points$$80$$ != this && !this.$isDescendantOf$($isolatedNode_points$$80$$))) {
      var $isolatedNode_points$$80$$ = [], $x1$$58_y$$284$$, $w$$75_y1$$48$$, $h$$69_x2$$55$$, $y2$$45$$;
      "header" == this.$_textStyle$ ? (this.$_innerShape$.$setSolidFill$($JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$.hoverBackgroundColor), this.$_selectionOuter$ || ($nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$ = this.$_x$, $x1$$58_y$$284$$ = this.$_y$ + 1, $w$$75_y1$$48$$ = this.$_width$ - 1, $h$$69_x2$$55$$ = this.$_height$ - 1, (0,D.$DvtAgent$isPlatformWebkit$$)() && ($x1$$58_y$$284$$ -= 1), this.$_selectionOuter$ = new D.$DvtRect$$(this.$_view$.$getCtx$(), 
      $nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$, $x1$$58_y$$284$$, $w$$75_y1$$48$$, $h$$69_x2$$55$$), this.$_selectionOuter$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), this.$_selectionOuter$.$setFill$(D.$JSCompiler_alias_NULL$$), (0,D.$JSCompiler_StaticMethods_setPixelHinting$$)(this.$_selectionOuter$), this.$_shape$.$addChild$(this.$_selectionOuter$)), this.$_selectionOuter$.$setSolidStroke$(this.$isSelected$() ? $JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$.selectedOuterColor : 
      $JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$.hoverOuterColor), $x1$$58_y$$284$$ = this.$_x$ + 1.5 + 1, $h$$69_x2$$55$$ = this.$_x$ + this.$_width$ - 1.5 - 1, $w$$75_y1$$48$$ = this.$_y$ + this.$_titleBarHeight$, $y2$$45$$ = this.$_y$ + this.$_height$ - 1.5 - 1, $isolatedNode_points$$80$$.push($h$$69_x2$$55$$, $w$$75_y1$$48$$, $h$$69_x2$$55$$, $y2$$45$$, $x1$$58_y$$284$$, $y2$$45$$, $x1$$58_y$$284$$, $w$$75_y1$$48$$), $nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$ = 
      new D.$DvtSolidStroke$$($JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$.hoverInnerColor, 0.8, 3), this.$_text$ && (this.$isDrillReplaceEnabled$() ? (0,D.$JSCompiler_StaticMethods_ApplyHeaderTextStyle$$)(this, this.$_text$, "_drillableHoverLabelStyle") : (0,D.$JSCompiler_StaticMethods_ApplyHeaderTextStyle$$)(this, this.$_text$, "_hoverLabelStyle"))) : ($x1$$58_y$$284$$ = this.$_x$ + 1, $h$$69_x2$$55$$ = this.$_x$ + this.$_width$ - 1, $w$$75_y1$$48$$ = this.$_y$ + 
      1, $y2$$45$$ = this.$_y$ + this.$_height$ - 1, $isolatedNode_points$$80$$.push(this.$_x$, $w$$75_y1$$48$$, $h$$69_x2$$55$$, $w$$75_y1$$48$$, $h$$69_x2$$55$$, $y2$$45$$, $x1$$58_y$$284$$, $y2$$45$$, $x1$$58_y$$284$$, $w$$75_y1$$48$$), $nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$ = new D.$DvtSolidStroke$$($nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$.hoverColor, 1, 2));
      $JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$ = this.$_view$;
      $JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$.$_hoverEffect$.$setPoints$($isolatedNode_points$$80$$);
      $JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$.$_hoverEffect$.$setStroke$($nodeDefaults$$5_stroke$$122_stroke$$inline_9268_x$$317$$);
      $JSCompiler_StaticMethods___showHoverEffect$self$$inline_9266_nodeHeaderDefaults$$1$$.$_hoverEffect$.$setVisible$(D.$JSCompiler_alias_TRUE$$)
    }
  }
};
...
D.$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($event$$828_lastChild$$2_next$$20$$) {
  var $keyCode$$56_navigables$$16_parent$$96$$;
  if($event$$828_lastChild$$2_next$$20$$.type == D.$DvtMouseEvent$CLICK$$) {
    return D.$DvtTreemapNode$$.$superclass$.$getNextNavigable$.call(this, $event$$828_lastChild$$2_next$$20$$)
  }
  $keyCode$$56_navigables$$16_parent$$96$$ = $event$$828_lastChild$$2_next$$20$$.keyCode;
  if(32 == $keyCode$$56_navigables$$16_parent$$96$$ && $event$$828_lastChild$$2_next$$20$$.ctrlKey) {
    return this
  }
  if(38 == $keyCode$$56_navigables$$16_parent$$96$$ && $event$$828_lastChild$$2_next$$20$$.altKey || 221 == $keyCode$$56_navigables$$16_parent$$96$$) {
    ($keyCode$$56_navigables$$16_parent$$96$$ = this.$_parent$) && $keyCode$$56_navigables$$16_parent$$96$$.getId() != this.$_view$.$_root$.getId() ? ($event$$828_lastChild$$2_next$$20$$ = $keyCode$$56_navigables$$16_parent$$96$$, (0,D.$JSCompiler_StaticMethods_MarkAsLastVisitedChild$$)($keyCode$$56_navigables$$16_parent$$96$$)) : $event$$828_lastChild$$2_next$$20$$ = this
  }else {
    if(40 == $keyCode$$56_navigables$$16_parent$$96$$ && $event$$828_lastChild$$2_next$$20$$.altKey || 219 == $keyCode$$56_navigables$$16_parent$$96$$) {
      $event$$828_lastChild$$2_next$$20$$ = ($event$$828_lastChild$$2_next$$20$$ = this.$_lastVisitedChild$) ? $event$$828_lastChild$$2_next$$20$$ : this.$hasChildren$() ? (0,D.$JSCompiler_StaticMethods___getDefaultNavigable$$)(this.$_view$, this.$getChildNodes$()) : this
    }else {
      ...
      $event$$828_lastChild$$2_next$$20$$ = (0,D.$DvtKeyboardHandler$getNextNavigable$$)(this, $event$$828_lastChild$$2_next$$20$$, $keyCode$$56_navigables$$16_parent$$96$$)
    }
  }
  (0,D.$JSCompiler_StaticMethods_MarkAsLastVisitedChild$$)($event$$828_lastChild$$2_next$$20$$);
  return $event$$828_lastChild$$2_next$$20$$
};
...
D.$JSCompiler_prototypeAlias$$.$setLayoutParams$ = function $$JSCompiler_prototypeAlias$$$$setLayoutParams$$($headerLabelHeight_text$$116_x$$318_xx$$65$$, $y$$285_yy$$65$$, $width$$194_ww$$121$$, $height$$173_hh$$105$$) {
  if(!(0 >= $width$$194_ww$$121$$ || 0 >= $height$$173_hh$$105$$)) {
    this.$_hasLayout$ = D.$JSCompiler_alias_TRUE$$;
    this.$_oldState$ = this.$GetAnimationParams$();
    this.$_x$ = $headerLabelHeight_text$$116_x$$318_xx$$65$$;
    this.$_y$ = $y$$285_yy$$65$$;
    this.$_width$ = $width$$194_ww$$121$$ ? $width$$194_ww$$121$$ : 0;
    this.$_height$ = $height$$173_hh$$105$$ ? $height$$173_hh$$105$$ : 0;
    ...
    if("header" == this.$_textStyle$) {
      ...
      $headerLabelHeight_text$$116_x$$318_xx$$65$$ = new D.$DvtOutputText$$(this.$_view$.$getCtx$(), this.$_textStr$);
      $headerLabelHeight_text$$116_x$$318_xx$$65$$.$setFontSize$((0,D.$JSCompiler_StaticMethods_GetTextSize$$)(this));
      (0,D.$JSCompiler_StaticMethods_ApplyHeaderTextStyle$$)(this, $headerLabelHeight_text$$116_x$$318_xx$$65$$, "labelStyle");
      $headerLabelHeight_text$$116_x$$318_xx$$65$$ = D.$DvtTextUtils$$.$guessTextDimensions$($headerLabelHeight_text$$116_x$$318_xx$$65$$).$h$;
      this.$_titleBarHeight$ = window.Math.max(this.$_titleBarHeight$, $headerLabelHeight_text$$116_x$$318_xx$$65$$);
      this.$isIsolateEnabled$() && (this.$_titleBarHeight$ = window.Math.max(this.$_titleBarHeight$, 15));
      $headerLabelHeight_text$$116_x$$318_xx$$65$$ = this.$_x$;
      $y$$285_yy$$65$$ = this.$_y$ + this.$_titleBarHeight$;
      $width$$194_ww$$121$$ = this.$_width$;
      $height$$173_hh$$105$$ = this.$_height$ - this.$_titleBarHeight$;
      if(0 <= $width$$194_ww$$121$$ && 0 <= $height$$173_hh$$105$$) {
        return new D.$DvtRectangle$$($headerLabelHeight_text$$116_x$$318_xx$$65$$, $y$$285_yy$$65$$, $width$$194_ww$$121$$, $height$$173_hh$$105$$)
      }
...
D.$JSCompiler_prototypeAlias$$.$getNodeUnderPoint$ = function $$JSCompiler_prototypeAlias$$$$getNodeUnderPoint$$($x$$319$$, $y$$286$$) {
  if(this.contains($x$$319$$, $y$$286$$) || !this.$_hasLayout$) {
    for(var $childNodes$$26$$ = this.$getChildNodes$(), $i$$927$$ = 0;$i$$927$$ < $childNodes$$26$$.length;$i$$927$$++) {
      if($childNodes$$26$$[$i$$927$$].contains($x$$319$$, $y$$286$$)) {
        return $childNodes$$26$$[$i$$927$$].$getNodeUnderPoint$($x$$319$$, $y$$286$$)
      }
    }
    if(this.$_hasLayout$) {
      return this
...
D.$JSCompiler_prototypeAlias$$.contains = function $$JSCompiler_prototypeAlias$$$contains$($x$$320$$, $y$$287$$) {
  return $x$$320$$ >= this.$_x$ && $x$$320$$ <= this.$_x$ + this.$_width$ && $y$$287$$ >= this.$_y$ && $y$$287$$ <= this.$_y$ + this.$_height$
};
...
D.$JSCompiler_prototypeAlias$$.$SetAnimationParams$ = function $$JSCompiler_prototypeAlias$$$$SetAnimationParams$$($params$$60$$) {
  this.$setLayoutParams$($params$$60$$[0], $params$$60$$[1], $params$$60$$[2], $params$$60$$[3]);
  this.$_color$ = D.$DvtColorUtils$$.$makeRGB$(window.Math.round($params$$60$$[4]), window.Math.round($params$$60$$[5]), window.Math.round($params$$60$$[6]));
...
D.$DvtTreemapNode$$.prototype.$_createShapeNode$ = function $$DvtTreemapNode$$$$$_createShapeNode$$() {
  ...
  if("header" == this.$_textStyle$) {
    $shape$$94$$ = new D.$DvtRect$$($context$$661$$, this.$_x$, this.$_y$, this.$_width$, this.$_height$), this.$_innerShape$ = new D.$DvtRect$$($context$$661$$, this.$_x$ + 1, this.$_y$ + 1, this.$_width$ - 2, this.$_height$ - 2), (0,D.$JSCompiler_StaticMethods_ApplyHeaderStyle$$)(this, $shape$$94$$, this.$_innerShape$), this.$_innerShape$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), $shape$$94$$.$addChild$(this.$_innerShape$), this.$_bIsolated$ && (this.$_isolateButton$ = (0,D.$JSCompiler_StaticMethods__createIsolateRestoreButton$$)(this, 
    $shape$$94$$))
  }else {
    ...
    if((1E3 > this.$_view$.$_nodeCount$ || !(0,D.$DvtAgent$isTouchDevice$$)()) && 2 <= this.$_width$ && 2 <= this.$_height$) {
      ...
      4 <= $minDim$$1$$ ? ($shape$$94$$.$setSolidFill$($bottomRightColor_fillColor$$12$$), this.$_topLeftShape$ = new D.$DvtRect$$($context$$661$$, this.$_x$, this.$_y$, this.$_width$ - 1, this.$_height$ - 1), this.$_topLeftShape$.$setSolidFill$($topLeftColor$$), this.$_topLeftShape$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), $shape$$94$$.$addChild$(this.$_topLeftShape$), this.$_fillShape$ = new D.$DvtRect$$($context$$661$$, this.$_x$ + 1, this.$_y$ + 1, this.$_width$ - 2, this.$_height$ - 2), 
      this.$_fillShape$.$setFill$($fill$$77$$), this.$_fillShape$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), $shape$$94$$.$addChild$(this.$_fillShape$)) : 2 <= $minDim$$1$$ ? ($shape$$94$$.$setSolidFill$($bottomRightColor_fillColor$$12$$), this.$_fillShape$ = new D.$DvtRect$$($context$$661$$, this.$_x$, this.$_y$, this.$_width$ - 1, this.$_height$ - 1), this.$_fillShape$.$setFill$($fill$$77$$), this.$_fillShape$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), $shape$$94$$.$addChild$(this.$_fillShape$)) : 
  ...
  this.$isSelectable$() ? $shape$$94$$.$setSelectable$(D.$JSCompiler_alias_TRUE$$) : $shape$$94$$.setCursor("default");
...
D.$JSCompiler_StaticMethods__createIsolateRestoreButton$$ = function $$JSCompiler_StaticMethods__createIsolateRestoreButton$$$($JSCompiler_StaticMethods__createIsolateRestoreButton$self$$, $container$$224$$) {
  ...
  var $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$ = D.$JSCompiler_alias_NULL$$, $transX$$10_x1$$59$$ = $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_x$, $x2$$56$$ = $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_x$ + $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_width$ - 1, $rect$$52_tooltip$$50_y1$$49$$ = $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_y$ + 1, 
  ...
  if(12 < $x2$$56$$ - $transX$$10_x1$$59$$ - 2) {
    if($JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_bIsolated$) {
      var $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$ = $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getCtx$(), $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ = (0,D.$DvtAgent$isRightToLeft$$)($JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_context$), $resources$$inline_9277_resources$$inline_9288$$ = $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getOptions$()._resources, 
      $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$ = $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ && $resources$$inline_9277_resources$$inline_9288$$.restoreDownRtl ? $resources$$inline_9277_resources$$inline_9288$$.restoreDownRtl : $resources$$inline_9277_resources$$inline_9288$$.restoreDown, $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$ = $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ && 
      $resources$$inline_9277_resources$$inline_9288$$.restoreOverRtl ? $resources$$inline_9277_resources$$inline_9288$$.restoreOverRtl : $resources$$inline_9277_resources$$inline_9288$$.restoreOver, $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ = new D.$DvtImage$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ && 
      $resources$$inline_9277_resources$$inline_9288$$.restoreRtl ? $resources$$inline_9277_resources$$inline_9288$$.restoreRtl : $resources$$inline_9277_resources$$inline_9288$$.restore, 0, 0, 12, 12), $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$ = new D.$DvtImage$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$, 
      0, 0, 12, 12), $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$ = new D.$DvtImage$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$, 0, 0, 12, 12);
      (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$);
      (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$);
      (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$);
      $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$ = new D.$DvtButton$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$, $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$, $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$);
      $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$.$addEvtListener$(D.$DvtMouseEvent$CLICK$$, $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$__restoreNode$, D.$JSCompiler_alias_FALSE$$, $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$)
    }else {
      $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$ = $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getCtx$(), $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ = (0,D.$DvtAgent$isRightToLeft$$)($JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_context$), $resources$$inline_9277_resources$$inline_9288$$ = $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getOptions$()._resources, 
      $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$ = $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ && $resources$$inline_9277_resources$$inline_9288$$.isolateDownRtl ? $resources$$inline_9277_resources$$inline_9288$$.isolateDownRtl : $resources$$inline_9277_resources$$inline_9288$$.isolateDown, $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$ = $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ && 
      $resources$$inline_9277_resources$$inline_9288$$.isolateOverRtl ? $resources$$inline_9277_resources$$inline_9288$$.isolateOverRtl : $resources$$inline_9277_resources$$inline_9288$$.isolateOver, $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ = new D.$DvtImage$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$ && 
      $resources$$inline_9277_resources$$inline_9288$$.isolateRtl ? $resources$$inline_9277_resources$$inline_9288$$.isolateRtl : $resources$$inline_9277_resources$$inline_9288$$.isolate, 0, 0, 12, 12), $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$ = new D.$DvtImage$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$, 
      0, 0, 12, 12), $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$ = new D.$DvtImage$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$, 0, 0, 12, 12), (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$), (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$), 
      (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$), $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$ = new D.$DvtButton$$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $bRtl$$inline_9276_bRtl$$inline_9287_upState$$inline_9280_upState$$inline_9291$$, $overImage$$inline_9278_overImage$$inline_9289_overState$$inline_9281_overState$$inline_9292$$, 
      $downImage$$inline_9279_downImage$$inline_9290_downState$$inline_9282_downState$$inline_9293$$), $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$.$addEvtListener$(D.$DvtMouseEvent$CLICK$$, $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$__isolateNode$, D.$JSCompiler_alias_FALSE$$, $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$)
    }
    $transX$$10_x1$$59$$ = (0,D.$DvtAgent$isRightToLeft$$)($container$$224$$.$getCtx$()) ? $transX$$10_x1$$59$$ + 1 : $x2$$56$$ - 12 - 1;
    (0,D.$JSCompiler_StaticMethods_setTranslate$$)($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $transX$$10_x1$$59$$, ($y2$$46$$ + $rect$$52_tooltip$$50_y1$$49$$ - 12) / 2);
    $container$$224$$.$addChild$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$);
    (0,D.$DvtAgent$isTouchDevice$$)() && ($rect$$52_tooltip$$50_y1$$49$$ = new D.$DvtRect$$($container$$224$$.$getCtx$(), -2, -2, 16, 16), (0,D.$JSCompiler_StaticMethods_setInvisibleFill$$)($rect$$52_tooltip$$50_y1$$49$$), $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$.$addChild$($rect$$52_tooltip$$50_y1$$49$$));
    (0,D.$DvtCSSStyle$afterSkinAlta$$)($JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getOptions$().skin) ? $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getEventManager$().$associate$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$) : ($rect$$52_tooltip$$50_y1$$49$$ = (0,D.$DvtBundle$getTranslation$$)($JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getOptions$(), 
    $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_bIsolated$ ? "tooltipRestore" : "tooltipIsolate", "DvtTreemapBundle", $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_bIsolated$ ? "RESTORE" : "ISOLATE"), $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.$_view$.$getEventManager$().$associate$($JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$, new D.$DvtBaseTreePeer$$($JSCompiler_StaticMethods__createIsolateRestoreButton$self$$, 
    $JSCompiler_StaticMethods__createIsolateRestoreButton$self$$.getId(), $rect$$52_tooltip$$50_y1$$49$$)))
  }
  return $JSCompiler_temp$$164_button$$76_button$$inline_9283_button$$inline_9294_context$$inline_9275_context$$inline_9286$$
};
...
D.$DvtTreemapNode$$.prototype.$_createTextNode$ = function $$DvtTreemapNode$$$$$_createTextNode$$($container$$225$$) {
  ...
  if($text$$117$$ != D.$JSCompiler_alias_NULL$$) {
    return"header" == this.$_textStyle$ && this.$isDrillReplaceEnabled$() ? ((0,D.$JSCompiler_StaticMethods_ApplyHeaderTextStyle$$)(this, $text$$117$$, "_drillableLabelStyle"), $text$$117$$.setCursor("pointer"), $chromeAdjustment_isRTL$$65_peer$$34_textHeight$$4$$ = new D.$DvtBaseTreePeer$$(this, this.getId(), D.$JSCompiler_alias_NULL$$, this.$getDatatip$(), this.$getDatatipColor$()), $chromeAdjustment_isRTL$$65_peer$$34_textHeight$$4$$.$setDrillable$(D.$JSCompiler_alias_TRUE$$), this.$_view$.$getEventManager$().$associate$($text$$117$$, 
    $chromeAdjustment_isRTL$$65_peer$$34_textHeight$$4$$)) : $text$$117$$.$setMouseEnabled$(D.$JSCompiler_alias_FALSE$$), D.$DvtTextUtils$$.$fitText$($text$$117$$, $availWidth$$20$$, $availHeight$$13$$, $container$$225$$) ? $text$$117$$ : D.$JSCompiler_alias_NULL$$
  }
};
...
D.$JSCompiler_prototypeAlias$$.$__isolateNode$ = function $$JSCompiler_prototypeAlias$$$$__isolateNode$$($event$$829$$) {
  ...
  var $JSCompiler_StaticMethods___isolate$self$$inline_9296$$ = this.$_view$, $currentNavigable$$inline_9298_displayable$$inline_9299$$ = $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$getEventManager$().$getFocus$();
  $currentNavigable$$inline_9298_displayable$$inline_9299$$ && $currentNavigable$$inline_9298_displayable$$inline_9299$$.$hideKeyboardFocusEffect$();
  $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$_isolatedNodes$.push(this);
  $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$getOptions$().isolatedNode = this.getId();
  $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.dispatchEvent(new D.$DvtTreemapIsolateEvent$$(this.getId()));
  $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$_isolateRestoreLayout$ = D.$JSCompiler_alias_TRUE$$;
  $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$Layout$(new D.$DvtRectangle$$(0, 0, $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$Width$, $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$Height$));
  $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$_isolateRestoreLayout$ = D.$JSCompiler_alias_FALSE$$;
  $currentNavigable$$inline_9298_displayable$$inline_9299$$ = this.$getDisplayable$();
  $JSCompiler_StaticMethods___isolate$self$$inline_9296$$.$_isolatedLayer$.$addChild$($currentNavigable$$inline_9298_displayable$$inline_9299$$);
  (0,D.$JSCompiler_StaticMethods__renderIsolateRestore$$)($JSCompiler_StaticMethods___isolate$self$$inline_9296$$, this);
...
D.$JSCompiler_prototypeAlias$$.$__restoreNode$ = function $$JSCompiler_prototypeAlias$$$$__restoreNode$$($event$$830$$) {
  ...
  this.$hideHoverEffect$();
  var $JSCompiler_StaticMethods___restore$self$$inline_9301$$ = this.$_view$, $restoreNode$$inline_9302$$ = $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$_isolatedNodes$.pop();
  $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$getOptions$().isolatedNode = 0 < $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$_isolatedNodes$.length ? $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$_isolatedNodes$[$JSCompiler_StaticMethods___restore$self$$inline_9301$$.$_isolatedNodes$.length - 1].getId() : D.$JSCompiler_alias_NULL$$;
  var $currentNavigable$$inline_9303_id$$inline_11635$$ = $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$getEventManager$().$getFocus$();
  $currentNavigable$$inline_9303_id$$inline_11635$$ && $currentNavigable$$inline_9303_id$$inline_11635$$.$hideKeyboardFocusEffect$();
  $currentNavigable$$inline_9303_id$$inline_11635$$ = $restoreNode$$inline_9302$$.getId();
  $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$_navigableIdToFocus$ = $currentNavigable$$inline_9303_id$$inline_11635$$;
  $JSCompiler_StaticMethods___restore$self$$inline_9301$$.dispatchEvent(new D.$DvtTreemapIsolateEvent$$);
  $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$_isolateRestoreLayout$ = D.$JSCompiler_alias_TRUE$$;
  $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$Layout$(new D.$DvtRectangle$$(0, 0, $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$Width$, $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$Height$));
  $JSCompiler_StaticMethods___restore$self$$inline_9301$$.$_isolateRestoreLayout$ = D.$JSCompiler_alias_FALSE$$;
  (0,D.$JSCompiler_StaticMethods__renderIsolateRestore$$)($JSCompiler_StaticMethods___restore$self$$inline_9301$$, $restoreNode$$inline_9302$$);
  (0,D.$JSCompiler_StaticMethods__removeIsolateRestoreButton$$)(this);
  this.$UpdateAriaLabel$();
  $event$$830$$ && $event$$830$$.stopPropagation()
};
D.$JSCompiler_prototypeAlias$$.$getDatatip$ = function $$JSCompiler_prototypeAlias$$$$getDatatip$$($target$$126$$, $x$$321$$, $y$$288$$) {
  return $target$$126$$ && $target$$126$$ instanceof D.$DvtButton$$ ? D.$JSCompiler_alias_NULL$$ : D.$DvtTreemapNode$$.$superclass$.$getDatatip$.call(this, $target$$126$$, $x$$321$$, $y$$288$$)
};
D.$JSCompiler_prototypeAlias$$.$getDatatipColor$ = function $$JSCompiler_prototypeAlias$$$$getDatatipColor$$($target$$127$$) {
  return $target$$127$$ && $target$$127$$ instanceof D.$DvtButton$$ ? D.$JSCompiler_alias_NULL$$ : D.$DvtTreemapNode$$.$superclass$.$getDatatipColor$.call(this, $target$$127$$)
};
D.$JSCompiler_prototypeAlias$$.$getTooltip$ = function $$JSCompiler_prototypeAlias$$$$getTooltip$$($target$$128$$) {
  return $target$$128$$ && $target$$128$$ instanceof D.$DvtButton$$ ? (0,D.$DvtBundle$getTranslation$$)(this.$_view$.$getOptions$(), this.$_bIsolated$ ? "tooltipRestore" : "tooltipIsolate", "DvtTreemapBundle", this.$_bIsolated$ ? "RESTORE" : "ISOLATE") : D.$JSCompiler_alias_NULL$$
};
...
D.$JSCompiler_StaticMethods_setNodeBounds$$ = function $$JSCompiler_StaticMethods_setNodeBounds$$$($JSCompiler_StaticMethods_setNodeBounds$self_gap$$30$$, $availBounds_node$$340$$, $x$$309$$, $y$$276$$, $width$$188$$, $height$$167$$, $isRoot$$2_xx$$64$$) {
  ...
  if(!$isRoot$$2_xx$$64$$ || !$availBounds_node$$340$$.$hasChildren$()) {
    ...
    var $yy$$64$$ = window.Math.round($y$$276$$ + $JSCompiler_StaticMethods_setNodeBounds$self_gap$$30$$);
    if($availBounds_node$$340$$ = $availBounds_node$$340$$.$setLayoutParams$($isRoot$$2_xx$$64$$, $yy$$64$$, window.Math.round($x$$309$$ + $width$$188$$ - $JSCompiler_StaticMethods_setNodeBounds$self_gap$$30$$) - $isRoot$$2_xx$$64$$, window.Math.round($y$$276$$ + $height$$167$$ - $JSCompiler_StaticMethods_setNodeBounds$self_gap$$30$$) - $yy$$64$$)) {
      return $availBounds_node$$340$$
    }
  }
  return new D.$DvtRectangle$$($x$$309$$, $y$$276$$, $width$$188$$, $height$$167$$)
};
...
D.$DvtSquarifyingLayout$$.prototype.$layout$ = function $$DvtSquarifyingLayout$$$$$layout$$($view$$67$$, $root$$37$$, $x$$312$$, $y$$279$$, $width$$191$$, $height$$170$$, $bShowRoot$$2$$) {
  this.$_layout$($root$$37$$, $x$$312$$, $y$$279$$, $width$$191$$, $height$$170$$, $bShowRoot$$2$$ ? D.$JSCompiler_alias_FALSE$$ : D.$JSCompiler_alias_TRUE$$)
};
D.$DvtSquarifyingLayout$$.prototype.$_layout$ = function $$DvtSquarifyingLayout$$$$$_layout$$($children$$26_node$$342$$, $availBounds$$2_x$$313$$, $children$$inline_9210_w$$70_y$$280$$, $i$$inline_9213_width$$192$$, $area$$inline_9211_factor$$inline_9214_height$$171$$, $child$$inline_9215_isRoot$$6_total$$inline_9212$$) {
  $availBounds$$2_x$$313$$ = (0,D.$JSCompiler_StaticMethods_setNodeBounds$$)(this, $children$$26_node$$342$$, $availBounds$$2_x$$313$$, $children$$inline_9210_w$$70_y$$280$$, $i$$inline_9213_width$$192$$, $area$$inline_9211_factor$$inline_9214_height$$171$$, $child$$inline_9215_isRoot$$6_total$$inline_9212$$);
  $children$$26_node$$342$$ = $children$$26_node$$342$$.$getChildNodes$();
  if($children$$26_node$$342$$ != D.$JSCompiler_alias_NULL$$ && 0 < $children$$26_node$$342$$.length) {
    $children$$inline_9210_w$$70_y$$280$$ = $children$$26_node$$342$$;
    $area$$inline_9211_factor$$inline_9214_height$$171$$ = $availBounds$$2_x$$313$$.$w$ * $availBounds$$2_x$$313$$.$h$;
    for($i$$inline_9213_width$$192$$ = $i$$inline_9213_width$$192$$ = $child$$inline_9215_isRoot$$6_total$$inline_9212$$ = 0;$i$$inline_9213_width$$192$$ < $children$$inline_9210_w$$70_y$$280$$.length;$i$$inline_9213_width$$192$$++) {
      $child$$inline_9215_isRoot$$6_total$$inline_9212$$ += 0 < $children$$inline_9210_w$$70_y$$280$$[$i$$inline_9213_width$$192$$].$getSize$() ? $children$$inline_9210_w$$70_y$$280$$[$i$$inline_9213_width$$192$$].$getSize$() : 0
    }
    $area$$inline_9211_factor$$inline_9214_height$$171$$ = 0 == $area$$inline_9211_factor$$inline_9214_height$$171$$ ? 0 : $area$$inline_9211_factor$$inline_9214_height$$171$$ / $child$$inline_9215_isRoot$$6_total$$inline_9212$$;
    for($i$$inline_9213_width$$192$$ = 0;$i$$inline_9213_width$$192$$ < $children$$inline_9210_w$$70_y$$280$$.length;$i$$inline_9213_width$$192$$++) {
      $child$$inline_9215_isRoot$$6_total$$inline_9212$$ = $children$$inline_9210_w$$70_y$$280$$[$i$$inline_9213_width$$192$$], $child$$inline_9215_isRoot$$6_total$$inline_9212$$.$__pxSize$ = $child$$inline_9215_isRoot$$6_total$$inline_9212$$.$getSize$() * $area$$inline_9211_factor$$inline_9214_height$$171$$
    }
    $children$$26_node$$342$$ = $children$$26_node$$342$$.slice(0).sort(function($children$$26_node$$342$$, $availBounds$$2_x$$313$$) {
      return $children$$26_node$$342$$.$getSize$() - $availBounds$$2_x$$313$$.$getSize$()
    });
    $children$$inline_9210_w$$70_y$$280$$ = window.Math.min($availBounds$$2_x$$313$$.$w$, $availBounds$$2_x$$313$$.$h$);
    (0,D.$JSCompiler_StaticMethods__squarify$$)(this, $children$$26_node$$342$$, $children$$inline_9210_w$$70_y$$280$$, new D.$DvtRectangle$$($availBounds$$2_x$$313$$.x, $availBounds$$2_x$$313$$.y, $availBounds$$2_x$$313$$.$w$, $availBounds$$2_x$$313$$.$h$))
  }
};
D.$JSCompiler_StaticMethods__squarify$$ = function $$JSCompiler_StaticMethods__squarify$$$($JSCompiler_StaticMethods__squarify$self$$, $children$$28$$, $w$$71$$, $r$$95$$) {
  ...
  if($children$$28$$ == D.$JSCompiler_alias_NULL$$ || 0 == $children$$28$$.length) {
    ...
    for(;0 < $children$$28$$.length;) {
      ...
      $row$$56$$.push($c$$52$$);
      var $min$$inline_9220_newWorst$$, $areas$$inline_9217_s2$$inline_9223$$ = $row$$56$$, $w$$inline_9218_w2$$inline_9224$$ = $w$$71$$, $total$$inline_9219$$ = 0;
      $min$$inline_9220_newWorst$$ = window.Infinity;
      for(var $max$$inline_9221$$ = -window.Infinity, $i$$inline_9222$$ = 0;$i$$inline_9222$$ < $areas$$inline_9217_s2$$inline_9223$$.length;$i$$inline_9222$$++) {
        $total$$inline_9219$$ += $areas$$inline_9217_s2$$inline_9223$$[$i$$inline_9222$$].$__pxSize$, $min$$inline_9220_newWorst$$ = window.Math.min($min$$inline_9220_newWorst$$, $areas$$inline_9217_s2$$inline_9223$$[$i$$inline_9222$$].$__pxSize$), $max$$inline_9221$$ = window.Math.max($max$$inline_9221$$, $areas$$inline_9217_s2$$inline_9223$$[$i$$inline_9222$$].$__pxSize$)
      }
      $areas$$inline_9217_s2$$inline_9223$$ = $total$$inline_9219$$ * $total$$inline_9219$$;
      $w$$inline_9218_w2$$inline_9224$$ *= $w$$inline_9218_w2$$inline_9224$$;
      $min$$inline_9220_newWorst$$ = window.Math.max($w$$inline_9218_w2$$inline_9224$$ * $max$$inline_9221$$ / $areas$$inline_9217_s2$$inline_9223$$, $areas$$inline_9217_s2$$inline_9223$$ / ($w$$inline_9218_w2$$inline_9224$$ * $min$$inline_9220_newWorst$$));
      if($min$$inline_9220_newWorst$$ > $worst$$) {
        ...
        if(0 == $children$$28$$.length) {
          ...
          $worst$$ = $min$$inline_9220_newWorst$$
        }
      }
    }
  }
...
D.$JSCompiler_StaticMethods__layoutRow$$ = function $$JSCompiler_StaticMethods__layoutRow$$$($JSCompiler_StaticMethods__layoutRow$self$$, $row$$57$$, $w$$73_width$$193$$, $r$$96$$) {
  ...
  var $x$$314$$ = $r$$96$$.x, $y$$281$$ = $r$$96$$.y;
  if($w$$73_width$$193$$ == $r$$96$$.$w$) {
    $height$$172_total$$11$$ = 0 == $w$$73_width$$193$$ ? 0 : $height$$172_total$$11$$ / $w$$73_width$$193$$;
    for($i$$920$$ = 0;$i$$920$$ < $row$$57$$.length;$i$$920$$++) {
      $w$$73_width$$193$$ = $row$$57$$[$i$$920$$].$__pxSize$ / $height$$172_total$$11$$, $JSCompiler_StaticMethods__layoutRow$self$$.$_layout$($row$$57$$[$i$$920$$], $x$$314$$, $y$$281$$, $w$$73_width$$193$$, $height$$172_total$$11$$, D.$JSCompiler_alias_FALSE$$), $x$$314$$ += $w$$73_width$$193$$
    }
  ...
  for($i$$920$$ = 0;$i$$920$$ < $row$$57$$.length;$i$$920$$++) {
    $height$$172_total$$11$$ = $row$$57$$[$i$$920$$].$__pxSize$ / $w$$73_width$$193$$, $JSCompiler_StaticMethods__layoutRow$self$$.$_layout$($row$$57$$[$i$$920$$], $x$$314$$, $y$$281$$, $w$$73_width$$193$$, $height$$172_total$$11$$, D.$JSCompiler_alias_FALSE$$), $y$$281$$ += $height$$172_total$$11$$
  }
...
D.$DvtSliceAndDiceLayout$$.prototype.$layout$ = function $$DvtSliceAndDiceLayout$$$$$layout$$($view$$65$$, $root$$36$$, $x$$310$$, $y$$277$$, $width$$189$$, $height$$168$$, $bShowRoot$$1$$) {
  this.$_layout$(this.$_isHoriz$, $view$$65$$, $root$$36$$, $x$$310$$, $y$$277$$, $width$$189$$, $height$$168$$, $bShowRoot$$1$$ ? D.$JSCompiler_alias_FALSE$$ : D.$JSCompiler_alias_TRUE$$)
};
D.$DvtSliceAndDiceLayout$$.prototype.$_layout$ = function $$DvtSliceAndDiceLayout$$$$$_layout$$($isHoriz$$19$$, $view$$66$$, $children$$25_node$$341$$, $availBounds$$1_x$$311$$, $childX$$1_y$$278$$, $childY$$1_width$$190$$, $childWidth_height$$169$$, $childHeight_isRoot$$4$$) {
  var $child$$81_options$$317$$ = $view$$66$$.$getOptions$();
  $availBounds$$1_x$$311$$ = (0,D.$JSCompiler_StaticMethods_setNodeBounds$$)(this, $children$$25_node$$341$$, $availBounds$$1_x$$311$$, $childX$$1_y$$278$$, $childY$$1_width$$190$$, $childWidth_height$$169$$, $childHeight_isRoot$$4$$);
  $children$$25_node$$341$$ = $children$$25_node$$341$$.$getChildNodes$();
  if($children$$25_node$$341$$ != D.$JSCompiler_alias_NULL$$) {
    $childX$$1_y$$278$$ = $availBounds$$1_x$$311$$.x;
    $childY$$1_width$$190$$ = $availBounds$$1_x$$311$$.y;
    $childWidth_height$$169$$ = $availBounds$$1_x$$311$$.$w$;
    $childHeight_isRoot$$4$$ = $availBounds$$1_x$$311$$.$h$;
    var $total$$8$$ = 0, $i$$917$$;
    for($i$$917$$ = 0;$i$$917$$ < $children$$25_node$$341$$.length;$i$$917$$++) {
      $total$$8$$ += 0 < $children$$25_node$$341$$[$i$$917$$].$getSize$() ? $children$$25_node$$341$$[$i$$917$$].$getSize$() : 0
    }
    ...
    for($i$$917$$ = 0;$i$$917$$ < $children$$25_node$$341$$.length;$i$$917$$++) {
      if($child$$81_options$$317$$ = $children$$25_node$$341$$[$i$$917$$], !(0 >= $child$$81_options$$317$$.$getSize$())) {
        ...
        this.$_layout$(!$isHoriz$$19$$, $view$$66$$, $child$$81_options$$317$$, $childX$$1_y$$278$$, $childY$$1_width$$190$$, $childWidth_height$$169$$, $childHeight_isRoot$$4$$, D.$JSCompiler_alias_FALSE$$);
        $isHoriz$$19$$ ? $childX$$1_y$$278$$ += $childWidth_height$$169$$ : $childY$$1_width$$190$$ += $childHeight_isRoot$$4$$
      }
    }
  }
};
D.$DvtTreemapIsolateEvent$$ = function $$DvtTreemapIsolateEvent$$$($id$$328$$) {
  this.Init("treemapIsolate");
  this.$_id$ = $id$$328$$ ? $id$$328$$ : D.$JSCompiler_alias_NULL$$
};
...
D.$DvtTreemapKeyboardHandler$$.prototype.$isNavigationEvent$ = function $$DvtTreemapKeyboardHandler$$$$$isNavigationEvent$$($event$$827_keyCode$$55$$) {
  var $isNavigable$$1$$ = D.$DvtTreemapKeyboardHandler$$.$superclass$.$isNavigationEvent$.call(this, $event$$827_keyCode$$55$$);
  if(!$isNavigable$$1$$ && ($event$$827_keyCode$$55$$ = $event$$827_keyCode$$55$$.keyCode, 219 == $event$$827_keyCode$$55$$ || 221 == $event$$827_keyCode$$55$$)) {
    $isNavigable$$1$$ = D.$JSCompiler_alias_TRUE$$
  }
  return $isNavigable$$1$$
};
D.$DvtTreemapEventManager$$ = function $$DvtTreemapEventManager$$$($view$$69$$, $context$$660$$, $callback$$182$$, $callbackObj$$129$$) {
  D.$DvtBaseTreeEventManager$$.call(this, $view$$69$$, $context$$660$$, $callback$$182$$, $callbackObj$$129$$)
};
