...
dvt.$TagCloud$ = function $dvt$$TagCloud$$($context$$361$$, $callback$$107$$, $callbackObj$$75$$) {
  this.Init($context$$361$$, $callback$$107$$, $callbackObj$$75$$)
};
$goog$exportPath_$$("dvt.TagCloud", dvt.$TagCloud$);
dvt.$Obj$.$createSubclass$(dvt.$TagCloud$, dvt.$BaseComponent$);
dvt.$TagCloud$.newInstance = function $dvt$$TagCloud$$newInstance$($context$$362$$, $callback$$108$$, $callbackObj$$76$$) {
  return new dvt.$TagCloud$($context$$362$$, $callback$$108$$, $callbackObj$$76$$)
};
dvt.$TagCloud$.newInstance = dvt.$TagCloud$.newInstance;
dvt.$TagCloud$.prototype.Init = function $dvt$$TagCloud$$$Init$($context$$363$$, $callback$$109$$, $callbackObj$$77$$) {
  dvt.$TagCloud$.$superclass$.Init.call(this, $context$$363$$, $callback$$109$$, $callbackObj$$77$$);
  this.$getCtx$().$_stage$.$getElem$().setAttributeNS($JSCompiler_alias_NULL$$, "text-rendering", "geometricPrecision");
  this.$EventManager$ = new $DvtTagCloudEventManager$$(this, $context$$363$$, this.$processEvent$, this);
...
dvt.$TagCloud$.prototype.$render$ = function $dvt$$TagCloud$$$$render$$($ah$$3_options$$246$$, $animationDuration$$9_width$$119$$, $bounds$$115_height$$104$$) {
  !isNaN($animationDuration$$9_width$$119$$) && !isNaN($bounds$$115_height$$104$$) && (this.$Width$ = $animationDuration$$9_width$$119$$, this.$Height$ = $bounds$$115_height$$104$$);
  this.$__cleanUp$();
  this.$SetOptions$($ah$$3_options$$246$$);
  ...
  $animationDuration$$9_width$$119$$ = this.$Options$.animationDuration;
  $bounds$$115_height$$104$$ = new dvt.$Rectangle$(0, 0, this.$Width$, this.$Height$);
  this.$_oldContainer$ ? "none" !== this.$Options$.animationOnDataChange && $ah$$3_options$$246$$ && (this.$_deleteContainer$ = new dvt.$Container$(this.$getCtx$()), this.$addChild$(this.$_deleteContainer$), $ah$$3_options$$246$$ = new dvt.$DataAnimationHandler$(this.$getCtx$(), this.$_deleteContainer$), $ah$$3_options$$246$$.$constructAnimation$(this.$_oldItems$, this.$_items$), this.$_animation$ = $ah$$3_options$$246$$.$getAnimation$()) : "none" !== this.$Options$.animationOnDisplay && (this.$_animation$ = 
  dvt.$BlackBoxAnimationHandler$.$getInAnimation$(this.$getCtx$(), dvt.$BlackBoxAnimationHandler$.$ALPHA_FADE$, this.$_container$, $bounds$$115_height$$104$$, $animationDuration$$9_width$$119$$));
...
$JSCompiler_prototypeAlias$$.$SetOptions$ = function $$JSCompiler_prototypeAlias$$$$SetOptions$$($options$$247_selectionMode$$7$$) {
  $options$$247_selectionMode$$7$$ ? this.$Options$ = this.$Defaults$.$calcOptions$($options$$247_selectionMode$$7$$) : this.$Options$ || (this.$Options$ = this.$GetDefaults$());
  $options$$247_selectionMode$$7$$ = this.$Options$.selectionMode;
  this.$SelectionHandler$ = "single" === $options$$247_selectionMode$$7$$ ? new dvt.$SelectionHandler$(dvt.$SelectionHandler$.$TYPE_SINGLE$) : "multiple" === $options$$247_selectionMode$$7$$ ? new dvt.$SelectionHandler$(dvt.$SelectionHandler$.$TYPE_MULTIPLE$) : $JSCompiler_alias_NULL$$;
...
$JSCompiler_prototypeAlias$$.$processEvent$ = function $$JSCompiler_prototypeAlias$$$$processEvent$$($event$$469$$, $source$$30$$) {
  ...
  if("categoryHide" == $type$$155$$ || "categoryShow" == $type$$155$$) {
    ...
    "categoryHighlight" == $type$$155$$ && (this != $source$$30$$ ? this.$highlight$($event$$469$$.categories) : this.$legend$ && this.$legend$ != $source$$30$$ && this.$legend$.$processEvent$($event$$469$$, $source$$30$$))
  }
...
function $DvtTagCloudItem$$($tagCloud$$, $context$$364$$, $textStr$$5$$, $x$$182$$, $y$$159$$, $style$$88$$, $id$$177$$) {
  this.Init($tagCloud$$, $context$$364$$, $textStr$$5$$, $x$$182$$, $y$$159$$, $style$$88$$, $id$$177$$)
}
dvt.$Obj$.$createSubclass$($DvtTagCloudItem$$, dvt.$BackgroundOutputText$);
$JSCompiler_prototypeAlias$$ = $DvtTagCloudItem$$.prototype;
$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($tagCloud$$1$$, $context$$365$$, $textStr$$6$$, $x$$183$$, $y$$160$$, $style$$89$$, $id$$178$$) {
  $DvtTagCloudItem$$.$superclass$.Init.call(this, $context$$365$$, $textStr$$6$$, $x$$183$$, $y$$160$$, $style$$89$$, $id$$178$$);
...
function $DvtTagCloudItem$_adjustX$$($dims$$52_tag$$1$$, $x$$184$$, $hAlign$$3$$) {
  $dims$$52_tag$$1$$ = $dims$$52_tag$$1$$.$getTextDimensions$();
  return $hAlign$$3$$ == dvt.$OutputText$.$H_ALIGN_LEFT$ ? $x$$184$$ + $dims$$52_tag$$1$$.$w$ : $hAlign$$3$$ == dvt.$OutputText$.$H_ALIGN_RIGHT$ ? $x$$184$$ - $dims$$52_tag$$1$$.$w$ : $x$$184$$
}
function $DvtTagCloudItem$_lightenColor$$($color$$65$$, $opacity$$2$$) {
  var $r$$63$$ = dvt.$ColorUtils$.$getRed$($color$$65$$), $g$$9$$ = dvt.$ColorUtils$.$getGreen$($color$$65$$), $b$$33$$ = dvt.$ColorUtils$.$getBlue$($color$$65$$);
  return dvt.$ColorUtils$.$makeRGB$(Math.floor(255 * (1 - $opacity$$2$$) + $opacity$$2$$ * $r$$63$$), Math.floor(255 * (1 - $opacity$$2$$) + $opacity$$2$$ * $g$$9$$), Math.floor(255 * (1 - $opacity$$2$$) + $opacity$$2$$ * $b$$33$$))
}
...
$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$) {
  var $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$ = this.$_view$.$EventManager$.$KeyboardHandler$;
  $bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$.type == dvt.$MouseEvent$.$CLICK$ || $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$.$isMultiSelectEvent$($bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$) ? $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$ = this : $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$.$isNavigationEvent$($bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$) ? 
  ($JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$ = this.$_view$.$getObjects$(), $bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$ = $bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$.keyCode == dvt.$KeyboardEvent$.$RIGHT_ARROW$ || $bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$.keyCode == dvt.$KeyboardEvent$.$DOWN_ARROW$ ? $JSCompiler_alias_TRUE$$ : $JSCompiler_alias_FALSE$$, $bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$ = dvt.$ArrayUtils$.$getIndex$($JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$, 
  this) + ($bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$ ? 1 : -1), $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$ = $bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$ < $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$.length && 0 <= $bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$ ? $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$[$bNext$$inline_4544_event$$470_nextIdx$$inline_4545$$] : 
  $JSCompiler_alias_NULL$$) : $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$ = $JSCompiler_alias_NULL$$;
  return $JSCompiler_temp$$306_JSCompiler_temp$$307_keyboardHandler$$8_navigableItems$$inline_4543$$
};
...
$JSCompiler_prototypeAlias$$.$getDragTransferable$ = function $$JSCompiler_prototypeAlias$$$$getDragTransferable$$() {
  var $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_4547_selection$$inline_4550$$ = this.$_view$;
  this.$isSelected$() || ($JSCompiler_StaticMethods_getDragRowKeys$self$$inline_4547_selection$$inline_4550$$.$SelectionHandler$.$processClick$(this, $JSCompiler_alias_FALSE$$), $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_4547_selection$$inline_4550$$.$EventManager$.$fireSelectionEvent$());
  for(var $rowKeys$$inline_4549$$ = [], $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_4547_selection$$inline_4550$$ = $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_4547_selection$$inline_4550$$.$SelectionHandler$.getSelection(), $i$$inline_4551$$ = 0;$i$$inline_4551$$ < $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_4547_selection$$inline_4550$$.length;$i$$inline_4551$$++) {
    var $item$$inline_4552$$ = $JSCompiler_StaticMethods_getDragRowKeys$self$$inline_4547_selection$$inline_4550$$[$i$$inline_4551$$];
    $item$$inline_4552$$ instanceof $DvtTagCloudObjPeer$$ && $rowKeys$$inline_4549$$.push($item$$inline_4552$$.getId())
  }
  return $rowKeys$$inline_4549$$
};
$JSCompiler_prototypeAlias$$.$getDragFeedback$ = function $$JSCompiler_prototypeAlias$$$$getDragFeedback$$() {
...
$DvtTagCloudRenderer$$.$render$ = function $$DvtTagCloudRenderer$$$$render$$($tagCloud$$4$$, $container$$167$$, $availSpace$$115$$) {
  ...
  var $items$$32_options$$248$$ = $tagCloud$$4$$.$getOptions$();
  $items$$32_options$$248$$.items && 0 < $items$$32_options$$248$$.items.length ? ($items$$32_options$$248$$ = $DvtTagCloudRenderer$$.$_renderItems$($tagCloud$$4$$, $container$$167$$, $availSpace$$115$$), 0 < $items$$32_options$$248$$.length ? ($tagCloud$$4$$.$registerItems$($items$$32_options$$248$$), $tagCloud$$4$$.$EventManager$.$setFocusObj$($tagCloud$$4$$.$getObjects$()[0])) : $DvtTagCloudRenderer$$.$_renderEmptyText$($tagCloud$$4$$, $container$$167$$, $availSpace$$115$$)) : $DvtTagCloudRenderer$$.$_renderEmptyText$($tagCloud$$4$$, 
...
$DvtTagCloudRenderer$$.$_renderEmptyText$ = function $$DvtTagCloudRenderer$$$$_renderEmptyText$$($tagCloud$$5$$, $container$$168$$, $availSpace$$116$$) {
  var $options$$249$$ = $tagCloud$$5$$.$getOptions$(), $emptyTextStr$$3$$ = $options$$249$$.emptyText;
  $emptyTextStr$$3$$ || ($emptyTextStr$$3$$ = dvt.$Bundle$.$getTranslation$($options$$249$$, "labelNoData", dvt.$Bundle$.$UTIL_PREFIX$, "NO_DATA", $JSCompiler_alias_NULL$$));
  dvt.$TextUtils$.$renderEmptyText$($container$$168$$, $emptyTextStr$$3$$, new dvt.$Rectangle$($availSpace$$116$$.x, $availSpace$$116$$.y, $availSpace$$116$$.$w$, $availSpace$$116$$.$h$), $tagCloud$$5$$.$EventManager$, $options$$249$$._statusMessageStyle)
};
...
$DvtTagCloudRenderer$$.$_renderItems$ = function $$DvtTagCloudRenderer$$$$_renderItems$$($tagCloud$$7$$, $container$$170$$, $availSpace$$118$$) {
  for(var $options$$250$$ = $tagCloud$$7$$.$getOptions$(), $items$$33$$ = [], $dataItems$$2$$ = $options$$250$$.items, $fontSizeFunction_minValue$$15$$ = Number.MAX_VALUE, $categoryMap$$2_maxValue$$16$$ = -Number.MAX_VALUE, $i$$564$$ = 0;$i$$564$$ < $dataItems$$2$$.length;$i$$564$$++) {
    $fontSizeFunction_minValue$$15$$ = Math.min($fontSizeFunction_minValue$$15$$, $dataItems$$2$$[$i$$564$$].value), $categoryMap$$2_maxValue$$16$$ = Math.max($categoryMap$$2_maxValue$$16$$, $dataItems$$2$$[$i$$564$$].value)
  }
  $fontSizeFunction_minValue$$15$$ = $DvtTagCloudLayoutUtils$$.$getFontSizeFunction$($fontSizeFunction_minValue$$15$$, $categoryMap$$2_maxValue$$16$$);
  $categoryMap$$2_maxValue$$16$$ = dvt.$ArrayUtils$.$createBooleanMap$($options$$250$$.hiddenCategories);
  for($i$$564$$ = 0;$i$$564$$ < $dataItems$$2$$.length;$i$$564$$++) {
    ...
    if(!$categoryMap$$2_maxValue$$16$$ || !dvt.$ArrayUtils$.$hasAnyMapItem$($categoryMap$$2_maxValue$$16$$, $data$$94$$.categories)) {
      var $item$$48_style$$92$$ = $options$$250$$.styleDefaults.style.$clone$(), $color$$66_peer$$32$$ = $data$$94$$.color;
      $color$$66_peer$$32$$ && $item$$48_style$$92$$.$setStyle$(dvt.$CSSStyle$.$COLOR$, $color$$66_peer$$32$$);
      $item$$48_style$$92$$.$parseInlineStyle$($data$$94$$.style);
      $item$$48_style$$92$$.$setStyle$(dvt.$CSSStyle$.$FONT_SIZE$, $fontSizeFunction_minValue$$15$$.call($JSCompiler_alias_NULL$$, $data$$94$$.value).toString());
      $item$$48_style$$92$$ = new $DvtTagCloudItem$$($tagCloud$$7$$, $tagCloud$$7$$.$getCtx$(), $data$$94$$.label, 0, 0, $item$$48_style$$92$$, $data$$94$$.id);
      $color$$66_peer$$32$$ = new $DvtTagCloudObjPeer$$($tagCloud$$7$$, $item$$48_style$$92$$, $data$$94$$);
      $tagCloud$$7$$.$EventManager$.$associate$($item$$48_style$$92$$, $color$$66_peer$$32$$);
      $tagCloud$$7$$.$registerObject$($color$$66_peer$$32$$, $i$$564$$);
      "none" !== $options$$250$$.selectionMode && $color$$66_peer$$32$$.$setSelectable$($JSCompiler_alias_TRUE$$);
      ($color$$66_peer$$32$$.$isSelectable$() || $data$$94$$.url || $color$$66_peer$$32$$.$getAction$()) && $item$$48_style$$92$$.setCursor("pointer");
      $items$$33$$.push($item$$48_style$$92$$);
      $container$$170$$.$addChild$($item$$48_style$$92$$)
    }
  }
  0 < $items$$33$$.length && ("cloud" === $options$$250$$.layout ? $DvtTagCloudLayoutUtils$$.$cloudLayout$($availSpace$$118$$, $items$$33$$) : $DvtTagCloudLayoutUtils$$.$rectangleLayout$($availSpace$$118$$, $items$$33$$, dvt.$Agent$.$isRightToLeft$($tagCloud$$7$$.$getCtx$())));
  return $items$$33$$
};
$DvtTagCloudRenderer$$.$_renderLegend$ = function $$DvtTagCloudRenderer$$$$_renderLegend$$($tagCloud$$8$$, $container$$171$$, $availSpace$$119$$) {
  var $legend$$30_options$$251$$ = $tagCloud$$8$$.$getOptions$(), $legendData$$6_legendOptions$$9$$ = $legend$$30_options$$251$$.legend;
  if($legendData$$6_legendOptions$$9$$ && $legendData$$6_legendOptions$$9$$.sections) {
    ...
    $legendData$$6_legendOptions$$9$$.hoverBehavior = $legend$$30_options$$251$$.hoverBehavior;
    $legendData$$6_legendOptions$$9$$.hideAndShowBehavior = $legend$$30_options$$251$$.hideAndShowBehavior;
    $legendData$$6_legendOptions$$9$$.hiddenCategories = $legend$$30_options$$251$$.hiddenCategories;
    $legend$$30_options$$251$$ = dvt.$Legend$.newInstance($tagCloud$$8$$.$getCtx$(), $tagCloud$$8$$.$processEvent$, $tagCloud$$8$$);
    $container$$171$$.$addChild$($legend$$30_options$$251$$);
    var $preferredSize$$7$$ = $legend$$30_options$$251$$.$getPreferredSize$($legendData$$6_legendOptions$$9$$, $availSpace$$119$$.$w$, $availSpace$$119$$.$h$ / 3);
    $legend$$30_options$$251$$.$render$($legendData$$6_legendOptions$$9$$, $preferredSize$$7$$.$w$, $preferredSize$$7$$.$h$);
    dvt.$LayoutUtils$.position($availSpace$$119$$, "bottom", $legend$$30_options$$251$$, $preferredSize$$7$$.$w$, $preferredSize$$7$$.$h$, 0);
    $tagCloud$$8$$.$legend$ && ($tagCloud$$8$$.$legend$.$destroy$(), $container$$171$$.removeChild($tagCloud$$8$$.$legend$));
    $tagCloud$$8$$.$legend$ = $legend$$30_options$$251$$
  }
};
...
$DvtTagCloudLayoutUtils$$.$getFontSizeFunction$ = function $$DvtTagCloudLayoutUtils$$$$getFontSizeFunction$$($minValue$$16$$, $maxValue$$17$$) {
  return function($value$$157$$) {
    return 12 + Math.ceil(12 * (2 * ($value$$157$$ - $minValue$$16$$) / ($maxValue$$17$$ - $minValue$$16$$)))
  }
};
$DvtTagCloudLayoutUtils$$.$cloudLayout$ = function $$DvtTagCloudLayoutUtils$$$$cloudLayout$$($availSpace$$121$$, $items$$34$$) {
  ...
  for(var $thetaStep$$1$$ = 2 * Math.PI / 180, $bounds$$116_cy$$35$$ = $JSCompiler_alias_NULL$$, $maxFontSize$$ = 0, $cosCache$$ = [], $sinCache$$ = [], $i$$565$$ = 0;$i$$565$$ < $items$$34$$.length;$i$$565$$++) {
    for(var $placed$$ = $JSCompiler_alias_FALSE$$, $step$$4$$ = 0, $stepIncrement$$ = 4, $tag$$2$$ = $items$$34$$[$i$$565$$], $dims$$53$$ = $tag$$2$$.$getDimensions$(), $maxFontSize$$ = Math.max($maxFontSize$$, parseFloat($tag$$2$$.$getCSSStyle$().$getStyle$(dvt.$CSSStyle$.$FONT_SIZE$))), $lastCollisionIndex$$ = -1;!$placed$$;) {
      var $j$$81_lookup$$ = $step$$4$$ % 180;
      $cosCache$$[$j$$81_lookup$$] === $JSCompiler_alias_VOID$$ && ($cosCache$$[$j$$81_lookup$$] = Math.cos($step$$4$$ * $thetaStep$$1$$));
      $sinCache$$[$j$$81_lookup$$] === $JSCompiler_alias_VOID$$ && ($sinCache$$[$j$$81_lookup$$] = Math.sin($step$$4$$ * $thetaStep$$1$$));
      var $x$$185$$ = $cx$$34_xrStep$$ * $step$$4$$ * $cosCache$$[$j$$81_lookup$$], $y$$161$$ = $fontSize$$8_yrStep$$ * $step$$4$$ * $sinCache$$[$j$$81_lookup$$], $rect$$37$$ = new dvt.$Rectangle$($x$$185$$, $y$$161$$, $dims$$53$$.$w$, $dims$$53$$.$h$), $placed$$ = $JSCompiler_alias_TRUE$$;
      -1 != $lastCollisionIndex$$ && $positions$$2_scale$$51$$[$lastCollisionIndex$$].$intersects$($rect$$37$$) && ($placed$$ = $JSCompiler_alias_FALSE$$);
      if($placed$$) {
        for($j$$81_lookup$$ = 0;$j$$81_lookup$$ < $i$$565$$;$j$$81_lookup$$++) {
          if($positions$$2_scale$$51$$[$j$$81_lookup$$].$intersects$($rect$$37$$)) {
            $lastCollisionIndex$$ = $j$$81_lookup$$;
            $placed$$ = $JSCompiler_alias_FALSE$$;
            break
          }
        }
      }
      $placed$$ && ($bounds$$116_cy$$35$$ = $bounds$$116_cy$$35$$ ? $bounds$$116_cy$$35$$.$getUnion$($rect$$37$$) : $rect$$37$$, $lastCollisionIndex$$ = -1, $positions$$2_scale$$51$$[$i$$565$$] = $rect$$37$$, $tag$$2$$.$setX$($x$$185$$), $tag$$2$$.$setY$(-$dims$$53$$.y + $y$$161$$));
      3600 === $step$$4$$ ? $stepIncrement$$ = 3 : 5400 === $step$$4$$ ? $stepIncrement$$ = 2 : 10800 === $step$$4$$ && ($stepIncrement$$ = 1);
      $step$$4$$ += $stepIncrement$$
    }
  }
  $positions$$2_scale$$51$$ = Math.max($bounds$$116_cy$$35$$.$w$ / $availSpace$$121$$.$w$, $bounds$$116_cy$$35$$.$h$ / $availSpace$$121$$.$h$);
  $cx$$34_xrStep$$ = $bounds$$116_cy$$35$$.x + $bounds$$116_cy$$35$$.$w$ / 2;
  $bounds$$116_cy$$35$$ = $bounds$$116_cy$$35$$.y + $bounds$$116_cy$$35$$.$h$ / 2;
  for($j$$81_lookup$$ = 0;$j$$81_lookup$$ < $items$$34$$.length;$j$$81_lookup$$++) {
    $tag$$2$$ = $items$$34$$[$j$$81_lookup$$], $tag$$2$$.$setX$($availSpace$$121$$.x + $tag$$2$$.$getX$() / $positions$$2_scale$$51$$ + ($availSpace$$121$$.$w$ / 2 - $cx$$34_xrStep$$ / $positions$$2_scale$$51$$)), $tag$$2$$.$setY$($availSpace$$121$$.y + $tag$$2$$.$getY$() / $positions$$2_scale$$51$$ + ($availSpace$$121$$.$h$ / 2 - $bounds$$116_cy$$35$$ / $positions$$2_scale$$51$$)), $fontSize$$8_yrStep$$ = parseFloat($tag$$2$$.$getCSSStyle$().$getStyle$(dvt.$CSSStyle$.$FONT_SIZE$)), $tag$$2$$.$setFontSize$($fontSize$$8_yrStep$$ / 
...
$DvtTagCloudLayoutUtils$$.$rectangleLayout$ = function $$DvtTagCloudLayoutUtils$$$$rectangleLayout$$($availSpace$$122$$, $items$$35$$, $isBidi$$) {
  ...
  for($i$$566_minScale$$3$$ = 0;$i$$566_minScale$$3$$ < $arLines_maxFontSize$$1$$.length - 1;$i$$566_minScale$$3$$++) {
    ...
    if(1 < $lineEnd$$ - $dims$$54_lineStart$$) {
      for(var $lineWidth$$7_maxScale_tag$$3$$ = 0, $flowPadding_j$$82$$ = $dims$$54_lineStart$$;$flowPadding_j$$82$$ < $lineEnd$$;$flowPadding_j$$82$$++) {
        $lineWidth$$7_maxScale_tag$$3$$ += $arDims$$1$$[$flowPadding_j$$82$$].$w$ * $maxWidth$$21_scale$$52$$, $bottomY$$1_maxLineHeight$$ = Math.max($bottomY$$1_maxLineHeight$$, $arDims$$1$$[$flowPadding_j$$82$$].$h$ * $maxWidth$$21_scale$$52$$)
      }
      $hPadding$$1$$ = ($availSpace$$122$$.$w$ - 10 - $lineWidth$$7_maxScale_tag$$3$$) / ($lineEnd$$ - $dims$$54_lineStart$$ - 1);
      $i$$566_minScale$$3$$ == $arLines_maxFontSize$$1$$.length - 2 && ($flowPadding_j$$82$$ = 0.5 * $bottomY$$1_maxLineHeight$$, $flowPadding_j$$82$$ < $hPadding$$1$$ && $lineWidth$$7_maxScale_tag$$3$$ + ($lineEnd$$ - $dims$$54_lineStart$$) * $flowPadding_j$$82$$ < 0.9 * ($availSpace$$122$$.$w$ - 10) && ($hPadding$$1$$ = $flowPadding_j$$82$$, $justified$$ = $JSCompiler_alias_FALSE$$))
    }
    for(var $bottomY$$1_maxLineHeight$$ = 5 + ($i$$566_minScale$$3$$ + 1) * ($maxHeight$$12$$ * $maxWidth$$21_scale$$52$$ + 2) - 2, $curX$$2$$ = $isBidi$$ ? $availSpace$$122$$.$w$ - 5 : 5, $flowPadding_j$$82$$ = $dims$$54_lineStart$$;$flowPadding_j$$82$$ < $lineEnd$$;$flowPadding_j$$82$$++) {
      var $lineWidth$$7_maxScale_tag$$3$$ = $items$$35$$[$flowPadding_j$$82$$], $fontSize$$9$$ = parseFloat($lineWidth$$7_maxScale_tag$$3$$.$getCSSStyle$().$getStyle$(dvt.$CSSStyle$.$FONT_SIZE$));
      ...
      $justified$$ && $flowPadding_j$$82$$ == $lineEnd$$ - 1 && $flowPadding_j$$82$$ != $dims$$54_lineStart$$ ? $isBidi$$ ? ($lineWidth$$7_maxScale_tag$$3$$.$alignLeft$(), $lineWidth$$7_maxScale_tag$$3$$.$setX$($availSpace$$122$$.x + 5)) : ($lineWidth$$7_maxScale_tag$$3$$.$alignRight$(), $lineWidth$$7_maxScale_tag$$3$$.$setX$($availSpace$$122$$.x + $availSpace$$122$$.$w$ - 5)) : ($lineWidth$$7_maxScale_tag$$3$$.$setX$($availSpace$$122$$.x + $curX$$2$$), $isBidi$$ ? ($lineWidth$$7_maxScale_tag$$3$$.$alignRight$(), 
      $curX$$2$$ -= $arDims$$1$$[$flowPadding_j$$82$$].$w$ * $maxWidth$$21_scale$$52$$ + $hPadding$$1$$) : ($lineWidth$$7_maxScale_tag$$3$$.$alignLeft$(), $curX$$2$$ += $arDims$$1$$[$flowPadding_j$$82$$].$w$ * $maxWidth$$21_scale$$52$$ + $hPadding$$1$$))
    }
  }
};
$DvtTagCloudLayoutUtils$$.$_calculateLineBreaks$ = function $$DvtTagCloudLayoutUtils$$$$_calculateLineBreaks$$($arDims$$2$$, $width$$120$$) {
  var $lines$$ = [0], $curWidth$$ = $arDims$$2$$[0].$w$ + 2;
  if(1 < $arDims$$2$$.length) {
    for(var $i$$567$$ = 1;$i$$567$$ < $arDims$$2$$.length;$i$$567$$++) {
      $curWidth$$ + $arDims$$2$$[$i$$567$$].$w$ > $width$$120$$ && ($lines$$.push($i$$567$$), $curWidth$$ = 0), $curWidth$$ += $arDims$$2$$[$i$$567$$].$w$ + 2
    }
  }
  return $lines$$
};
...
function $DvtTagCloudEventManager$$($view$$55$$, $context$$366$$, $callback$$110$$, $callbackObj$$78$$) {
  this.Init($context$$366$$, $callback$$110$$, $callbackObj$$78$$);
  this.$_view$ = $view$$55$$
}
...
function $JSCompiler_StaticMethods__handleLinkCallback$$($callback$$111_obj$$193$$) {
  $callback$$111_obj$$193$$ instanceof $DvtTagCloudObjPeer$$ && ($callback$$111_obj$$193$$ = $callback$$111_obj$$193$$.$getLinkCallback$()) && $callback$$111_obj$$193$$.call()
}
...
$JSCompiler_prototypeAlias$$.$ProcessRolloverEvent$ = function $$JSCompiler_prototypeAlias$$$$ProcessRolloverEvent$$($event$$475_options$$252$$, $categories$$24_hoverBehaviorDelay$$5_obj$$194$$, $bOver$$11_rolloverEvent$$6$$) {
  $event$$475_options$$252$$ = this.$_view$.$getOptions$();
  "dim" == $event$$475_options$$252$$.hoverBehavior && ($categories$$24_hoverBehaviorDelay$$5_obj$$194$$ = $categories$$24_hoverBehaviorDelay$$5_obj$$194$$.$getCategories$ ? $categories$$24_hoverBehaviorDelay$$5_obj$$194$$.$getCategories$() : [], $event$$475_options$$252$$.highlightedCategories = $bOver$$11_rolloverEvent$$6$$ ? $categories$$24_hoverBehaviorDelay$$5_obj$$194$$.slice() : $JSCompiler_alias_NULL$$, $bOver$$11_rolloverEvent$$6$$ = dvt.$EventFactory$.$newCategoryHighlightEvent$($event$$475_options$$252$$.highlightedCategories, 
  $bOver$$11_rolloverEvent$$6$$), $categories$$24_hoverBehaviorDelay$$5_obj$$194$$ = dvt.$StyleUtils$.$getTimeMilliseconds$($event$$475_options$$252$$.styleDefaults.hoverBehaviorDelay), this.$RolloverHandler$.$processEvent$($bOver$$11_rolloverEvent$$6$$, this.$_view$.$getObjects$(), $categories$$24_hoverBehaviorDelay$$5_obj$$194$$, "any" == $event$$475_options$$252$$.highlightMatch))
};
