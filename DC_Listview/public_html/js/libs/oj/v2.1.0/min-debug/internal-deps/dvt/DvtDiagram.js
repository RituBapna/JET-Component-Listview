...
$DvtDiagramLayoutContext$$.prototype.$localToGlobal$ = function $$DvtDiagramLayoutContext$$$$$localToGlobal$$($point$$30$$, $node$$166$$) {
  for(var $containerId$$inline_2322_node$$inline_2320$$ = $node$$166$$, $offset$$inline_2321$$ = new $DvtDiagramPoint$$(0, 0);$containerId$$inline_2322_node$$inline_2320$$;) {
    if($offset$$inline_2321$$.x += $containerId$$inline_2322_node$$inline_2320$$.$ContentOffset$.x + $containerId$$inline_2322_node$$inline_2320$$.$getPosition$().x, $offset$$inline_2321$$.y += $containerId$$inline_2322_node$$inline_2320$$.$ContentOffset$.y + $containerId$$inline_2322_node$$inline_2320$$.$getPosition$().y, $containerId$$inline_2322_node$$inline_2320$$ = $containerId$$inline_2322_node$$inline_2320$$.$_containerId$) {
      if(($containerId$$inline_2322_node$$inline_2320$$ = this.$getNodeById$($containerId$$inline_2322_node$$inline_2320$$)) && $containerId$$inline_2322_node$$inline_2320$$.$isDisclosed$()) {
        var $containerPadding$$inline_2323$$ = $containerId$$inline_2322_node$$inline_2320$$.$getContainerPadding$();
        $containerPadding$$inline_2323$$ && ($offset$$inline_2321$$.x += $containerPadding$$inline_2323$$.left, $offset$$inline_2321$$.y += $containerPadding$$inline_2323$$.top)
      }
    }else {
      $containerId$$inline_2322_node$$inline_2320$$ = $JSCompiler_alias_NULL$$
    }
  }
  return new $DvtDiagramPoint$$($point$$30$$.x + $offset$$inline_2321$$.x, $point$$30$$.y + $offset$$inline_2321$$.y)
};
...
$JSCompiler_prototypeAlias$$ = $DvtBaseDiagram$$.prototype;
$JSCompiler_prototypeAlias$$.$CreateEmptyText$ = function $$JSCompiler_prototypeAlias$$$$CreateEmptyText$$($text$$47$$) {
...
$JSCompiler_prototypeAlias$$.$getInitAnim$ = $JSCompiler_get$$("$_initAnim$");
...
function $JSCompiler_StaticMethods_CreateEmptyLayoutContext$$($JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2525$$) {
  var $layoutContext$$11$$ = new $DvtDiagramLayoutContext$$, $bR2L$$inline_2522$$ = dvt.$Agent$.$isRightToLeft$($JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2525$$.$getCtx$());
  $layoutContext$$11$$.$_bLocaleR2L$ = $bR2L$$inline_2522$$;
  $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2525$$ = new $DvtDiagramRectangle$$(0, 0, $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2525$$.getWidth(), $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2525$$.getHeight());
  $layoutContext$$11$$.$_componentSize$ = $JSCompiler_StaticMethods_CreateEmptyLayoutContext$self_compSize$$inline_2525$$;
  return $layoutContext$$11$$
}
$JSCompiler_prototypeAlias$$.$CreateLayoutContextNode$ = function $$JSCompiler_prototypeAlias$$$$CreateLayoutContextNode$$($node$$171$$, $layout$$19_obj$$inline_2531$$, $bRenderAfter$$) {
  ...
  var $bounds$$inline_2528$$ = $DvtDiagramLayoutUtils$$.$convertRectToDiagramRect$($node$$171$$.$getContentBounds$());
  $nc$$1$$.$_contentBounds$ = $bounds$$inline_2528$$;
  $nc$$1$$.$_origContentBounds$ = $bounds$$inline_2528$$;
  $nc$$1$$.$setLayoutAttributes$($node$$171$$.$getLayoutAttributes$($layout$$19_obj$$inline_2531$$));
  ...
  if($node$$171$$.$isDisclosed$() && ($nc$$1$$.$setDisclosed$($JSCompiler_alias_TRUE$$), $layout$$19_obj$$inline_2531$$ = $DvtBaseDiagram$getLayoutContainerPadding$$($node$$171$$.$getContainerPadding$()), $nc$$1$$.$isDisclosed$() && ($nc$$1$$.$_containerPadding$ = $layout$$19_obj$$inline_2531$$))) {
    $nc$$1$$.$_origBounds$ && ($nc$$1$$.$_origBounds$ = new $DvtDiagramRectangle$$($nc$$1$$.$_origBounds$.x, $nc$$1$$.$_origBounds$.y, $nc$$1$$.$_origBounds$.w - ($layout$$19_obj$$inline_2531$$.left + $layout$$19_obj$$inline_2531$$.right), $nc$$1$$.$_origBounds$.h - ($layout$$19_obj$$inline_2531$$.top + $layout$$19_obj$$inline_2531$$.bottom))), $nc$$1$$.$_origContentBounds$ && ($nc$$1$$.$_origContentBounds$ = new $DvtDiagramRectangle$$($nc$$1$$.$_origContentBounds$.x, $nc$$1$$.$_origContentBounds$.y, 
    $nc$$1$$.$_origContentBounds$.w - ($layout$$19_obj$$inline_2531$$.left + $layout$$19_obj$$inline_2531$$.right), $nc$$1$$.$_origContentBounds$.h - ($layout$$19_obj$$inline_2531$$.top + $layout$$19_obj$$inline_2531$$.bottom)))
  }
...
$JSCompiler_prototypeAlias$$.$CreateLayoutContextLink$ = function $$JSCompiler_prototypeAlias$$$$CreateLayoutContextLink$$($link$$58$$, $offset$$inline_2534_offset$$inline_2537_startId$$5$$, $endId$$5$$, $layout$$20$$) {
  var $lc$$6$$ = new $DvtDiagramLayoutContextLink$$;
  $lc$$6$$.setId($link$$58$$.getId ? $link$$58$$.getId() : $link$$58$$.getData().getId());
  $lc$$6$$.$setStartId$($offset$$inline_2534_offset$$inline_2537_startId$$5$$ ? $offset$$inline_2534_offset$$inline_2537_startId$$5$$ : $link$$58$$.getData().$getStartId$());
  ...
  $offset$$inline_2534_offset$$inline_2537_startId$$5$$ = $link$$58$$.$getStartConnectorOffset$();
  $lc$$6$$.$_startConnectorOffset$ = $offset$$inline_2534_offset$$inline_2537_startId$$5$$;
  $offset$$inline_2534_offset$$inline_2537_startId$$5$$ = $link$$58$$.$getEndConnectorOffset$();
  $lc$$6$$.$_endConnectorOffset$ = $offset$$inline_2534_offset$$inline_2537_startId$$5$$;
...
function $JSCompiler_StaticMethods_CalcViewBounds$$($JSCompiler_StaticMethods_CalcViewBounds$self$$, $animator$$65$$, $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$, $arLinkIds$$2$$) {
  var $bounds$$23$$ = $JSCompiler_alias_NULL$$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$, $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$, $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $contentPane$$ = $JSCompiler_StaticMethods_CalcViewBounds$self$$.$_panZoomCanvas$.$_contentPane$;
  ...
  for(var $i$$263$$ = 0;$i$$263$$ < $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$.length;$i$$263$$++) {
    if($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$ = $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$[$i$$263$$], ($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $JSCompiler_StaticMethods_CalcViewBounds$self$$.$getNodeById$($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$)) && $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$_bVisible$ && 
    !$JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$_bHiddenAncestor$) {
      var $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $animator$$inline_2540_j$$inline_2558$$ = $animator$$65$$;
      $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$getLayoutBounds$();
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = new dvt.$Rectangle$($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$);
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $JSCompiler_alias_NULL$$;
      $animator$$inline_2540_j$$inline_2558$$ && ($bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $animator$$inline_2540_j$$inline_2558$$.$getDestVal$($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$getLabelPosition$));
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ || ($bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$getLabelPosition$());
      var $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = $JSCompiler_alias_NULL$$, $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = $JSCompiler_alias_NULL$$;
      $animator$$inline_2540_j$$inline_2558$$ && ($labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = $animator$$inline_2540_j$$inline_2558$$.$getDestVal$($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$getLabelRotationAngle$), $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = 
      $animator$$inline_2540_j$$inline_2558$$.$getDestVal$($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$getLabelRotationPoint$));
      $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ == $JSCompiler_alias_NULL$$ && ($labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$_labelRotAngle$);
      $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ || ($labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$_labelRotPoint$);
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$getLabelBounds$();
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ && $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ && ($labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ != $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = $DvtBaseDiagram$RotateBounds$$($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$, 
      $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$, $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$)), $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.x = Math.min($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.x + $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.x), 
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.y = Math.min($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.y + $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.y), $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.$w$ = 
      Math.max($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.x + $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.x + $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$w$) - 
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.x, $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.$h$ = Math.max($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.y + 
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.y + $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$.$h$) - $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.y);
      $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$;
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_alias_NULL$$;
      $animator$$65$$ && ($animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $animator$$65$$.$getDestVal$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getTranslateX$), $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = 
      $animator$$65$$.$getDestVal$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getTranslateY$));
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ == $JSCompiler_alias_NULL$$ && ($animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getTranslateX$());
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ == $JSCompiler_alias_NULL$$ && ($bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getTranslateY$());
      $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x += $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$;
      $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y += $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$;
      if($animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.getData().$getGroupId$ ? $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.getData().$_groupId$ : $JSCompiler_alias_NULL$$) {
        $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.getParent(), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $JSCompiler_StaticMethods_LocalToStage$$(new dvt.$Point$($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x, 
        $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y), $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$, $animator$$65$$), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $JSCompiler_StaticMethods_StageToLocal$$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, 
        $contentPane$$, $animator$$65$$), $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_StaticMethods_LocalToStage$$(new dvt.$Point$($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$), 
        $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$, $animator$$65$$), $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_StaticMethods_StageToLocal$$($animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$, $contentPane$$, $animator$$65$$), $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x = 
        $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.x, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.y, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.x - 
        $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.x, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.y - $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.y
      }
      $bounds$$23$$ ? ($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $bounds$$23$$.x, $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $bounds$$23$$.y, $bounds$$23$$.x = Math.min($bounds$$23$$.x, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x), $bounds$$23$$.y = Math.min($bounds$$23$$.y, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y), 
      $bounds$$23$$.$w$ = Math.max($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ + $bounds$$23$$.$w$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$) - $bounds$$23$$.x, $bounds$$23$$.$h$ = Math.max($animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ + $bounds$$23$$.$h$, 
      $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$) - $bounds$$23$$.y) : $bounds$$23$$ = $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$
    }
  }
  ...
  for($i$$263$$ = 0;$i$$263$$ < $arLinkIds$$2$$.length;$i$$263$$++) {
    if($arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$ = $arLinkIds$$2$$[$i$$263$$], ($arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$ = $JSCompiler_StaticMethods_CalcViewBounds$self$$.$getLinkById$($arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$)) && $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$.$_bVisible$) {
      $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$;
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $animator$$65$$;
      $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$ = new dvt.$Rectangle$(Number.MAX_VALUE, Number.MAX_VALUE, -Number.MAX_VALUE, -Number.MAX_VALUE);
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $JSCompiler_alias_NULL$$;
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ && ($bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.$getDestVal$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getPoints$));
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ || ($bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getPoints$());
      if($bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$) {
        $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = $DvtDiagramLinkUtils$$.$GetControlPoints$($bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$);
        for(var $controlPoint$$inline_2553_minY$$inline_2557$$ = $JSCompiler_alias_VOID$$, $controlPoint$$inline_2553_minY$$inline_2557$$ = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = $JSCompiler_alias_VOID$$, $animator$$inline_2540_j$$inline_2558$$ = 0;$animator$$inline_2540_j$$inline_2558$$ < 
        $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.length;$animator$$inline_2540_j$$inline_2558$$++) {
          $controlPoint$$inline_2553_minY$$inline_2557$$ = $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$[$animator$$inline_2540_j$$inline_2558$$], $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = Math.max($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$, $controlPoint$$inline_2553_minY$$inline_2557$$.x), $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = 
          Math.max($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$, $controlPoint$$inline_2553_minY$$inline_2557$$.y), $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = Math.min($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x, $controlPoint$$inline_2553_minY$$inline_2557$$.x), $controlPoint$$inline_2553_minY$$inline_2557$$ = 
          Math.min($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y, $controlPoint$$inline_2553_minY$$inline_2557$$.y), $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x = $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y = $controlPoint$$inline_2553_minY$$inline_2557$$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$ = 
          $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ - $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$ = $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ - $controlPoint$$inline_2553_minY$$inline_2557$$
        }
      }
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$ = new dvt.$Rectangle$($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$);
      $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = $JSCompiler_alias_NULL$$;
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ && ($labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.$getDestVal$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getLabelPosition$));
      $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ == $JSCompiler_alias_NULL$$ && ($labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getLabelPosition$());
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = $JSCompiler_alias_NULL$$;
      $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ && ($labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.$getDestVal$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getLabelRotationAngle$), 
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$.$getDestVal$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getLabelRotationPoint$));
      $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ == $JSCompiler_alias_NULL$$ && ($labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$_labelRotAngle$);
      $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ || ($JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$_labelRotPoint$);
      $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$getLabelBounds$();
      $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$ && $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ && ($labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$ != $JSCompiler_alias_NULL$$ && ($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $DvtBaseDiagram$RotateBounds$$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, 
      $labelRotAngle$$inline_2561_labelRotPoint$$inline_2545_maxY$$inline_2555$$, $JSCompiler_StaticMethods_GetNodeBounds$self$$inline_2539_labelBounds$$inline_2546_labelRotPoint$$inline_2562_minX$$inline_2556$$)), $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.x = Math.min($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.x + 
      $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$.x), $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.y = Math.min($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.y + $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$.y), $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.$w$ = 
      Math.max($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.x + $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$.x + $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$w$) - 
      $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.x, $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.$h$ = Math.max($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$, $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.y + 
      $labelPos$$inline_2560_labelRotAngle$$inline_2544_maxX$$inline_2554$$.y + $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.$h$) - $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$.y);
      $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$ = $bounds$$inline_2559_controlPoints$$inline_2552_labelPos$$inline_2543_points$$inline_2551_ty$$12$$;
      if($animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$.getData().$getGroupId$ ? $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$.getData().$_groupId$ : $JSCompiler_alias_NULL$$) {
        $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$ = $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$.getParent(), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $JSCompiler_StaticMethods_LocalToStage$$(new dvt.$Point$($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y), $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$, 
        $animator$$65$$), $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$ = $JSCompiler_StaticMethods_StageToLocal$$($JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$, $contentPane$$, $animator$$65$$), $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_StaticMethods_LocalToStage$$(new dvt.$Point$($dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x + 
        $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y + $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$h$), $arNodeIds$$4_link$$60_linkId$$33_linkParent$$1$$, $animator$$65$$), $animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$ = $JSCompiler_StaticMethods_StageToLocal$$($animator$$inline_2549_bounds$$inline_2542_by$$1_groupId$$22_localPoint2_nodeParent$$1_stagePoint2_tx$$11$$, 
        $contentPane$$, $animator$$65$$), $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.x = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.x, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.y = $JSCompiler_StaticMethods_GetLinkBounds$self$$inline_2548_bx$$1_labelBounds$$inline_2563_localPoint1_node$$174_stagePoint1$$.y, $dims$$31_linkBounds$$inline_2550_nodeBounds$$inline_2541_nodeId$$91$$.$w$ = 
...
function $DvtBaseDiagram$RotateBounds$$($bottomRight$$3_bounds$$24_minX$$7$$, $maxY$$5_rotAngle$$2_tl$$, $minY$$7_rotPoint$$2$$) {
  ...
  $maxY$$5_rotAngle$$2_tl$$ = $mat$$9_maxX$$5$$.$transformPoint$($br_topLeft$$3$$);
  $topRight$$2_tr$$ = $mat$$9_maxX$$5$$.$transformPoint$($topRight$$2_tr$$);
  $bl_bottomLeft$$2$$ = $mat$$9_maxX$$5$$.$transformPoint$($bl_bottomLeft$$2$$);
  $br_topLeft$$3$$ = $mat$$9_maxX$$5$$.$transformPoint$($bottomRight$$3_bounds$$24_minX$$7$$);
  $bottomRight$$3_bounds$$24_minX$$7$$ = Math.min(Math.min($maxY$$5_rotAngle$$2_tl$$.x, $topRight$$2_tr$$.x), Math.min($bl_bottomLeft$$2$$.x, $br_topLeft$$3$$.x));
  $mat$$9_maxX$$5$$ = Math.max(Math.max($maxY$$5_rotAngle$$2_tl$$.x, $topRight$$2_tr$$.x), Math.max($bl_bottomLeft$$2$$.x, $br_topLeft$$3$$.x));
  $minY$$7_rotPoint$$2$$ = Math.min(Math.min($maxY$$5_rotAngle$$2_tl$$.y, $topRight$$2_tr$$.y), Math.min($bl_bottomLeft$$2$$.y, $br_topLeft$$3$$.y));
  $maxY$$5_rotAngle$$2_tl$$ = Math.max(Math.max($maxY$$5_rotAngle$$2_tl$$.y, $topRight$$2_tr$$.y), Math.max($bl_bottomLeft$$2$$.y, $br_topLeft$$3$$.y));
...
function $JSCompiler_StaticMethods_UpdateNodeLayoutContext$$($nodeContext$$3$$, $node$$175$$) {
  ...
  var $bounds$$inline_2566$$ = $DvtDiagramLayoutUtils$$.$convertRectToDiagramRect$($node$$175$$.$getContentBounds$());
  $nodeContext$$3$$.$_contentBounds$ = $bounds$$inline_2566$$;
  $nodeContext$$3$$.$_origContentBounds$ = $bounds$$inline_2566$$;
...
$JSCompiler_prototypeAlias$$.$getNextNavigableLink$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigableLink$$($i$$inline_2575_index$$128_node$$177$$, $currentLink$$, $bForward$$8_event$$185$$, $listOfLinks$$1$$) {
  if(!$listOfLinks$$1$$) {
    return $JSCompiler_alias_NULL$$
  }
  if(!$currentLink$$) {
  ...
  if(!$i$$inline_2575_index$$128_node$$177$$) {
    return $currentLink$$
  }
  for(var $i$$267_i$$inline_2571_link$$inline_2576$$ = 0;$i$$267_i$$inline_2571_link$$inline_2576$$ < $listOfLinks$$1$$.length;$i$$267_i$$inline_2571_link$$inline_2576$$++) {
    var $link$$inline_2572$$ = $listOfLinks$$1$$[$i$$267_i$$inline_2571_link$$inline_2576$$], $JSCompiler_temp_const$$5536_JSCompiler_temp_const$$5584$$ = $link$$inline_2572$$, $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ = $i$$inline_2575_index$$128_node$$177$$, $endNode$$inline_6186_link$$inline_6184$$ = $link$$inline_2572$$, $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$ = 
    this.$GetVisibleNode$($endNode$$inline_6186_link$$inline_6184$$.$getStartId$ ? $endNode$$inline_6186_link$$inline_6184$$.$getStartId$() : $endNode$$inline_6186_link$$inline_6184$$.getData().$getStartId$()), $endNode$$inline_6186_link$$inline_6184$$ = this.$GetVisibleNode$($endNode$$inline_6186_link$$inline_6184$$.$getEndId$ ? $endNode$$inline_6186_link$$inline_6184$$.$getEndId$() : $endNode$$inline_6186_link$$inline_6184$$.getData().$getEndId$()), $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$ = 
    $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ == $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$ ? $endNode$$inline_6186_link$$inline_6184$$ : $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$, $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ = $JSCompiler_StaticMethods__getNodeCenter$$($angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$), 
    $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$ = $JSCompiler_StaticMethods__getNodeCenter$$($endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$), $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ = Math.atan2($endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.y - 
    $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$.y, $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.x - $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$.x), $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ = 0 > $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ ? 
    $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ + 2 * Math.PI : $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$;
    $JSCompiler_temp_const$$5536_JSCompiler_temp_const$$5584$$.$__angle$ = $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$;
    $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$ = $JSCompiler_temp_const$$5536_JSCompiler_temp_const$$5584$$ = $link$$inline_2572$$;
    $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ = this.$GetVisibleNode$($endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.$getStartId$ ? $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.$getStartId$() : $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.getData().$getStartId$());
    $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$ = this.$GetVisibleNode$($endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.$getEndId$ ? $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.$getEndId$() : $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.getData().$getEndId$());
    $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$ = $JSCompiler_StaticMethods__getNodeCenter$$($angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$);
    $endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$ = $JSCompiler_StaticMethods__getNodeCenter$$($endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$);
    $JSCompiler_temp_const$$5536_JSCompiler_temp_const$$5584$$.$__distance$ = Math.sqrt(Math.pow($endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.x - $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$.x, 2) + Math.pow($endNode$$inline_6195_link$$inline_6193_oppositeNode$$inline_6187_p2$$inline_6189_p2$$inline_6197_startNode$$inline_6185$$.y - $angle$$inline_6190_node$$inline_6183_p1$$inline_6188_p1$$inline_6196_startNode$$inline_6194$$.y, 
    2));
    $link$$inline_2572$$.$__direction$ = $i$$inline_2575_index$$128_node$$177$$ == this.$GetVisibleNode$($link$$inline_2572$$.$getEndId$ ? $link$$inline_2572$$.$getEndId$() : $link$$inline_2572$$.getData().$getEndId$()) ? 1 : 0
  }
  $listOfLinks$$1$$.sort($JSCompiler_StaticMethods__getLinkComparator$$());
  for($i$$inline_2575_index$$128_node$$177$$ = 0;$i$$inline_2575_index$$128_node$$177$$ < $listOfLinks$$1$$.length;$i$$inline_2575_index$$128_node$$177$$++) {
    $i$$267_i$$inline_2571_link$$inline_2576$$ = $listOfLinks$$1$$[$i$$inline_2575_index$$128_node$$177$$], $i$$267_i$$inline_2571_link$$inline_2576$$.$__angle$ = $JSCompiler_alias_VOID$$, $i$$267_i$$inline_2571_link$$inline_2576$$.$__distance$ = $JSCompiler_alias_VOID$$, $i$$267_i$$inline_2571_link$$inline_2576$$.$__direction$ = $JSCompiler_alias_VOID$$
  }
  ...
  for($i$$267_i$$inline_2571_link$$inline_2576$$ = $i$$inline_2575_index$$128_node$$177$$ = 0;$i$$267_i$$inline_2571_link$$inline_2576$$ < $listOfLinks$$1$$.length;$i$$267_i$$inline_2571_link$$inline_2576$$++) {
    if($listOfLinks$$1$$[$i$$267_i$$inline_2571_link$$inline_2576$$] === $currentLink$$) {
      $i$$inline_2575_index$$128_node$$177$$ = $bForward$$8_event$$185$$ ? $i$$267_i$$inline_2571_link$$inline_2576$$ == $listOfLinks$$1$$.length - 1 ? 0 : $i$$267_i$$inline_2571_link$$inline_2576$$ + 1 : 0 == $i$$267_i$$inline_2571_link$$inline_2576$$ ? $listOfLinks$$1$$.length - 1 : $i$$267_i$$inline_2571_link$$inline_2576$$ - 1;
      break
    }
  }
  return $listOfLinks$$1$$[$i$$inline_2575_index$$128_node$$177$$]
};
...
$JSCompiler_prototypeAlias$$.$setLabelPosition$ = function $$JSCompiler_prototypeAlias$$$$setLabelPosition$$($mat$$inline_2583_pos$$26$$) {
  if($mat$$inline_2583_pos$$26$$) {
    this.$_labelPos$ = $mat$$inline_2583_pos$$26$$;
    var $label$$inline_2578$$ = this.$_labelObj$;
    this.$getLabelBounds$();
    $label$$inline_2578$$ && ($mat$$inline_2583_pos$$26$$ = $DvtBaseDiagramNode$CalcLabelMatrix$$($mat$$inline_2583_pos$$26$$, this.$_labelRotAngle$, this.$_labelRotPoint$), $label$$inline_2578$$.$setMatrix$($mat$$inline_2583_pos$$26$$))
  }
};
...
$JSCompiler_prototypeAlias$$.$setLabelRotationAngle$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationAngle$$($angle$$10_mat$$inline_2590$$) {
  this.$_labelRotAngle$ = $angle$$10_mat$$inline_2590$$;
  var $label$$inline_2585$$ = this.$_labelObj$;
  this.$getLabelBounds$();
  $label$$inline_2585$$ && ($angle$$10_mat$$inline_2590$$ = $DvtBaseDiagramNode$CalcLabelMatrix$$(this.$getLabelPosition$(), $angle$$10_mat$$inline_2590$$, this.$_labelRotPoint$), $label$$inline_2585$$.$setMatrix$($angle$$10_mat$$inline_2590$$))
};
$JSCompiler_prototypeAlias$$.$getLabelRotationAngle$ = $JSCompiler_get$$("$_labelRotAngle$");
$JSCompiler_prototypeAlias$$.$setLabelRotationPoint$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationPoint$$($mat$$inline_2597_point$$35$$) {
  this.$_labelRotPoint$ = $mat$$inline_2597_point$$35$$;
  var $label$$inline_2592$$ = this.$_labelObj$;
  this.$getLabelBounds$();
  $label$$inline_2592$$ && ($mat$$inline_2597_point$$35$$ = $DvtBaseDiagramNode$CalcLabelMatrix$$(this.$getLabelPosition$(), this.$_labelRotAngle$, $mat$$inline_2597_point$$35$$), $label$$inline_2592$$.$setMatrix$($mat$$inline_2597_point$$35$$))
};
...
$JSCompiler_prototypeAlias$$.$setLabelRotationAngle$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationAngle$$($angle$$11_mat$$inline_2604$$) {
  this.$_labelRotAngle$ = $angle$$11_mat$$inline_2604$$;
  var $label$$inline_2599$$ = this.$_labelObj$;
  this.$getLabelBounds$();
  $label$$inline_2599$$ && ($angle$$11_mat$$inline_2604$$ = $DvtBaseDiagramLink$CalcLabelMatrix$$(this.$getLabelPosition$(), $angle$$11_mat$$inline_2604$$, this.$_labelRotPoint$), $label$$inline_2599$$.$setMatrix$($angle$$11_mat$$inline_2604$$))
};
$JSCompiler_prototypeAlias$$.$getLabelRotationAngle$ = $JSCompiler_get$$("$_labelRotAngle$");
$JSCompiler_prototypeAlias$$.$setLabelRotationPoint$ = function $$JSCompiler_prototypeAlias$$$$setLabelRotationPoint$$($mat$$inline_2611_point$$36$$) {
  this.$_labelRotPoint$ = $mat$$inline_2611_point$$36$$;
  var $label$$inline_2606$$ = this.$_labelObj$;
  this.$getLabelBounds$();
  $label$$inline_2606$$ && ($mat$$inline_2611_point$$36$$ = $DvtBaseDiagramLink$CalcLabelMatrix$$(this.$getLabelPosition$(), this.$_labelRotAngle$, $mat$$inline_2611_point$$36$$), $label$$inline_2606$$.$setMatrix$($mat$$inline_2611_point$$36$$))
};
$JSCompiler_prototypeAlias$$.$getLabelRotationPoint$ = $JSCompiler_get$$("$_labelRotPoint$");
$JSCompiler_prototypeAlias$$.$getLabelPosition$ = $JSCompiler_get$$("$_labelPos$");
$JSCompiler_prototypeAlias$$.$setLabelPosition$ = function $$JSCompiler_prototypeAlias$$$$setLabelPosition$$($mat$$inline_2618_pos$$29$$) {
  if($mat$$inline_2618_pos$$29$$) {
    this.$_labelPos$ = $mat$$inline_2618_pos$$29$$;
    var $label$$inline_2613$$ = this.$_labelObj$;
    this.$getLabelBounds$();
    $label$$inline_2613$$ && ($mat$$inline_2618_pos$$29$$ = $DvtBaseDiagramLink$CalcLabelMatrix$$($mat$$inline_2618_pos$$29$$, this.$_labelRotAngle$, this.$_labelRotPoint$), $label$$inline_2613$$.$setMatrix$($mat$$inline_2618_pos$$29$$))
  }
};
$JSCompiler_prototypeAlias$$.$getLabelBounds$ = $JSCompiler_returnArg$$($JSCompiler_alias_NULL$$);
$JSCompiler_prototypeAlias$$.$setLabelBounds$ = $JSCompiler_emptyFn$$();
...
function $JSCompiler_StaticMethods_CreateFeedbackUnderlay$$($JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$, $feedbackUnderlay_strokeColor$$4$$, $connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$, $connectorUnderlay$$inline_2625_strokeWidthOffset$$1$$) {
  $feedbackUnderlay_strokeColor$$4$$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$CreateUnderlay$($feedbackUnderlay_strokeColor$$4$$, $connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$, $connectorUnderlay$$inline_2625_strokeWidthOffset$$1$$);
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$_startConnector$ && $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$getStartConnectorType$() && ($connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$getStartConnectorType$(), $connectorUnderlay$$inline_2625_strokeWidthOffset$$1$$ = $JSCompiler_StaticMethods_CreateConnectorUnderlay$$($feedbackUnderlay_strokeColor$$4$$, 
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$_points$, $connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$, $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$getConnectorTemplate$($DvtDiagramLinkConnectorUtils$$.$START_CONNECTOR$), $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$, 0), $feedbackUnderlay_strokeColor$$4$$.$_underlayStart$ && $feedbackUnderlay_strokeColor$$4$$.removeChild($feedbackUnderlay_strokeColor$$4$$.$_underlayStart$), 
  $feedbackUnderlay_strokeColor$$4$$.$_underlayStart$ = $connectorUnderlay$$inline_2625_strokeWidthOffset$$1$$, $feedbackUnderlay_strokeColor$$4$$.$_underlayStartType$ = $connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$, $feedbackUnderlay_strokeColor$$4$$.$addChild$($feedbackUnderlay_strokeColor$$4$$.$_underlayStart$));
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$_endConnector$ && $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$getEndConnectorType$() && ($connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$getEndConnectorType$(), $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$ = $JSCompiler_StaticMethods_CreateConnectorUnderlay$$($feedbackUnderlay_strokeColor$$4$$, 
  $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$_points$, $connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$, $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$.$getConnectorTemplate$($DvtDiagramLinkConnectorUtils$$.$END_CONNECTOR$), $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$, 1), $feedbackUnderlay_strokeColor$$4$$.$_underlayEnd$ && $feedbackUnderlay_strokeColor$$4$$.removeChild($feedbackUnderlay_strokeColor$$4$$.$_underlayEnd$), 
  $feedbackUnderlay_strokeColor$$4$$.$_underlayEnd$ = $JSCompiler_StaticMethods_CreateFeedbackUnderlay$self_connectorUnderlay$$inline_2632$$, $feedbackUnderlay_strokeColor$$4$$.$_underlayEndType$ = $connectorType$$inline_2622_connectorType$$inline_2629_strokeAlpha$$1$$, $feedbackUnderlay_strokeColor$$4$$.$addChild$($feedbackUnderlay_strokeColor$$4$$.$_underlayEnd$));
...
$DvtDiagramLinkConnectorUtils$$.$CreateCustomConnector$ = function $$DvtDiagramLinkConnectorUtils$$$$CreateCustomConnector$$($connectorTemplate$$9$$, $parentLink$$4$$) {
  var $afContext$$59$$ = $JSCompiler_StaticMethods_createAfContext$$($parentLink$$4$$.$GetDiagram$()), $array$$inline_2638_elContext$$inline_2635$$ = $parentLink$$4$$.getData().$_elAttributes$;
  $afContext$$59$$.$_elContext$ = $array$$inline_2638_elContext$$inline_2635$$;
  $afContext$$59$$.$setContextCallback$($parentLink$$4$$, $parentLink$$4$$.$eventContextCallback$);
  $array$$inline_2638_elContext$$inline_2635$$ = $parentLink$$4$$.$getTabStopsArray$();
  $afContext$$59$$.$_tabStopsArray$ = $array$$inline_2638_elContext$$inline_2635$$;
...
dvt.$Diagram$ = function $dvt$$Diagram$$($context$$155$$, $callback$$61$$, $callbackObj$$33$$) {
  this.Init($context$$155$$, $callback$$61$$, $callbackObj$$33$$)
};
$goog$exportPath_$$("dvt.Diagram", dvt.$Diagram$);
dvt.$Obj$.$createSubclass$(dvt.$Diagram$, $DvtBaseDiagram$$);
dvt.$Diagram$.prototype.Init = function $dvt$$Diagram$$$Init$($context$$156$$, $callback$$62$$, $callbackObj$$34$$) {
  dvt.$Diagram$.$superclass$.Init.call(this, $context$$156$$, $callback$$62$$, $callbackObj$$34$$);
  this.$Defaults$ = new $DvtDiagramDefaults$$;
  this.$_eventHandler$ = new $DvtDiagramEventManager$$($context$$156$$, this.$processEvent$, this);
...
dvt.$Diagram$.newInstance = function $dvt$$Diagram$$newInstance$($context$$157$$, $callback$$63$$, $callbackObj$$35$$) {
  return new dvt.$Diagram$($context$$157$$, $callback$$63$$, $callbackObj$$35$$)
};
...
function $JSCompiler_StaticMethods__processContent$$($JSCompiler_StaticMethods__processContent$self$$, $animator$$75_zoom$$8$$, $bEmptyDiagram_contentDim$$2$$) {
  ...
  if(!$bEmptyDiagram_contentDim$$2$$) {
    ...
    var $ah$$1_pzc$$inline_3228$$ = $JSCompiler_StaticMethods__processContent$self$$.$_panZoomCanvas$;
    if($JSCompiler_StaticMethods__processContent$self$$.$_bRendered$) {
      if($JSCompiler_StaticMethods__processContent$self$$.$_isResize$) {
        var $fitBounds$$inline_3231_viewBounds$$inline_3229$$ = $JSCompiler_StaticMethods__processContent$self$$.$AdjustMinZoom$($animator$$75_zoom$$8$$, $JSCompiler_StaticMethods__processContent$self$$.$_cachedViewBounds$), $fitBounds$$inline_3231_viewBounds$$inline_3229$$ = $bLayoutViewport$$inline_3230$$ ? $JSCompiler_StaticMethods_GetLayoutViewport$$($JSCompiler_StaticMethods__processContent$self$$) : $fitBounds$$inline_3231_viewBounds$$inline_3229$$ ? $fitBounds$$inline_3231_viewBounds$$inline_3229$$ : 
        $JSCompiler_StaticMethods__processContent$self$$.$_cachedViewBounds$;
        $ah$$1_pzc$$inline_3228$$.$setZoomToFitEnabled$($JSCompiler_alias_TRUE$$);
        $ah$$1_pzc$$inline_3228$$.$zoomToFit$($JSCompiler_alias_NULL$$, $fitBounds$$inline_3231_viewBounds$$inline_3229$$);
        $ah$$1_pzc$$inline_3228$$.$setZoomToFitEnabled$($JSCompiler_StaticMethods__processContent$self$$.$_zoomingEnabled$)
      }
    }else {
      ...
      if(!$JSCompiler_StaticMethods__processContent$self$$.$_isResize$) {
        var $bLayoutViewport$$inline_3230$$ = $JSCompiler_StaticMethods__processContent$self$$.$_layoutViewport$ ? $JSCompiler_alias_TRUE$$ : $JSCompiler_alias_FALSE$$, $fitBounds$$inline_3231_viewBounds$$inline_3229$$ = $bLayoutViewport$$inline_3230$$ ? $JSCompiler_StaticMethods_GetLayoutViewport$$($JSCompiler_StaticMethods__processContent$self$$) : $JSCompiler_StaticMethods__processContent$self$$.$_cachedViewBounds$;
        $bLayoutViewport$$inline_3230$$ && $ah$$1_pzc$$inline_3228$$.$setZoomToFitPadding$();
        $ah$$1_pzc$$inline_3228$$.$zoomToFit$($JSCompiler_alias_NULL$$, $fitBounds$$inline_3231_viewBounds$$inline_3229$$)
      }
      $ah$$1_pzc$$inline_3228$$.$setPanningEnabled$($JSCompiler_StaticMethods__processContent$self$$.$_panningEnabled$);
      $ah$$1_pzc$$inline_3228$$.$setZoomingEnabled$($JSCompiler_StaticMethods__processContent$self$$.$_zoomingEnabled$);
      $ah$$1_pzc$$inline_3228$$.$setZoomToFitEnabled$($JSCompiler_StaticMethods__processContent$self$$.$_zoomingEnabled$)
    }
  }
  $JSCompiler_StaticMethods__processContent$self$$.$_oldPanZoomCanvas$ = $JSCompiler_alias_NULL$$;
  $JSCompiler_StaticMethods__processContent$self$$.$_bRendered$ || ($JSCompiler_StaticMethods__processContent$self$$.$_animation$ && $JSCompiler_StaticMethods__processContent$self$$.$_animation$.stop($JSCompiler_alias_TRUE$$), dvt.$Agent$.$isEnvironmentBrowser$() && $JSCompiler_StaticMethods__processContent$self$$.$getInitAnim$() && !$JSCompiler_StaticMethods__processContent$self$$.$_oldDataAnimState$ ? $JSCompiler_StaticMethods__processContent$self$$.$_animation$ = dvt.$BlackBoxAnimationHandler$.$getInAnimation$($JSCompiler_StaticMethods__processContent$self$$.$getCtx$(), 
  $JSCompiler_StaticMethods__processContent$self$$.$getInitAnim$(), $JSCompiler_StaticMethods__processContent$self$$, $JSCompiler_alias_NULL$$, $JSCompiler_StaticMethods__processContent$self$$.$getAnimationDuration$()) : "none" != $JSCompiler_StaticMethods__processContent$self$$.$_dataChangeAnim$ && $JSCompiler_StaticMethods__processContent$self$$.$_oldDataAnimState$ && ($JSCompiler_StaticMethods__processContent$self$$.$_deleteContainer$ = new dvt.$Container$($JSCompiler_StaticMethods__processContent$self$$.$getCtx$(), 
  "Delete Container"), $JSCompiler_StaticMethods__processContent$self$$.$addChild$($JSCompiler_StaticMethods__processContent$self$$.$_deleteContainer$), $ah$$1_pzc$$inline_3228$$ = new $DvtDiagramDataAnimationHandler$$($JSCompiler_StaticMethods__processContent$self$$.$getCtx$(), $JSCompiler_StaticMethods__processContent$self$$.$_deleteContainer$, $JSCompiler_StaticMethods__processContent$self$$.$_oldDataAnimState$, $JSCompiler_StaticMethods__processContent$self$$), $ah$$1_pzc$$inline_3228$$.$constructAnimation$([$JSCompiler_StaticMethods__processContent$self$$.$_oldDataAnimState$], 
  [$JSCompiler_StaticMethods__processContent$self$$]), $JSCompiler_StaticMethods__processContent$self$$.$_animation$ = $ah$$1_pzc$$inline_3228$$.$getAnimation$()), $JSCompiler_StaticMethods__processContent$self$$.$_animation$ ? ($JSCompiler_StaticMethods__processContent$self$$.$getEventManager$().$hideTooltip$(), $JSCompiler_StaticMethods__processContent$self$$.$getEventManager$().$removeListeners$($JSCompiler_StaticMethods__processContent$self$$), $JSCompiler_StaticMethods__processContent$self$$.$_animation$.$setOnEnd$($JSCompiler_StaticMethods__processContent$self$$.$_onAnimationEnd$, 
...
$JSCompiler_prototypeAlias$$.$SetOptions$ = function $$JSCompiler_prototypeAlias$$$$SetOptions$$($options$$116$$) {
  ...
  this.$_initAnim$ = "auto" == this.$Options$.animationOnDisplay ? dvt.$BlackBoxAnimationHandler$.$ALPHA_FADE$ : $JSCompiler_alias_NULL$$;
  ...
  switch($event$$236$$.$getSubType$()) {
    case dvt.$ZoomEvent$.$SUBTYPE_ADJUST_PAN_CONSTRAINTS$:
      if(this.$_panningEnabled$) {
        var $nodeId$$98_zoom$$9$$ = $event$$236$$.$_newZoom$, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$ = this.$_cachedViewBounds$ ? this.$_cachedViewBounds$ : $JSCompiler_StaticMethods_CalcViewBounds$$(this, $event$$236$$.$_animator$, $JSCompiler_alias_VOID$$, $JSCompiler_alias_VOID$$);
        this.$ConstrainPanning$($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.x, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.y, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.$w$, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.$h$, $nodeId$$98_zoom$$9$$)
      }
      break;
    case dvt.$ZoomEvent$.$SUBTYPE_ZOOM_TO_FIT_CALC_BOUNDS$:
      this.$_layoutViewport$ || ($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$ = this.$_cachedViewBounds$ ? this.$_cachedViewBounds$ : $JSCompiler_StaticMethods_CalcViewBounds$$(this, $event$$236$$.$_animator$, $JSCompiler_alias_VOID$$, $JSCompiler_alias_VOID$$), $event$$236$$.$setZoomToFitBounds$($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$));
      break;
    case dvt.$ZoomEvent$.$SUBTYPE_ZOOMED$:
      if(this.$getOptions$().zoomRenderer && $event$$236$$.$_oldZoom$ !== $event$$236$$.$_newZoom$) {
        for($nodeId$$98_zoom$$9$$ in this.$_nodes$) {
          var $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$ = this.$getNodeById$($nodeId$$98_zoom$$9$$), $event$$inline_3251_state$$inline_3253$$ = $event$$236$$;
          if($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.$_diagram$.$getOptions$().zoomRenderer) {
            var $prevState$$inline_3252$$ = $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.$_getState$($event$$inline_3251_state$$inline_3253$$.$_oldZoom$), $event$$inline_3251_state$$inline_3253$$ = $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.$_getState$($event$$inline_3251_state$$inline_3253$$.$_newZoom$);
            $JSCompiler_StaticMethods__applyCustomNodeContent$$($JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$, $JSCompiler_StaticMethods_rerenderOnZoom$self$$inline_3250_contentDim$$3$$.$_diagram$.$getOptions$().zoomRenderer, $event$$inline_3251_state$$inline_3253$$, $prevState$$inline_3252$$)
          }
        }
      }
  }
...
$JSCompiler_prototypeAlias$$.$_processHighlighting$ = function $$JSCompiler_prototypeAlias$$$$_processHighlighting$$() {
  ...
  if($categories$$8$$) {
    ...
    var $highlightedLinks_highlightedNodes$$ = [], $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$;
    for($link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$ in this.$_nodes$) {
      var $highlightedLinks$$inline_3260_node$$189$$ = this.$getNodeById$($link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$), $incoming$$inline_3258_match$$3$$ = $bAnyMatched$$ ? dvt.$ArrayUtils$.$hasAnyItem$($highlightedLinks$$inline_3260_node$$189$$.$getCategories$(), $categories$$8$$) : dvt.$ArrayUtils$.$hasAllItems$($highlightedLinks$$inline_3260_node$$189$$.$getCategories$(), $categories$$8$$);
      $incoming$$inline_3258_match$$3$$ && (this.$_highlightedObjects$[$highlightedLinks$$inline_3260_node$$189$$.getId()] = $highlightedLinks$$inline_3260_node$$189$$, $highlightedLinks_highlightedNodes$$.push($highlightedLinks$$inline_3260_node$$189$$))
    }
    $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$ = this.$Options$.nodeHighlightMode;
    if("node" != $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$) {
      $incoming$$inline_3258_match$$3$$ = "nodeAndIncomingLinks" == $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$ || "nodeAndLinks" == $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$;
      $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$ = "nodeAndOutgoingLinks" == $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$ || "nodeAndLinks" == $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$;
      for(var $highlightedLinks$$inline_3260_node$$189$$ = [], $nodeIdx$$inline_3261$$ = 0;$nodeIdx$$inline_3261$$ < $highlightedLinks_highlightedNodes$$.length;$nodeIdx$$inline_3261$$++) {
        for(var $idx$$inline_3264_node$$inline_3262$$ = $highlightedLinks_highlightedNodes$$[$nodeIdx$$inline_3261$$], $links$$inline_3263$$ = $incoming$$inline_3258_match$$3$$ && $idx$$inline_3264_node$$inline_3262$$.$_inLinkIds$ ? $idx$$inline_3264_node$$inline_3262$$.$_inLinkIds$ : [], $links$$inline_3263$$ = $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$ && $idx$$inline_3264_node$$inline_3262$$.$_outLinkIds$ ? $links$$inline_3263$$.concat($idx$$inline_3264_node$$inline_3262$$.$_outLinkIds$) : 
        $links$$inline_3263$$, $idx$$inline_3264_node$$inline_3262$$ = 0;$idx$$inline_3264_node$$inline_3262$$ < $links$$inline_3263$$.length;$idx$$inline_3264_node$$inline_3262$$++) {
          var $linkId$$inline_3265$$ = $links$$inline_3263$$[$idx$$inline_3264_node$$inline_3262$$];
          this.$_highlightedObjects$[$linkId$$inline_3265$$] = this.$getLinkById$($linkId$$inline_3265$$);
          $highlightedLinks$$inline_3260_node$$189$$.push(this.$getLinkById$($linkId$$inline_3265$$))
        }
      }
      $JSCompiler_StaticMethods__processLinkConnections$$(this, $highlightedLinks$$inline_3260_node$$189$$)
    }
    var $highlightedLinks_highlightedNodes$$ = [], $linkId$$41$$;
    for($linkId$$41$$ in this.$_links$) {
      if($link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$ = this.$getLinkById$($linkId$$41$$), $incoming$$inline_3258_match$$3$$ = $bAnyMatched$$ ? dvt.$ArrayUtils$.$hasAnyItem$($link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$.$getCategories$(), $categories$$8$$) : dvt.$ArrayUtils$.$hasAllItems$($link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$.$getCategories$(), $categories$$8$$)) {
        this.$_highlightedObjects$[$link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$.getId()] = $link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$, $highlightedLinks_highlightedNodes$$.push($link$$71_nodeHighlightMode$$inline_3257_nodeId$$101_outgoing$$inline_3259$$)
      }
    }
...
dvt.$Diagram$.prototype.$processDefaultSelectionEffect$ = function $dvt$$Diagram$$$$processDefaultSelectionEffect$$($nodeId$$103$$, $selected$$24$$) {
  var $node$$192$$ = this.$getNodeById$($nodeId$$103$$);
  $node$$192$$ && $node$$192$$.$processDefaultSelectionEffect$($selected$$24$$)
};
...
function $DvtDiagramCategoryRolloverHandler$$($callback$$64$$, $callbackObj$$36$$) {
  $DvtDiagramCategoryRolloverHandler$$.$superclass$.constructor.call(this, $callback$$64$$, $callbackObj$$36$$);
  this.$setHoverDelay$();
...
var $DvtDiagramDefaults$VERSION_1$$ = {skin:dvt.$CSSStyle$.$SKIN_ALTA$, emptyText:$JSCompiler_alias_NULL$$, selectionMode:"none", animationOnDataChange:"none", animationOnDisplay:"none", maxZoom:1, highlightMatch:"all", nodeHighlightMode:"node", linkHighlightMode:"link", panning:"none", touchResponse:"auto", zooming:"none", _statusMessageStyle:new dvt.$CSSStyle$("font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif;"), styleDefaults:{animationDuration:500, hoverBehaviorDelay:200, _highlightAlpha:0.1, 
nodeDefaults:{labelStyle:'font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;font-weight:bold;font-size:12px;color:#383A47', hoverInnerColor:"rgb(255,255,255)", hoverOuterColor:"rgba(0,0,0, .3)", selectionColor:"rgb(0,0,0)", icon:{width:10, height:10, fillPattern:"none", shape:"circle"}}, linkDefaults:{startConnectorType:"none", endConnectorType:"none", width:1, style:"solid", hoverInnerColor:"rgb(255,255,255)", hoverOuterColor:"rgba(0,0,0, .3)", selectionColor:"rgb(0,0,0)", labelStyle:'font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;font-weight:bold;font-size:12px;color:#383A47', 
_hitDetectionOffset:4}}}, $DvtDiagramDefaults$SKIN_ALTA$$ = {};
function $DvtDiagramDataAnimationHandler$$($context$$158$$, $deleteContainer$$1$$, $oldDiagram$$, $newDiagram$$3$$) {
  this.Init($context$$158$$, $deleteContainer$$1$$, $oldDiagram$$, $newDiagram$$3$$)
}
dvt.$Obj$.$createSubclass$($DvtDiagramDataAnimationHandler$$, dvt.$DataAnimationHandler$, "DvtDiagramDataAnimationHandler");
$DvtDiagramDataAnimationHandler$$.prototype.Init = function $$DvtDiagramDataAnimationHandler$$$$Init$($context$$159$$, $deleteContainer$$2$$, $oldDiagram$$1$$, $newDiagram$$4$$) {
  $DvtDiagramDataAnimationHandler$$.$superclass$.Init.call(this, $context$$159$$, $deleteContainer$$2$$);
...
function $DvtDiagramEventManager$$($context$$160$$, $callback$$67$$, $callbackObj$$37$$) {
  this.Init($context$$160$$, $callback$$67$$, $callbackObj$$37$$);
...
$JSCompiler_prototypeAlias$$.$CreateCategoryRolloverHandler$ = function $$JSCompiler_prototypeAlias$$$$CreateCategoryRolloverHandler$$($callback$$68$$, $callbackObj$$38$$) {
  return new $DvtDiagramCategoryRolloverHandler$$($callback$$68$$, $callbackObj$$38$$)
};
...
function $DvtDiagramLink$$($context$$161$$, $diagram$$94$$, $linkData$$16$$) {
  this.Init($context$$161$$, $diagram$$94$$, $linkData$$16$$)
}
...
$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$162$$, $diagram$$96$$, $data$$51$$) {
  $DvtDiagramLink$$.$superclass$.Init.call(this, $context$$162$$, $data$$51$$.id, $diagram$$96$$);
  this.$_data$ = $data$$51$$;
...
$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($container$$72$$) {
  var $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$ = this.getData(), $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$ = this.$_pathCmds$;
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$ || ($labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$ = ["M", 0, 0, "L", 0, 0]);
  var $halign$$inline_3308_id$$inline_3297$$ = $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$.id, $diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$ = $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$.color, $linkWidth$$inline_3299$$ = $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$.width, $linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$ = $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$.style;
  this.$_hitDetectionUnderlay$ = this.$CreateUnderlay$("#000000", 0, $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$._hitDetectionOffset);
  this.$addChild$(this.$_hitDetectionUnderlay$);
  $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$ = new dvt.$SolidStroke$($diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$, 1, $linkWidth$$inline_3299$$);
  dvt.$Agent$.$isTouchDevice$() && (dvt.$Agent$.$isBrowserSafari$() && 1 == dvt.$Agent$.$getDevicePixelRatio$()) && $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$.$setFixedWidth$($JSCompiler_alias_TRUE$$);
  $linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$ = $DvtDiagramLinkUtils$$.$ConvertLinkStyleToStrokeType$($linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$);
  $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$.$setType$($linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$, $DvtDiagramLinkUtils$$.$GetStrokeDash$($linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$), $DvtDiagramLinkUtils$$.$GetStrokeDashOffset$($linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$));
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$ = new dvt.$Path$(this.$getCtx$(), $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$, $halign$$inline_3308_id$$inline_3297$$);
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$.$setFill$($JSCompiler_alias_NULL$$);
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$.$setStroke$($linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$);
  this.$setShape$($labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$);
  this.$addChild$($labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$);
  $diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$ = this.$_diagram$;
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$ = this.getData();
  $halign$$inline_3308_id$$inline_3297$$ = dvt.$Agent$.$isRightToLeft$($diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$.$getCtx$()) ? dvt.$OutputText$.$H_ALIGN_RIGHT$ : dvt.$OutputText$.$H_ALIGN_LEFT$;
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$.label && ($linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$ = $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$.labelStyle, $linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$ = dvt.$OutputText$.$V_ALIGN_TOP$, $diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$ = new dvt.$OutputText$($diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$.$getCtx$(), 
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$.label, 0, 0), $diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$.$setCSSStyle$(new dvt.$CSSStyle$($linkStyle$$inline_3300_strokeType$$inline_3302_style$$inline_6311$$)), $diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$.$setHorizAlignment$($halign$$inline_3308_id$$inline_3297$$), $diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$.$setVertAlignment$($linkData$$inline_3294_stroke$$inline_3301_valign$$inline_6313$$), 
  $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$ = dvt.$CSSStyle$.$toNumber$((new dvt.$CSSStyle$($labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$.labelStyle)).getWidth()), 0 < $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$ && dvt.$TextUtils$.$fitText$($diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$, $labelWidth$$inline_3310_linkData$$inline_3306_points$$inline_3296_shape$$inline_3303$$, 
  Infinity, this) || this.$addChild$($diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$), this.$_labelObj$ = $diagram$$inline_3305_linkColor$$inline_3298_text$$inline_6314$$);
  $container$$72$$.$addChild$(this);
  this.$setAriaRole$("img");
  this.$UpdateAriaLabel$();
  this.$_diagram$.$getEventManager$().$associate$(this, this)
};
$JSCompiler_prototypeAlias$$.$setSelected$ = function $$JSCompiler_prototypeAlias$$$$setSelected$$($selected$$25$$) {
  $DvtDiagramLink$$.$superclass$.$setSelected$.call(this, $selected$$25$$);
  $selected$$25$$ ? this.$_showFeedback$(this.$_isShowingHoverEffect$, $JSCompiler_alias_TRUE$$) : this.$_hideFeedback$();
  this.$UpdateAriaLabel$()
};
$JSCompiler_prototypeAlias$$.$isSelectable$ = function $$JSCompiler_prototypeAlias$$$$isSelectable$$() {
...
function $DvtDiagramNode$$($context$$163$$, $diagram$$99$$, $nodeData$$21$$) {
  this.Init($context$$163$$, $diagram$$99$$, $nodeData$$21$$)
}
...
$JSCompiler_prototypeAlias$$.Init = function $$JSCompiler_prototypeAlias$$$Init$($context$$164$$, $diagram$$101$$, $data$$53$$) {
  $DvtDiagramNode$$.$superclass$.Init.call(this, $context$$164$$, $data$$53$$.id, $diagram$$101$$);
  this.$_data$ = $data$$53$$;
  this.$_diagram$.$isSelectionSupported$() && this.setCursor("pointer")
};
$JSCompiler_prototypeAlias$$.getData = $JSCompiler_get$$("$_data$");
...
$JSCompiler_prototypeAlias$$.$setSelected$ = function $$JSCompiler_prototypeAlias$$$$setSelected$$($selected$$26$$) {
  ...
  $DvtDiagramNode$$.$superclass$.$setSelected$.call(this, $selected$$26$$);
  this.$_diagram$.$getOptions$().selectionRenderer ? $JSCompiler_StaticMethods__applyCustomNodeContent$$(this, this.$_diagram$.$getOptions$().selectionRenderer, this.$_getState$(), $prevState$$) : this.$processDefaultSelectionEffect$($selected$$26$$);
  this.$UpdateAriaLabel$()
};
$JSCompiler_prototypeAlias$$.$processDefaultSelectionEffect$ = function $$JSCompiler_prototypeAlias$$$$processDefaultSelectionEffect$$($selected$$27$$) {
  this.$getSelectionShape$() && this.$getSelectionShape$().$setSelected$($selected$$27$$)
};
$JSCompiler_prototypeAlias$$.$isSelectable$ = function $$JSCompiler_prototypeAlias$$$$isSelectable$$() {
  return this.$GetDiagram$().$isSelectionSupported$() && "off" != this.getData().selectable
};
$JSCompiler_prototypeAlias$$.$GetIcon$ = $JSCompiler_get$$("$_shape$");
$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($container$$75_dims$$inline_3344$$) {
  if(this.$_diagram$.$getOptions$().renderer) {
    ...
    var $bbox$$inline_3345_nodeData$$22$$ = this.getData(), $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ = this.$_diagram$, $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ = new dvt.$CSSStyle$($bbox$$inline_3345_nodeData$$22$$.backgroundStyle);
    if(!$backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$.$isEmpty$()) {
      var $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$ = dvt.$CSSStyle$.$toNumber$($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$.$getStyle$(dvt.$CSSStyle$.$WIDTH$)), $height$$inline_3320_iconHeight$$inline_6322$$ = dvt.$CSSStyle$.$toNumber$($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$.$getStyle$(dvt.$CSSStyle$.$HEIGHT$)), $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$ = 
      $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$.$getStyle$(dvt.$CSSStyle$.$BACKGROUND_COLOR$), $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$ = $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$.$getStyle$(dvt.$CSSStyle$.$BORDER_COLOR$), $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$ = dvt.$CSSStyle$.$toNumber$($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$.$getStyle$(dvt.$CSSStyle$.$BORDER_WIDTH$)), 
      $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ = dvt.$CSSStyle$.$toNumber$($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$.$getStyle$(dvt.$CSSStyle$.$BORDER_RADIUS$)), $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ = new dvt.$Rect$($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$getCtx$(), 
      0, 0, $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$, $height$$inline_3320_iconHeight$$inline_6322$$);
      $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$setSolidFill$($diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$);
      $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ && ($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$setRx$($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$), $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$setRy$($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$));
      $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$ && $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$setStroke$(new dvt.$SolidStroke$($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$, 1, $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$));
      this.$addChild$($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$);
      this.$setSelectionShape$($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$);
      this.$_background$ = $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$
    }
    $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$ = this.$_diagram$;
    if($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$ = $bbox$$inline_3345_nodeData$$22$$.icon) {
      $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ = $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.width;
      $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$ = $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.height;
      $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$ = $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.color;
      $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$ = $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.source ? new dvt.$ImageMarker$($diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$.$getCtx$(), $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ / 
      2, $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$ / 2, $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$, $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$, $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.source, $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.sourceSelected, $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.sourceHover, 
      $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.sourceHoverSelected) : new dvt.$SimpleMarker$($diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$.$getCtx$(), $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.shape, dvt.$CSSStyle$.$SKIN_ALTA$, $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ / 
      2, $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$ / 2, $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$, $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$);
      "none" != $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.fillPattern ? $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$.$setFill$(new dvt.$PatternFill$($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.fillPattern, $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$, $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$)) : 
      $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$.$setSolidFill$($backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$);
      $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.borderColor && $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$.$setStroke$(new dvt.$SolidStroke$($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.borderColor, $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.borderWidth));
      this.$addChild$($diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$);
      this.$_shape$ = $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$;
      if(this.$_background$) {
        var $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$ = $bbox$$inline_3345_nodeData$$22$$.icon, $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$ = this.$_background$.getWidth(), $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ = this.$_background$.getHeight(), $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$ = 
        $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.width, $height$$inline_3320_iconHeight$$inline_6322$$ = $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.height, $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ = 0.5 * ($backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$ - $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$), 
        $positionY$$inline_6324$$ = 0.5 * ($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ - $height$$inline_3320_iconHeight$$inline_6322$$);
        if($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.positionX !== $JSCompiler_alias_VOID$$) {
          $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ = parseFloat($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.positionX), dvt.$Agent$.$isRightToLeft$(this.$getCtx$()) && ($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ = $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$ - $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ - 
          $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$)
        }else {
          var $resolvedHalign$$inline_6325$$ = $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.halign;
          "start" == $resolvedHalign$$inline_6325$$ ? $resolvedHalign$$inline_6325$$ = dvt.$Agent$.$isRightToLeft$(this.$getCtx$()) ? "right" : "left" : "end" == $resolvedHalign$$inline_6325$$ && ($resolvedHalign$$inline_6325$$ = dvt.$Agent$.$isRightToLeft$(this.$getCtx$()) ? "left" : "right");
          $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$ = "left" == $resolvedHalign$$inline_6325$$ ? 0 : "right" == $resolvedHalign$$inline_6325$$ ? $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$ - $iconHeight$$inline_3332_iconWidth$$inline_6321_width$$inline_3319$$ : $backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$
        }
        $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.positionY !== $JSCompiler_alias_VOID$$ ? $positionY$$inline_6324$$ = parseFloat($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.positionY) : "top" == $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.valign ? $positionY$$inline_6324$$ = 0 : "bottom" == $borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$.valign && 
        ($positionY$$inline_6324$$ = $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ - $height$$inline_3320_iconHeight$$inline_6322$$);
        this.$_shape$.$setTranslate$($backgroundStyle$$inline_3318_borderRadius$$inline_3324_positionX$$inline_6323$$, $positionY$$inline_6324$$)
      }
      this.$_background$ || this.$setSelectionShape$($diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$)
    }
    $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ = this.$_diagram$;
    $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$ = dvt.$Agent$.$isRightToLeft$($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$getCtx$()) ? dvt.$OutputText$.$H_ALIGN_RIGHT$ : dvt.$OutputText$.$H_ALIGN_LEFT$;
    $bbox$$inline_3345_nodeData$$22$$.label && ($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$ = $bbox$$inline_3345_nodeData$$22$$.labelStyle, $backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$ = dvt.$OutputText$.$V_ALIGN_TOP$, $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$ = new dvt.$OutputText$($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$getCtx$(), 
    $bbox$$inline_3345_nodeData$$22$$.label, 0, 0), $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$setCSSStyle$(new dvt.$CSSStyle$($borderColor$$inline_3322_icon$$inline_3330_iconData$$inline_6318_style$$inline_6329$$)), $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$setHorizAlignment$($diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$), 
    $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$.$setVertAlignment$($backgroundWidth$$inline_6319_borderWidth$$inline_3323_iconColor$$inline_3333_valign$$inline_6331$$), $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$ = dvt.$CSSStyle$.$toNumber$((new dvt.$CSSStyle$($bbox$$inline_3345_nodeData$$22$$.labelStyle)).getWidth()), 0 < $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$ && 
    dvt.$TextUtils$.$fitText$($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$, $diagram$$inline_3327_fillColor$$inline_3321_halign$$inline_3339_iconMarker$$inline_3334_labelWidth$$inline_3341$$, Infinity, this) || this.$addChild$($backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$), this.$_labelObj$ = $backgroundHeight$$inline_6320_backgroundRect$$inline_3325_diagram$$inline_3315_diagram$$inline_3336_iconWidth$$inline_3331_text$$inline_6332$$);
    $DvtDiagramNode$_addHoverSelectionStrokes$$(this.$getSelectionShape$(), $bbox$$inline_3345_nodeData$$22$$)
  }
  $container$$75_dims$$inline_3344$$.$addChild$(this);
  $container$$75_dims$$inline_3344$$ = $JSCompiler_alias_NULL$$;
  this.$_customNodeContent$ ? ($bbox$$inline_3345_nodeData$$22$$ = this.$getDimensions$()) && ($container$$75_dims$$inline_3344$$ = new dvt.$Rectangle$($bbox$$inline_3345_nodeData$$22$$.x, $bbox$$inline_3345_nodeData$$22$$.y, $bbox$$inline_3345_nodeData$$22$$.$w$ - $bbox$$inline_3345_nodeData$$22$$.x, $bbox$$inline_3345_nodeData$$22$$.$h$ - $bbox$$inline_3345_nodeData$$22$$.y)) : ($container$$75_dims$$inline_3344$$ = this.$_background$ ? this.$_background$.$GetDimensionsWithStroke$(this) : $JSCompiler_alias_NULL$$) && 
  this.$_shape$ ? $container$$75_dims$$inline_3344$$ = $container$$75_dims$$inline_3344$$.$getUnion$(this.$_shape$.$GetDimensionsWithStroke$(this)) : !$container$$75_dims$$inline_3344$$ && this.$_shape$ && ($container$$75_dims$$inline_3344$$ = this.$_shape$.$GetDimensionsWithStroke$(this));
  this.$_contentDims$ = $container$$75_dims$$inline_3344$$;
  this.$setAriaRole$("img");
  this.$UpdateAriaLabel$();
  this.$_diagram$.$getEventManager$().$associate$(this, this)
};
function $JSCompiler_StaticMethods__applyCustomNodeContent$$($JSCompiler_StaticMethods__applyCustomNodeContent$self$$, $nodeContent$$1_renderer$$, $context$$165_state$$28$$, $prevState$$1$$) {
  ...
  if($contextHandler$$) {
    ...
    $context$$165_state$$28$$ = $contextHandler$$($JSCompiler_StaticMethods__applyCustomNodeContent$self$$.$getElem$(), $JSCompiler_StaticMethods__applyCustomNodeContent$self$$.$_customNodeContent$, $nodeData$$23$$, $context$$165_state$$28$$, $prevState$$1$$);
    $nodeContent$$1_renderer$$ = $nodeContent$$1_renderer$$($context$$165_state$$28$$);
...
$DvtDiagramAutomation$$.prototype.$_getMarkerData$ = function $$DvtDiagramAutomation$$$$$_getMarkerData$$($marker$$7$$) {
  if($marker$$7$$) {
    var $data$$56$$ = {};
    $data$$56$$.shape = $marker$$7$$ instanceof dvt.$SimpleMarker$ ? $marker$$7$$.$getType$() : "none";
    $marker$$7$$.$getFill$() && ($data$$56$$.color = $marker$$7$$.$getFill$().$getColor$());
    return $data$$56$$
  }
  return $JSCompiler_alias_NULL$$
};
