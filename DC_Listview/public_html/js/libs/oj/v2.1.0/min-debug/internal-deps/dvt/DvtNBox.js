...
dvt.$NBox$ = function $dvt$$NBox$$($context$$250$$, $callback$$84$$, $callbackObj$$54$$) {
  this.Init($context$$250$$, $callback$$84$$, $callbackObj$$54$$)
};
$goog$exportPath_$$("dvt.NBox", dvt.$NBox$);
dvt.$Obj$.$createSubclass$(dvt.$NBox$, dvt.$BaseComponent$);
dvt.$NBox$.newInstance = function $dvt$$NBox$$newInstance$($context$$251$$, $callback$$85$$, $callbackObj$$55$$) {
  return new dvt.$NBox$($context$$251$$, $callback$$85$$, $callbackObj$$55$$)
};
...
dvt.$NBox$.prototype.Init = function $dvt$$NBox$$$Init$($context$$252$$, $callback$$86$$, $callbackObj$$56$$) {
  dvt.$NBox$.$superclass$.Init.call(this, $context$$252$$, $callback$$86$$, $callbackObj$$56$$);
  this.$Defaults$ = new $DvtNBoxDefaults$$;
  this.$EventManager$ = new $DvtNBoxEventManager$$(this);
  this.$EventManager$.$addListeners$(this);
  this.$_dragSource$ = new dvt.$DragSource$($context$$252$$);
...
dvt.$NBox$.prototype.$SetOptions$ = function $dvt$$NBox$$$$SetOptions$$($options$$188_selectionMode$$3$$) {
  $options$$188_selectionMode$$3$$ || ($options$$188_selectionMode$$3$$ = $JSCompiler_StaticMethods_getSanitizedOptions$$(this));
  $options$$188_selectionMode$$3$$ ? (this.$Options$ = this.$Defaults$.$calcOptions$($options$$188_selectionMode$$3$$), $DvtNBoxDataUtils$$.$processDataObject$(this), dvt.$Agent$.$isEnvironmentBrowser$() || (this.$Options$[dvt.$NBoxConstants$.$ANIMATION_ON_DISPLAY$] = "none", this.$Options$[dvt.$NBoxConstants$.$ANIMATION_ON_DATA_CHANGE$] = "none")) : this.$Options$ || (this.$Options$ = this.$GetDefaults$());
  this.$_displayables$ = [];
  $options$$188_selectionMode$$3$$ = this.$Options$[dvt.$NBoxConstants$.$SELECTION_MODE$];
  this.$_selectionHandler$ = "single" == $options$$188_selectionMode$$3$$ ? new dvt.$SelectionHandler$(dvt.$SelectionHandler$.$TYPE_SINGLE$) : "multiple" == $options$$188_selectionMode$$3$$ ? new dvt.$SelectionHandler$(dvt.$SelectionHandler$.$TYPE_MULTIPLE$) : $JSCompiler_alias_NULL$$;
  this.$EventManager$.$setSelectionHandler$(this.$_selectionHandler$)
};
dvt.$NBox$.prototype.$render$ = function $dvt$$NBox$$$$render$$($options$$189$$, $container$$127_width$$80$$, $bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$) {
  ...
  this.$__cleanUp$();
  this.$SetOptions$($options$$189$$);
  !isNaN($container$$127_width$$80$$) && !isNaN($bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$) && (this.$Width$ = $container$$127_width$$80$$, this.$Height$ = $bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$);
  $container$$127_width$$80$$ = new dvt.$Container$(this.$getCtx$());
  this.$addChild$($container$$127_width$$80$$);
  $DvtNBoxRenderer$$.$render$(this, $container$$127_width$$80$$, new dvt.$Rectangle$(0, 0, this.$Width$, this.$Height$));
  $bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$ = [this];
  ...
  if($animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$ && $animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$.sections) {
    ...
    $animationDuration$$7_panelDrawer$$2$$ && ($bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$.push($animationDuration$$7_panelDrawer$$2$$), $animationDuration$$7_panelDrawer$$2$$.$isDisclosed$() && ($animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$ = $DvtNBoxDataUtils$$.$getDisplayable$(this, $animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$, "legend"), $bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$.push($animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$)))
  }
  this.$getCtx$().$setKeyboardFocusArray$($bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$);
  $options$$189$$ && ($DvtNBoxDataUtils$$.$getDrawer$(this) && $DvtNBoxDataUtils$$.$getGrouping$(this)) && ($bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$ = $DvtNBoxDataUtils$$.$getDisplayable$(this, $DvtNBoxDataUtils$$.$getDrawer$(this)), this.$EventManager$.$setFocus$($bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$), this.$EventManager$.$setFocused$($JSCompiler_alias_FALSE$$));
  this.$_updateKeyboardFocusEffect$();
  this.$_animation$ && (this.$_animationStopped$ = $JSCompiler_alias_TRUE$$, this.$_animation$.stop());
  var $animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$ = $DvtNBoxStyleUtils$$.$getAnimationOnDisplay$(this), $animationDuration$$7_panelDrawer$$2$$ = $DvtNBoxStyleUtils$$.$getAnimationDuration$(this), $bounds$$105$$ = new dvt.$Rectangle$(0, 0, this.$Width$, this.$Height$);
  $bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$ = $JSCompiler_alias_FALSE$$;
  this.$_container$ ? "none" != $ah$$2_animationOnDataChange$$2$$ && $options$$189$$ && ((this.$_animation$ = dvt.$BlackBoxAnimationHandler$.$getCombinedAnimation$(this.$getCtx$(), $ah$$2_animationOnDataChange$$2$$, this.$_container$, $container$$127_width$$80$$, $bounds$$105$$, $animationDuration$$7_panelDrawer$$2$$)) ? $bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$ = $JSCompiler_alias_TRUE$$ : (this.$_deleteContainer$ = new dvt.$Container$(this.$getCtx$(), "DeleteContainer"), this.$addChild$(this.$_deleteContainer$), 
  ...
  this))) : "none" !== $animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$ && (this.$_animation$ = dvt.$BlackBoxAnimationHandler$.$getInAnimation$(this.$getCtx$(), $animationOnDisplay$$2_legend$$27_legendData$$3_nodeOrderFunction$$, $container$$127_width$$80$$, $bounds$$105$$, $animationDuration$$7_panelDrawer$$2$$));
  this.$_animation$ && (this.$setMouseEnabled$($JSCompiler_alias_FALSE$$), dvt.$Playable$.$appendOnEnd$(this.$_animation$, this.$_onAnimationEnd$, this), dvt.$Agent$.$isPlatformIE$() && 12 <= dvt.$Agent$.$getVersion$() && dvt.$Playable$.$appendOnEnd$(this.$_animation$, function() {
    ...
    this.$render$($options$$189$$);
    this.$_animationAllowed$ = $JSCompiler_alias_TRUE$$
  }, this), this.$_animation$.play());
  $bBlackBoxUpdate$$2_drawer_height$$72_keyboardHandlers$$ ? this.$_oldContainer$ = this.$_container$ : this.$_container$ && (this.removeChild(this.$_container$), this.$_container$.$destroy$());
  this.$_container$ = $container$$127_width$$80$$;
...
$JSCompiler_prototypeAlias$$.$processEvent$ = function $$JSCompiler_prototypeAlias$$$$processEvent$$($event$$309$$) {
  var $disclosure_type$$150$$ = $event$$309$$.type, $options$$190$$ = $JSCompiler_StaticMethods_getSanitizedOptions$$(this);
  "categoryHide" == $disclosure_type$$150$$ || "categoryShow" == $disclosure_type$$150$$ ? $event$$309$$ = this.$_processHideShowEvent$($event$$309$$) : "categoryHighlight" == $disclosure_type$$150$$ ? $event$$309$$ = this.$_processRolloverEvent$($event$$309$$) : "selection" == $disclosure_type$$150$$ ? $event$$309$$ = this.$_processSelectionEvent$($event$$309$$) : $options$$190$$._legend && $disclosure_type$$150$$ == dvt.$PanelDrawerEvent$.$TYPE$ && ($disclosure_type$$150$$ = $event$$309$$.$getSubType$() == 
  dvt.$PanelDrawerEvent$.$SUBTYPE_HIDE$ ? "undisclosed" : "disclosed", $event$$309$$ = dvt.$EventFactory$.$newAdfPropertyChangeEvent$(dvt.$NBoxConstants$.$LEGEND_DISCLOSURE$, $disclosure_type$$150$$), $options$$190$$[dvt.$NBoxConstants$.$LEGEND_DISCLOSURE$] = $disclosure_type$$150$$, this.$render$($options$$190$$));
...
$JSCompiler_prototypeAlias$$.$_processHideShowEvent$ = function $$JSCompiler_prototypeAlias$$$$_processHideShowEvent$$($event$$310$$) {
  var $options$$191$$ = $JSCompiler_StaticMethods_getSanitizedOptions$$(this), $hiddenCategories$$10$$ = $options$$191$$[dvt.$NBoxConstants$.$HIDDEN_CATEGORIES$];
  ...
  $options$$191$$[dvt.$NBoxConstants$.$HIDDEN_CATEGORIES$] = $hiddenCategories$$10$$;
  this.$render$($options$$191$$);
  return $event$$310$$
};
      ...
      for($i$$492_selectedItems$$ = 0;$i$$492_selectedItems$$ < $eventSelection_objects$$3_selection$$15$$.length;$i$$492_selectedItems$$++) {
        if($eventSelection_objects$$3_selection$$15$$[$i$$492_selectedItems$$] instanceof $DvtNBoxCategoryNode$$) {
          if($event$$312_selectedMap$$[$eventSelection_objects$$3_selection$$15$$[$i$$492_selectedItems$$].getId()]) {
            ...
            for(var $nodeIndices$$1$$ = $eventSelection_objects$$3_selection$$15$$[$i$$492_selectedItems$$].getData().nodeIndices, $j$$69$$ = 0;$j$$69$$ < $nodeIndices$$1$$.length;$j$$69$$++) {
              var $node$$246$$ = $DvtNBoxDataUtils$$.$getNode$(this, $nodeIndices$$1$$[$j$$69$$]);
...
$JSCompiler_prototypeAlias$$.$__getDragTransferable$ = function $$JSCompiler_prototypeAlias$$$$__getDragTransferable$$($node$$247_rowKeys$$1$$) {
  ...
  for(var $selectionMap$$ = {}, $selectedIds$$5_selection$$16$$ = this.$_selectionHandler$.getSelection(), $i$$493$$ = 0;$i$$493$$ < $selectedIds$$5_selection$$16$$.length;$i$$493$$++) {
    var $id$$126_item$$38$$ = $selectedIds$$5_selection$$16$$[$i$$493$$];
    if($id$$126_item$$38$$ instanceof $DvtNBoxNode$$) {
      $id$$126_item$$38$$ = $id$$126_item$$38$$.getData()[dvt.$NBoxConstants$.ID], $node$$247_rowKeys$$1$$.push($id$$126_item$$38$$), $selectionMap$$[$id$$126_item$$38$$] = $JSCompiler_alias_TRUE$$
    }else {
      if($id$$126_item$$38$$ instanceof $DvtNBoxCategoryNode$$) {
        for(var $nodeIndices$$2$$ = $id$$126_item$$38$$.getData().nodeIndices, $j$$70$$ = 0;$j$$70$$ < $nodeIndices$$2$$.length;$j$$70$$++) {
          var $nodeId$$143$$ = $DvtNBoxDataUtils$$.$getNode$(this, $nodeIndices$$2$$[$j$$70$$])[dvt.$NBoxConstants$.ID];
          $node$$247_rowKeys$$1$$.push($nodeId$$143$$);
          $selectionMap$$[$nodeId$$143$$] = $JSCompiler_alias_TRUE$$
        }
        $selectionMap$$[$id$$126_item$$38$$.getData()[dvt.$NBoxConstants$.ID]] = $JSCompiler_alias_TRUE$$
      }
    }
  }
  ...
  for($i$$493$$ = 0;$i$$493$$ < $selectedIds$$5_selection$$16$$.length;$i$$493$$++) {
    if($id$$126_item$$38$$ = $selectedIds$$5_selection$$16$$[$i$$493$$], !$selectionMap$$[$id$$126_item$$38$$]) {
      if(isNaN($DvtNBoxDataUtils$$.$getNodeIndex$(this, $id$$126_item$$38$$))) {
        if($DvtNBoxDataUtils$$.$getGrouping$(this) && $DvtNBoxDataUtils$$.$getCategoryNode$(this, $id$$126_item$$38$$)) {
          $nodeIndices$$2$$ = $DvtNBoxDataUtils$$.$getCategoryNode$(this, $id$$126_item$$38$$).nodeIndices;
          for($j$$70$$ = 0;$j$$70$$ < $nodeIndices$$2$$.length;$j$$70$$++) {
            $nodeId$$143$$ = $DvtNBoxDataUtils$$.$getNode$(this, $nodeIndices$$2$$[$j$$70$$])[dvt.$NBoxConstants$.ID], $selectionMap$$[$nodeId$$143$$] || ($node$$247_rowKeys$$1$$.push($nodeId$$143$$), $selectionMap$$[$nodeId$$143$$] = $JSCompiler_alias_TRUE$$)
          }
          $selectionMap$$[$id$$126_item$$38$$] = $JSCompiler_alias_TRUE$$
        }
      }else {
        $node$$247_rowKeys$$1$$.push($id$$126_item$$38$$), $selectionMap$$[$id$$126_item$$38$$] = $JSCompiler_alias_TRUE$$
      }
    }
  }
...
function $JSCompiler_StaticMethods___getCellUnderPoint$$($JSCompiler_StaticMethods___getCellUnderPoint$self$$, $x$$160$$, $y$$138$$) {
...
$JSCompiler_prototypeAlias$$.$_processHighlighting$ = function $$JSCompiler_prototypeAlias$$$$_processHighlighting$$($categories$$15$$) {
  ...
  for($i$$495$$ = 0;$i$$495$$ < $cellCount$$1_highlightedMap$$;$i$$495$$++) {
    var $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $DvtNBoxDataUtils$$.$getCell$(this, $i$$495$$), $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$ = $DvtNBoxDataUtils$$.$getDisplayable$(this, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$);
    $DvtNBoxCellRenderer$$.$renderHeader$(this, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$, $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$, $JSCompiler_alias_FALSE$$)
  }
  $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $DvtNBoxDataUtils$$.$getHighlightedItems$(this);
  $cellCount$$1_highlightedMap$$ = {};
  if($JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$) {
    for(var $i$$495$$ = 0;$i$$495$$ < $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.length;$i$$495$$++) {
      $cellCount$$1_highlightedMap$$[$JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$[$i$$495$$][dvt.$NBoxConstants$.ID]] = $JSCompiler_alias_TRUE$$
    }
  }
  for($i$$495$$ = 0;$i$$495$$ < $displayables$$16$$.length;$i$$495$$++) {
    if($JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $categories$$15$$) {
      if($JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = 0 < $categories$$15$$.length) {
        a: {
          $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $displayables$$16$$[$i$$495$$];
          if($JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ instanceof $DvtNBoxNode$$) {
            if($JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.$getCategories$()) {
              $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = "all" == this.$getOptions$()[dvt.$NBoxConstants$.$HIGHLIGHT_MATCH$] ? dvt.$ArrayUtils$.$hasAllItems$($categories$$15$$, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.$getCategories$()) : dvt.$ArrayUtils$.$hasAnyItem$($categories$$15$$, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.$getCategories$());
              break a
            }
          }else {
            if($JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ instanceof $DvtNBoxCategoryNode$$) {
              for(var $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.getData(), $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$ = $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.nodeIndices.length, 
              $i$$inline_4394_j$$71$$ = 0;$i$$inline_4394_j$$71$$ < $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$;$i$$inline_4394_j$$71$$++) {
                var $nodeData$$inline_4395$$ = $DvtNBoxDataUtils$$.$getNode$(this, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.nodeIndices[$i$$inline_4394_j$$71$$]);
                if($nodeData$$inline_4395$$[dvt.$NBoxConstants$.$CATEGORIES$] && ("all" == this.$getOptions$()[dvt.$NBoxConstants$.$HIGHLIGHT_MATCH$] ? dvt.$ArrayUtils$.$hasAllItems$($categories$$15$$, $nodeData$$inline_4395$$[dvt.$NBoxConstants$.$CATEGORIES$]) : dvt.$ArrayUtils$.$hasAnyItem$($categories$$15$$, $nodeData$$inline_4395$$[dvt.$NBoxConstants$.$CATEGORIES$]))) {
                  $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $JSCompiler_alias_TRUE$$;
                  break a
                }
              }
            }
          }
          $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $JSCompiler_alias_FALSE$$
        }
        $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = !$JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$
      }
    }
    $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ ? $displayables$$16$$[$i$$495$$].$setAlpha$($DvtNBoxStyleUtils$$.$getFadedNodeAlpha$(this)) : $displayables$$16$$[$i$$495$$].$setAlpha$(1);
    if($displayables$$16$$[$i$$495$$] instanceof $DvtNBoxCategoryNode$$) {
      $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$ = 0;
      $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$ = $displayables$$16$$[$i$$495$$].getData();
      for($i$$inline_4394_j$$71$$ = 0;$i$$inline_4394_j$$71$$ < $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.nodeIndices.length;$i$$inline_4394_j$$71$$++) {
        $cellCount$$1_highlightedMap$$[$JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.nodeIndices[$i$$inline_4394_j$$71$$]] && ($bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$ += 1)
      }
      $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.highlightedCount = $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$;
      $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$ = $DvtNBoxStyleUtils$$.$getStyledCategoryIndicatorIcon$(this, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$) != $JSCompiler_alias_NULL$$ || $DvtNBoxStyleUtils$$.$getCategoryNodeIndicatorColor$(this, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$) != 
      $JSCompiler_alias_NULL$$;
      $DvtNBoxCategoryNodeRenderer$$.$_renderNodeCount$(this, $displayables$$16$$[$i$$495$$].getData(), $displayables$$16$$[$i$$495$$], $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.__scale, $bIndicator_categoryNodeCount$$inline_4393_cell$$2_count$$14$$, $JSCompiler_inline_result$$182_JSCompiler_temp$$180_JSCompiler_temp$$181_cellData_data$$59_data$$inline_4392_disp$$inline_4391_highlightedItems$$.__gap)
    }
  }
};
...
var $DvtNBoxDefaults$VERSION_1$$ = {skin:dvt.$CSSStyle$.$SKIN_ALTA$, selectionMode:"multiple", animationOnDataChange:"none", animationOnDisplay:"none", cellMaximize:"on", cellContent:"auto", legendDisplay:"auto", legendDisclosure:"disclosed", groupBehavior:"withinCell", otherColor:"#636363", otherThreshold:0, hoverBehavior:"none", highlightMatch:"all", highlightedCategories:[], touchResponse:"auto", styleDefaults:{animationDuration:500, hoverBehaviorDelay:200, columnLabelStyle:new dvt.$CSSStyle$('font-size: 12px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), 
rowLabelStyle:new dvt.$CSSStyle$('font-size: 12px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), columnsTitleStyle:new dvt.$CSSStyle$('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), rowsTitleStyle:new dvt.$CSSStyle$('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), cellDefaults:{style:new dvt.$CSSStyle$("background-color:#e9e9e9"), maximizedStyle:new dvt.$CSSStyle$("background-color:#dddddd"), 
minimizedStyle:new dvt.$CSSStyle$("background-color:#e9e9e9"), labelStyle:new dvt.$CSSStyle$('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;font-weight:bold'), countLabelStyle:new dvt.$CSSStyle$('font-size: 14px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), bodyCountLabelStyle:new dvt.$CSSStyle$('color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), dropTargetStyle:new dvt.$CSSStyle$("background-color:rgba(217, 244, 250, .75);border-color:#ccf6ff"), 
...
countLabelStyle:new dvt.$CSSStyle$('font-size: 14px; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif;font-weight:bold'), countBorderRadius:1}, nodeDefaults:{color:"#FFFFFF", labelStyle:new dvt.$CSSStyle$('font-size: 12px; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), secondaryLabelStyle:new dvt.$CSSStyle$('font-size: 11px; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif'), alphaFade:0.2, borderRadius:1, hoverColor:"#FFFFFF", selectionColor:"#000000", iconDefaults:{preferredSize:19, 
preferredSizeTouch:34, shapePaddingRatio:0.15, sourcePaddingRatio:0, opacity:1, pattern:"none", borderColor:"#000000", borderWidth:0, borderRadius:0, shape:dvt.$SimpleMarker$.$CIRCLE$}, indicatorIconDefaults:{width:10, height:10, opacity:1, pattern:"none", borderColor:"#000000", borderWidth:0, borderRadius:0, shape:dvt.$SimpleMarker$.$CIRCLE$}}, __legendDefaults:{sectionStyle:'font-size: 12px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif; font-weight:bold', itemStyle:'font-size: 12px; color: #252525; font-family:"Helvetica Neue", Helvetica, Arial, sans-serif', 
markerColor:"#808080"}, __categoryNodeDefaults:{labelStyle:new dvt.$CSSStyle$('font-family:"Helvetica Neue", Helvetica, Arial, sans-serif')}}, __layout:{componentGap:8, titleGap:4, titleComponentGap:4, nodeLabelOnlyStartLabelGap:5, nodeStartLabelGap:3, nodeEndLabelGap:5, nodeSingleLabelGap:2, nodeDualLabelGap:2, nodeInterLabelGap:0, nodeIndicatorGap:3, nodeSwatchSize:10, categoryNodeLabelGap:5, minimumCellSize:34, cellGap:3, gridGap:6, cellStartGap:6, cellEndGap:6, cellTopGap:6, cellBottomGap:6, 
cellLabelGap:6, cellCloseGap:6, countLabelGap:10, markerGap:3, minimumLabelWidth:55, maximumLabelWidth:148, drawerButtonGap:6, drawerCountHorizontalGap:5, drawerCountVerticalGap:3, drawerStartGap:6, drawerLabelGap:6, drawerHeaderHeight:31, legendBottomGap:10}}, $DvtNBoxDefaults$SKIN_ALTA$$ = {};
...
$JSCompiler_prototypeAlias$$.$handleDoubleClick$ = function $$JSCompiler_prototypeAlias$$$$handleDoubleClick$$() {
  if(this.$isDoubleClickable$()) {
    var $maximizedRow_oldFocus$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$(this.$_nbox$), $maximizedColumn$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$(this.$_nbox$), $options$$192$$ = $JSCompiler_StaticMethods_getSanitizedOptions$$(this.$_nbox$), $event$$314$$ = dvt.$EventFactory$.$newAdfPropertyChangeEvent$(dvt.$NBoxConstants$.$DRAWER$, $JSCompiler_alias_NULL$$);
    $options$$192$$[dvt.$NBoxConstants$.$DRAWER$] = $JSCompiler_alias_NULL$$;
    $maximizedRow_oldFocus$$ == this.$_data$[dvt.$NBoxConstants$.$ROW$] && $maximizedColumn$$ == this.$_data$[dvt.$NBoxConstants$.$COLUMN$] ? ($options$$192$$[dvt.$NBoxConstants$.$MAXIMIZED_ROW$] = $JSCompiler_alias_NULL$$, $event$$314$$.properties[dvt.$NBoxConstants$.$MAXIMIZED_ROW$] = $JSCompiler_alias_NULL$$, $options$$192$$[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$] = $JSCompiler_alias_NULL$$, $event$$314$$.properties[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$] = $JSCompiler_alias_NULL$$) : ($options$$192$$[dvt.$NBoxConstants$.$MAXIMIZED_ROW$] = 
    this.$_data$[dvt.$NBoxConstants$.$ROW$], $event$$314$$.properties[dvt.$NBoxConstants$.$MAXIMIZED_ROW$] = this.$_data$[dvt.$NBoxConstants$.$ROW$], $options$$192$$[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$] = this.$_data$[dvt.$NBoxConstants$.$COLUMN$], $event$$314$$.properties[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$] = this.$_data$[dvt.$NBoxConstants$.$COLUMN$]);
    var $otherCell$$;
    ...
    this.$_nbox$.$render$($options$$192$$)
  }
};
$JSCompiler_prototypeAlias$$.contains = function $$JSCompiler_prototypeAlias$$$contains$($x$$161$$, $y$$139$$) {
  ...
  return $minX$$12$$ <= $x$$161$$ && $x$$161$$ <= $maxX$$9$$ && $minY$$14$$ <= $y$$139$$ && $y$$139$$ <= $background$$8_maxY$$11$$
};
...
$JSCompiler_prototypeAlias$$.$getNextNavigable$ = function $$JSCompiler_prototypeAlias$$$$getNextNavigable$$($JSCompiler_temp$$155_event$$316$$) {
  var $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $JSCompiler_alias_NULL$$;
  if(this.$_nbox$.$EventManager$.$KeyboardHandler$.$isNavigationEvent$($JSCompiler_temp$$155_event$$316$$)) {
    if($JSCompiler_temp$$155_event$$316$$.keyCode == dvt.$KeyboardEvent$.$OPEN_BRACKET$) {
      var $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $JSCompiler_alias_NULL$$, $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$(this.$_nbox$), $cellCount$$inline_4411_maximizedColumn$$inline_4401_nodes$$inline_4404$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$(this.$_nbox$), $drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$ = $DvtNBoxDataUtils$$.$getDrawer$(this.$_nbox$);
      if($drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$ && $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ == this.getData()[dvt.$NBoxConstants$.$ROW$] && $cellCount$$inline_4411_maximizedColumn$$inline_4401_nodes$$inline_4404$$ == this.getData()[dvt.$NBoxConstants$.$COLUMN$]) {
        $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $DvtNBoxDataUtils$$.$getDisplayable$(this.$_nbox$, $drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$)
      }else {
        if($cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = this.$getChildContainer$(), $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.$getScrollingPane$ && ($cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.$_container$), 0 < $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.$getNumChildren$() && 
        ($cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.$getChildAt$(0) instanceof $DvtNBoxNode$$ || $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.$getChildAt$(0) instanceof $DvtNBoxNodeOverflow$$)) {
          $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $DvtNBoxDataUtils$$.$getFirstNavigableNode$(this.$_nbox$, $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$)
        }else {
          $cellCount$$inline_4411_maximizedColumn$$inline_4401_nodes$$inline_4404$$ = [];
          for($drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$ = 0;$drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$ < $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.$getNumChildren$();$drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$++) {
            var $child$$inline_4406$$ = $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.$getChildAt$($drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$);
            $child$$inline_4406$$ instanceof $DvtNBoxCategoryNode$$ && $cellCount$$inline_4411_maximizedColumn$$inline_4401_nodes$$inline_4404$$.push($child$$inline_4406$$)
          }
          $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $DvtNBoxKeyboardHandler$getNextNavigableCategoryNode$$($JSCompiler_alias_NULL$$, $JSCompiler_temp$$155_event$$316$$, $cellCount$$inline_4411_maximizedColumn$$inline_4401_nodes$$inline_4404$$)
        }
      }
      $JSCompiler_temp$$155_event$$316$$ = $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$
    }else {
      $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = [];
      $cellCount$$inline_4411_maximizedColumn$$inline_4401_nodes$$inline_4404$$ = $DvtNBoxDataUtils$$.$getRowCount$(this.$_nbox$) * $DvtNBoxDataUtils$$.$getColumnCount$(this.$_nbox$);
      for($drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$ = 0;$drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$ < $cellCount$$inline_4411_maximizedColumn$$inline_4401_nodes$$inline_4404$$;$drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$++) {
        $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$.push($DvtNBoxDataUtils$$.$getDisplayable$(this.$_nbox$, $DvtNBoxDataUtils$$.$getCell$(this.$_nbox$, $drawerData$$inline_4402_i$$inline_4405_i$$inline_4412$$)))
      }
      $JSCompiler_temp$$155_event$$316$$ = dvt.$KeyboardHandler$.$getNextNavigable$(this, $JSCompiler_temp$$155_event$$316$$, $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$)
    }
    $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$ = $JSCompiler_temp$$155_event$$316$$
  }
  return $cells$$inline_4410_childObj$$inline_4399_container$$inline_4403_maximizedRow$$inline_4400_next$$6$$
};
...
function $DvtNBoxNode$$() {
}
dvt.$Obj$.$createSubclass$($DvtNBoxNode$$, dvt.$Container$, "DvtNBoxNode");
$DvtNBoxNode$$.newInstance = function $$DvtNBoxNode$$$newInstance$($nbox$$3$$, $data$$64$$) {
  var $component$$15$$ = new $DvtNBoxNode$$;
  $component$$15$$.Init($nbox$$3$$, $data$$64$$);
  return $component$$15$$
};
...
$JSCompiler_prototypeAlias$$.$setSelected$ = function $$JSCompiler_prototypeAlias$$$$setSelected$$($selected$$29$$) {
  this.$getSelectionShape$().$setSelected$($selected$$29$$);
...
$JSCompiler_prototypeAlias$$.$getDatatip$ = function $$JSCompiler_prototypeAlias$$$$getDatatip$$() {
  ...
  if($tooltipFunc$$5$$) {
    var $dataContext$$7$$ = {id:this.$_data$.id, label:this.$_data$.label, secondaryLabel:this.$_data$.secondaryLabel, row:this.$_data$.row, column:this.$_data$.column, color:$DvtNBoxStyleUtils$$.$getNodeColor$(this.$_nbox$, this.$_data$), indicatorColor:$DvtNBoxStyleUtils$$.$getNodeIndicatorColor$(this.$_nbox$, this.$_data$)};
    return this.$_nbox$.$getCtx$().$getTooltipManager$().$getCustomTooltip$($tooltipFunc$$5$$, $dataContext$$7$$)
  }
...
$JSCompiler_prototypeAlias$$.$getKeyboardFocusDisplayable$ = function $$JSCompiler_prototypeAlias$$$$getKeyboardFocusDisplayable$$() {
  ...
  if($cell$$3_cellData$$2_node$$248$$) {
    var $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ = $DvtNBoxDataUtils$$.$getDisplayable$(this.$_nbox$, $cell$$3_cellData$$2_node$$248$$);
    if($ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$) {
      return $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$
    }
    ...
    $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ = $DvtNBoxDataUtils$$.$getLastNavigableNode$(this.$_nbox$, $cell$$3_cellData$$2_node$$248$$.$getChildContainer$());
    if($ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ instanceof $DvtNBoxNodeOverflow$$) {
      return $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$
    }
    a: {
      for($ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ = this;$ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ && $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$.getParent;) {
        if($ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ = $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$.getParent(), $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ instanceof $DvtNBoxDrawer$$) {
          break a
        }
      }
      $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ = $JSCompiler_alias_NULL$$
    }
    return $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$ ? $ancestor$$inline_4415_displayable$$43_drawer$$2_lastNode$$.$getKeyboardFocusDisplayable$() : $cell$$3_cellData$$2_node$$248$$.$getKeyboardFocusDisplayable$()
  }
  return $JSCompiler_alias_NULL$$
};
...
$DvtNBoxNodeOverflow$$.newInstance = function $$DvtNBoxNodeOverflow$$$newInstance$($nbox$$5$$, $cell$$4$$) {
  var $component$$16$$ = new $DvtNBoxNodeOverflow$$;
  $component$$16$$.Init($nbox$$5$$, $cell$$4$$);
  return $component$$16$$
};
...
$JSCompiler_prototypeAlias$$.$render$ = function $$JSCompiler_prototypeAlias$$$$render$$($container$$134$$, $keyboardFocusEffect_width$$81$$, $height$$73$$) {
  var $options$$194$$ = this.$_nbox$.$getOptions$(), $w$$31$$ = $options$$194$$._resources.overflow_ena.width, $h$$24$$ = $options$$194$$._resources.overflow_ena.height, $scale$$42_x$$163$$ = 1;
  if($keyboardFocusEffect_width$$81$$ < $w$$31$$ || $height$$73$$ < $h$$24$$) {
    $scale$$42_x$$163$$ = Math.min($keyboardFocusEffect_width$$81$$ / $w$$31$$, $height$$73$$ / $h$$24$$)
  }
  var $w$$31$$ = $scale$$42_x$$163$$ * $w$$31$$, $h$$24$$ = $scale$$42_x$$163$$ * $h$$24$$, $scale$$42_x$$163$$ = ($keyboardFocusEffect_width$$81$$ - $w$$31$$) / 2, $y$$141$$ = ($height$$73$$ - $h$$24$$) / 2, $ctx$$4$$ = this.$_nbox$.$getCtx$(), $upRect$$ = new dvt.$Rect$($ctx$$4$$, 0, 0, $keyboardFocusEffect_width$$81$$, $height$$73$$), $overRect$$ = new dvt.$Rect$($ctx$$4$$, 0, 0, $keyboardFocusEffect_width$$81$$, $height$$73$$), $downRect$$ = new dvt.$Rect$($ctx$$4$$, 0, 0, $keyboardFocusEffect_width$$81$$, 
  $height$$73$$), $disRect$$ = new dvt.$Rect$($ctx$$4$$, 0, 0, $keyboardFocusEffect_width$$81$$, $height$$73$$);
  ...
  $upState$$13$$.$addChild$(new dvt.$Image$($ctx$$4$$, $options$$194$$._resources.overflow_ena.src, $scale$$42_x$$163$$, $y$$141$$, $w$$31$$, $h$$24$$));
  $overState$$10$$.$addChild$(new dvt.$Image$($ctx$$4$$, $options$$194$$._resources.overflow_ovr.src, $scale$$42_x$$163$$, $y$$141$$, $w$$31$$, $h$$24$$));
  $downState$$10$$.$addChild$(new dvt.$Image$($ctx$$4$$, $options$$194$$._resources.overflow_dwn.src, $scale$$42_x$$163$$, $y$$141$$, $w$$31$$, $h$$24$$));
  $disState$$.$addChild$(new dvt.$Image$($ctx$$4$$, $options$$194$$._resources.overflow_dis.src, $scale$$42_x$$163$$, $y$$141$$, $w$$31$$, $h$$24$$));
  ...
  $keyboardFocusEffect_width$$81$$ = new dvt.$KeyboardFocusEffect$(this.$_nbox$.$getCtx$(), this, new dvt.$Rectangle$(-1, -1, $keyboardFocusEffect_width$$81$$ + 2, $height$$73$$ + 2));
  $DvtNBoxDataUtils$$.$setDisplayable$(this.$_nbox$, this, $keyboardFocusEffect_width$$81$$, "focusEffect");
...
$DvtNBoxCategoryNode$$.newInstance = function $$DvtNBoxCategoryNode$$$newInstance$($nbox$$7$$, $data$$66$$) {
  var $component$$17$$ = new $DvtNBoxCategoryNode$$;
  $component$$17$$.Init($nbox$$7$$, $data$$66$$);
  return $component$$17$$
};
...
$JSCompiler_prototypeAlias$$.$getDatatip$ = function $$JSCompiler_prototypeAlias$$$$getDatatip$$() {
  ...
  if($tooltipFunc$$6$$) {
    var $dataContext$$8$$ = {id:this.$_data$.id, color:$DvtNBoxStyleUtils$$.$getCategoryNodeColor$(this.$_nbox$, this.$_data$), indicatorColor:$DvtNBoxStyleUtils$$.$getCategoryNodeIndicatorColor$(this.$_nbox$, this.$_data$), size:this.$_data$.nodeIndices.length};
    "withinCell" == $DvtNBoxDataUtils$$.$getGroupBehavior$(this.$_nbox$) && ($dataContext$$8$$.row = $DvtNBoxDataUtils$$.$getCell$(this.$_nbox$, this.$_data$.cell).row, $dataContext$$8$$.column = $DvtNBoxDataUtils$$.$getCell$(this.$_nbox$, this.$_data$.cell).column);
    return this.$_nbox$.$getCtx$().$getTooltipManager$().$getCustomTooltip$($tooltipFunc$$6$$, $dataContext$$8$$)
  }
...
function $JSCompiler_StaticMethods_openDrawer$$($JSCompiler_StaticMethods_openDrawer$self$$) {
  var $options$$195$$ = $JSCompiler_StaticMethods_getSanitizedOptions$$($JSCompiler_StaticMethods_openDrawer$self$$.$_nbox$);
  $options$$195$$[dvt.$NBoxConstants$.$DRAWER$] = {id:$JSCompiler_StaticMethods_openDrawer$self$$.getId()};
  ...
  $JSCompiler_StaticMethods_openDrawer$self$$.$_nbox$.$render$($options$$195$$)
}
...
$DvtNBoxCategoryNode$$.$compareSize$ = function $$DvtNBoxCategoryNode$$$$compareSize$$($a$$49$$, $b$$22$$) {
  var $alength$$ = $a$$49$$.nodeIndices.length, $blength$$ = $b$$22$$.nodeIndices.length;
...
function $DvtNBoxCategoryRolloverHandler$$($callback$$87$$, $callbackObj$$57$$) {
  $DvtNBoxCategoryRolloverHandler$$.$superclass$.constructor.call(this, $callback$$87$$, $callbackObj$$57$$);
...
$DvtNBoxDrawer$$.newInstance = function $$DvtNBoxDrawer$$$newInstance$($nbox$$9$$, $data$$68$$) {
  var $component$$18$$ = new $DvtNBoxDrawer$$;
  $component$$18$$.Init($nbox$$9$$, $data$$68$$);
  return $component$$18$$
};
...
$JSCompiler_prototypeAlias$$.$closeDrawer$ = function $$JSCompiler_prototypeAlias$$$$closeDrawer$$() {
  var $options$$196$$ = $JSCompiler_StaticMethods_getSanitizedOptions$$(this.$_nbox$);
  $options$$196$$[dvt.$NBoxConstants$.$DRAWER$] = $JSCompiler_alias_NULL$$;
...
$JSCompiler_prototypeAlias$$.$getAriaLabel$ = function $$JSCompiler_prototypeAlias$$$$getAriaLabel$$() {
  var $categoryNode$$ = $DvtNBoxDataUtils$$.$getDisplayable$(this.$_nbox$, $DvtNBoxDataUtils$$.$getCategoryNode$(this.$_nbox$, this.getData().id)), $selected$$31$$ = $DvtNBoxDataUtils$$.$isDrawerSelected$(this.$_nbox$, $categoryNode$$);
  return $DvtNBoxDataUtils$$.$buildAriaDesc$(this.$_nbox$, this, $categoryNode$$.$getShortDesc$(), $selected$$31$$)
};
$JSCompiler_prototypeAlias$$.$getKeyboardBoundingBox$ = function $$JSCompiler_prototypeAlias$$$$getKeyboardBoundingBox$$() {
  return $DvtNBoxKeyboardHandler$getKeyboardBoundingBox$$(this)
};
...
function $DvtNBoxDataAnimationHandler$$($context$$253$$, $deleteContainer$$9$$, $oldNBox$$2$$, $newNBox$$) {
  this.Init($context$$253$$, $deleteContainer$$9$$, $oldNBox$$2$$, $newNBox$$)
}
dvt.$Obj$.$createSubclass$($DvtNBoxDataAnimationHandler$$, dvt.$DataAnimationHandler$);
$DvtNBoxDataAnimationHandler$$.prototype.Init = function $$DvtNBoxDataAnimationHandler$$$$Init$($context$$254$$, $deleteContainer$$10$$, $oldNBox$$3$$, $newNBox$$1$$) {
  $DvtNBoxDataAnimationHandler$$.$superclass$.Init.call(this, $context$$254$$, $deleteContainer$$10$$);
...
$JSCompiler_prototypeAlias$$.$ProcessRolloverEvent$ = function $$JSCompiler_prototypeAlias$$$$ProcessRolloverEvent$$($event$$338_options$$197$$, $categories$$17_hoverBehaviorDelay$$3_obj$$156$$, $bOver$$9_rolloverEvent$$4$$) {
  $event$$338_options$$197$$ = this.$_nbox$.$getOptions$();
  "dim" == $event$$338_options$$197$$.hoverBehavior && ($categories$$17_hoverBehaviorDelay$$3_obj$$156$$ = $categories$$17_hoverBehaviorDelay$$3_obj$$156$$.$getCategories$ ? $categories$$17_hoverBehaviorDelay$$3_obj$$156$$.$getCategories$() : [], $event$$338_options$$197$$.highlightedCategories = $bOver$$9_rolloverEvent$$4$$ ? $categories$$17_hoverBehaviorDelay$$3_obj$$156$$.slice() : $JSCompiler_alias_NULL$$, $bOver$$9_rolloverEvent$$4$$ = dvt.$EventFactory$.$newCategoryHighlightEvent$($event$$338_options$$197$$.highlightedCategories, 
  $bOver$$9_rolloverEvent$$4$$), $categories$$17_hoverBehaviorDelay$$3_obj$$156$$ = dvt.$StyleUtils$.$getTimeMilliseconds$($event$$338_options$$197$$.styleDefaults.hoverBehaviorDelay), this.$RolloverHandler$.$processEvent$($bOver$$9_rolloverEvent$$4$$, $JSCompiler_StaticMethods_getNodeDisplayables$$(this.$_nbox$), $categories$$17_hoverBehaviorDelay$$3_obj$$156$$, "any" == $event$$338_options$$197$$.highlightMatch))
};
$JSCompiler_prototypeAlias$$.$CreateCategoryRolloverHandler$ = function $$JSCompiler_prototypeAlias$$$$CreateCategoryRolloverHandler$$($callback$$90$$, $callbackObj$$58$$) {
  return new $DvtNBoxCategoryRolloverHandler$$($callback$$90$$, $callbackObj$$58$$)
};
...
$JSCompiler_prototypeAlias$$.$GetTouchResponse$ = function $$JSCompiler_prototypeAlias$$$$GetTouchResponse$$() {
  var $options$$198$$ = this.$_nbox$.$getOptions$(), $drawerData$$4$$ = $DvtNBoxDataUtils$$.$getDrawer$(this.$_nbox$), $cellData$$5$$ = $DvtNBoxDataUtils$$.$getCell$(this.$_nbox$, $DvtNBoxDataUtils$$.$getMaximizedCellIndex$(this.$_nbox$));
  return $drawerData$$4$$ && $DvtNBoxDataUtils$$.$getDisplayable$(this.$_nbox$, $drawerData$$4$$).$getChildContainer$().$hasScrollingContent$() || $cellData$$5$$ && $DvtNBoxDataUtils$$.$getDisplayable$(this.$_nbox$, $cellData$$5$$).$getChildContainer$().$hasScrollingContent$() ? dvt.$EventManager$.$TOUCH_RESPONSE_TOUCH_HOLD$ : $options$$198$$.touchResponse === dvt.$EventManager$.$TOUCH_RESPONSE_TOUCH_START$ ? dvt.$EventManager$.$TOUCH_RESPONSE_TOUCH_START$ : dvt.$EventManager$.$TOUCH_RESPONSE_AUTO$
};
...
function $DvtNBoxKeyboardHandler$getKeyboardBoundingBox$$($obj$$158_stageP2$$3$$) {
  var $bounds$$106$$ = $obj$$158_stageP2$$3$$.$getDimensions$(), $stageP1$$3$$ = $obj$$158_stageP2$$3$$.$localToStage$(new dvt.$Point$($bounds$$106$$.x, $bounds$$106$$.y));
  $obj$$158_stageP2$$3$$ = $obj$$158_stageP2$$3$$.$localToStage$(new dvt.$Point$($bounds$$106$$.x + $bounds$$106$$.$w$, $bounds$$106$$.y + $bounds$$106$$.$h$));
...
$DvtNBoxAutomation$$.prototype.$GetSubIdForDomElement$ = function $$DvtNBoxAutomation$$$$$GetSubIdForDomElement$$($displayable$$47_index$$166$$) {
  for(var $cell$$9_id$$130$$ = $JSCompiler_StaticMethods__getParentObject$$($displayable$$47_index$$166$$, $DvtNBoxCell$$), $drawer$$3$$ = $JSCompiler_StaticMethods__getParentObject$$($displayable$$47_index$$166$$, $DvtNBoxDrawer$$);$displayable$$47_index$$166$$ && !($displayable$$47_index$$166$$ instanceof dvt.$NBox$);) {
    var $nBox$$ = this.$getComponent$(), $component$$19_r$$28_values$$10$$, $action$$22$$;
    if($displayable$$47_index$$166$$ instanceof $DvtNBoxNode$$) {
      return $displayable$$47_index$$166$$ = $DvtNBoxDataUtils$$.$getNodeIndex$($nBox$$, $displayable$$47_index$$166$$.getData().id), $component$$19_r$$28_values$$10$$ = $JSCompiler_StaticMethods__createBrackets$$([$displayable$$47_index$$166$$]), $component$$19_r$$28_values$$10$$ = "node" + $component$$19_r$$28_values$$10$$, this.$_createSubId$($component$$19_r$$28_values$$10$$, $action$$22$$)
    }
    if($cell$$9_id$$130$$) {
      $component$$19_r$$28_values$$10$$ = $cell$$9_id$$130$$.getData().row;
      var $c$$18$$ = $cell$$9_id$$130$$.getData().column;
      $cell$$9_id$$130$$.$getChildContainer$();
      $component$$19_r$$28_values$$10$$ = $JSCompiler_StaticMethods__createBrackets$$([$component$$19_r$$28_values$$10$$, $c$$18$$]);
      $component$$19_r$$28_values$$10$$ = "cell" + $component$$19_r$$28_values$$10$$;
      if($displayable$$47_index$$166$$ instanceof $DvtNBoxCell$$) {
        return this.$_createSubId$($component$$19_r$$28_values$$10$$, $action$$22$$)
      }
    ...
    if($displayable$$47_index$$166$$ instanceof $DvtNBoxCategoryNode$$) {
      return $cell$$9_id$$130$$ = $displayable$$47_index$$166$$.getData().id, $component$$19_r$$28_values$$10$$ = "groupNode", $component$$19_r$$28_values$$10$$ = $DvtNBoxDataUtils$$.$getNode$($nBox$$, $displayable$$47_index$$166$$.getData().nodeIndices[0]).groupCategory ? $component$$19_r$$28_values$$10$$ + $JSCompiler_StaticMethods__createBrackets$$([$cell$$9_id$$130$$]) : $component$$19_r$$28_values$$10$$ + $JSCompiler_StaticMethods__createBraces$$($cell$$9_id$$130$$.split(";")), this.$_createSubId$($component$$19_r$$28_values$$10$$, 
      $action$$22$$)
    }
...
$DvtNBoxAutomation$$.prototype.$_createSubId$ = function $$DvtNBoxAutomation$$$$$_createSubId$$($component$$20$$, $action$$23$$) {
  var $subId$$24$$ = $component$$20$$;
...
$DvtNBoxAutomation$$.prototype.$getDomElementForSubId$ = function $$DvtNBoxAutomation$$$$$getDomElementForSubId$$($displayable$$48_parsedId_subId$$25$$) {
  ...
  var $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $displayable$$48_parsedId_subId$$25$$.component, $action$$24$$ = $displayable$$48_parsedId_subId$$25$$.action, $j$$72_values$$11$$ = $JSCompiler_alias_NULL$$, $colCount$$inline_4420_container$$141_data$$71$$ = $JSCompiler_alias_NULL$$;
  $displayable$$48_parsedId_subId$$25$$ = $JSCompiler_alias_NULL$$;
  0 === $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.lastIndexOf("node", 0) && ($j$$72_values$$11$$ = $JSCompiler_StaticMethods__parseBrackets$$($cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$, $JSCompiler_alias_TRUE$$), $colCount$$inline_4420_container$$141_data$$71$$ = $DvtNBoxDataUtils$$.$getNode$($id$$131_nBox$$1$$, $j$$72_values$$11$$[0]), $displayable$$48_parsedId_subId$$25$$ = $DvtNBoxDataUtils$$.$getDisplayable$($id$$131_nBox$$1$$, $colCount$$inline_4420_container$$141_data$$71$$));
  if(0 === $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.lastIndexOf("cell", 0)) {
    var $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ = $j$$72_values$$11$$ = $JSCompiler_StaticMethods__parseBrackets$$($cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$), $count$$15_nBox$$inline_4419$$ = this.$getComponent$(), $colCount$$inline_4420_container$$141_data$$71$$ = $DvtNBoxDataUtils$$.$getColumnCount$($count$$15_nBox$$inline_4419$$), $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $DvtNBoxDataUtils$$.$getRowIndex$($count$$15_nBox$$inline_4419$$, 
    $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$[0]), $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ = $DvtNBoxDataUtils$$.$getColumnIndex$($count$$15_nBox$$inline_4419$$, $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$[1]), $colCount$$inline_4420_container$$141_data$$71$$ = $DvtNBoxDataUtils$$.$getCell$($id$$131_nBox$$1$$, $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ != $JSCompiler_alias_NULL$$ && $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ != 
    $JSCompiler_alias_NULL$$ ? $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ + $colCount$$inline_4420_container$$141_data$$71$$ * $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ : $JSCompiler_alias_NULL$$);
    if(!$colCount$$inline_4420_container$$141_data$$71$$) {
      return $JSCompiler_alias_NULL$$
    }
    $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $DvtNBoxDataUtils$$.$getDisplayable$($id$$131_nBox$$1$$, $colCount$$inline_4420_container$$141_data$$71$$);
    if($action$$24$$) {
      $colCount$$inline_4420_container$$141_data$$71$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.$getChildContainer$();
      $colCount$$inline_4420_container$$141_data$$71$$.$getScrollingPane$ && ($colCount$$inline_4420_container$$141_data$$71$$ = $colCount$$inline_4420_container$$141_data$$71$$.$_container$);
      if("overflow" == $action$$24$$) {
        for($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ = $colCount$$inline_4420_container$$141_data$$71$$.$getNumChildren$();0 < $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$;$colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$--) {
          if($colCount$$inline_4420_container$$141_data$$71$$.$getChildAt$($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ - 1) instanceof $DvtNBoxNodeOverflow$$) {
            $displayable$$48_parsedId_subId$$25$$ = $colCount$$inline_4420_container$$141_data$$71$$.$getChildAt$($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ - 1).$_button$;
            break
          }
        }
      }
      "closeButton" == $action$$24$$ && ($displayable$$48_parsedId_subId$$25$$ = $DvtNBoxDataUtils$$.$getDisplayable$($id$$131_nBox$$1$$, $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.getData(), "closeButton"));
      if(0 === $action$$24$$.lastIndexOf("node", 0)) {
        $j$$72_values$$11$$ = $JSCompiler_StaticMethods__parseBrackets$$($action$$24$$, $JSCompiler_alias_TRUE$$);
        $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ = $j$$72_values$$11$$[0];
        if(0 > $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$) {
          return $JSCompiler_alias_NULL$$
        }
        $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $DvtNBoxDataUtils$$.$getFirstNavigableNode$($id$$131_nBox$$1$$, $colCount$$inline_4420_container$$141_data$$71$$);
        for($count$$15_nBox$$inline_4419$$ = 0;$cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ instanceof $DvtNBoxNode$$;) {
          if($count$$15_nBox$$inline_4419$$ == $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$) {
            $displayable$$48_parsedId_subId$$25$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$;
            break
          }
          $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $DvtNBoxDataUtils$$.$getDisplayable$($id$$131_nBox$$1$$, $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.getData().__next);
          $count$$15_nBox$$inline_4419$$++
        }
      }
      if(0 === $action$$24$$.lastIndexOf("groupNode", 0)) {
        var $dialog_dialogContainer_value$$151$$;
        -1 < $action$$24$$.indexOf("{") ? $j$$72_values$$11$$ = $JSCompiler_StaticMethods__parseBraces$$($action$$24$$) : $dialog_dialogContainer_value$$151$$ = $action$$24$$.substring($action$$24$$.indexOf("[") + 1, $action$$24$$.indexOf("]"));
        for($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ = 0;$colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ < $colCount$$inline_4420_container$$141_data$$71$$.$getNumChildren$();$colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$++) {
          if($cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $colCount$$inline_4420_container$$141_data$$71$$.$getChildAt$($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$), $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ instanceof $DvtNBoxCategoryNode$$) {
            if($id$$131_nBox$$1$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.getData().id, $j$$72_values$$11$$ && $JSCompiler_StaticMethods__compareCategories$$($j$$72_values$$11$$, $id$$131_nBox$$1$$.split(";"))) {
              $displayable$$48_parsedId_subId$$25$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$;
              break
            }else {
    ...
    if(0 === $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.lastIndexOf("groupNode", 0)) {
      $colCount$$inline_4420_container$$141_data$$71$$ = $id$$131_nBox$$1$$.$getChildContainer$();
      -1 < $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.indexOf("{") ? $j$$72_values$$11$$ = $JSCompiler_StaticMethods__parseBraces$$($cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$) : $dialog_dialogContainer_value$$151$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.substring($cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.indexOf("[") + 1, $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.indexOf("]"));
      for($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ = 0;$colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ < $colCount$$inline_4420_container$$141_data$$71$$.$getNumChildren$();$colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$++) {
        if($cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $colCount$$inline_4420_container$$141_data$$71$$.$getChildAt$($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$), $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ instanceof $DvtNBoxCategoryNode$$) {
          if($id$$131_nBox$$1$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$.getData().id, $j$$72_values$$11$$ && $JSCompiler_StaticMethods__compareCategories$$($j$$72_values$$11$$, $id$$131_nBox$$1$$.split(";"))) {
            $displayable$$48_parsedId_subId$$25$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$;
      ...
      if("dialog" === $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ && ($colCount$$inline_4420_container$$141_data$$71$$ = $id$$131_nBox$$1$$.$getChildContainer$())) {
        for($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ = 0;$colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$ < $colCount$$inline_4420_container$$141_data$$71$$.$getNumChildren$();$colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$++) {
          if($colCount$$inline_4420_container$$141_data$$71$$.$getChildAt$($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$) instanceof $DvtNBoxDrawer$$) {
            $dialog_dialogContainer_value$$151$$ = $colCount$$inline_4420_container$$141_data$$71$$.$getChildAt$($colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$);
            if($action$$24$$) {
              if("closeButton" == $action$$24$$) {
                for($j$$72_values$$11$$ = 0;$j$$72_values$$11$$ < $dialog_dialogContainer_value$$151$$.$getNumChildren$();$j$$72_values$$11$$++) {
                  $dialog_dialogContainer_value$$151$$.$getChildAt$($j$$72_values$$11$$) instanceof dvt.$Button$ && ($displayable$$48_parsedId_subId$$25$$ = $dialog_dialogContainer_value$$151$$.$getChildAt$($j$$72_values$$11$$))
                }
              }
              if(0 === $action$$24$$.lastIndexOf("node", 0)) {
                ...
                $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ = $DvtNBoxDataUtils$$.$getFirstNavigableNode$($id$$131_nBox$$1$$, $dialog_dialogContainer_value$$151$$);
                for($count$$15_nBox$$inline_4419$$ = 0;$cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$ instanceof $DvtNBoxNode$$;) {
                  if($count$$15_nBox$$inline_4419$$ == $colIndex$$inline_4422_i$$504_nodeIndex$$8_values$$inline_4418$$) {
                    $displayable$$48_parsedId_subId$$25$$ = $cell$$10_component$$21_node$$249_rowIndex$$inline_4421$$;
                    break
...
$DvtNBoxAutomation$$.prototype.$_parseSubId$ = function $$DvtNBoxAutomation$$$$$_parseSubId$$($subId$$26$$) {
  var $component$$22$$ = $JSCompiler_alias_NULL$$, $action$$25$$ = $JSCompiler_alias_NULL$$, $hashIndex$$ = $subId$$26$$.indexOf("#");
  -1 !== $hashIndex$$ ? ($component$$22$$ = $subId$$26$$.substring(0, $hashIndex$$), $action$$25$$ = $subId$$26$$.substring($hashIndex$$ + 1)) : $component$$22$$ = $subId$$26$$;
  return{component:$component$$22$$, action:$action$$25$$}
};
...
$DvtNBoxAutomation$$.prototype.$_getMarkerData$ = function $$DvtNBoxAutomation$$$$$_getMarkerData$$($marker$$9$$) {
  if($marker$$9$$) {
    var $data$$76$$ = {};
    $data$$76$$.shape = $marker$$9$$ instanceof dvt.$SimpleMarker$ ? $marker$$9$$.$getType$() : "none";
    $marker$$9$$.$getFill$() && ($data$$76$$.color = $marker$$9$$.$getFill$().$getColor$());
    return $data$$76$$
  }
  return $JSCompiler_alias_NULL$$
};
...
$DvtNBoxRenderer$$.$_renderLegend$ = function $$DvtNBoxRenderer$$$$_renderLegend$$($nbox$$16$$, $container$$144_legendDwn_legendDwnImg$$, $availSpace$$99$$) {
  ...
  if($legendData$$4$$ && $legendData$$4$$.sections) {
    var $dims$$45_options$$199$$ = $nbox$$16$$.$getOptions$(), $rtl$$16$$ = dvt.$Agent$.$isRightToLeft$($nbox$$16$$.$getCtx$()), $panelDrawer$$3$$ = new dvt.$PanelDrawer$($nbox$$16$$.$getCtx$(), $nbox$$16$$.$processEvent$, $nbox$$16$$, "pd1");
    ...
    $panelDrawer$$3$$.$setMaxHeight$($availSpace$$99$$.$h$ - $dims$$45_options$$199$$.__layout.legendBottomGap);
    ...
    var $legendEna_legendEnaImg_preferredSize$$4$$ = $dims$$45_options$$199$$._resources.legend_ena, $legendOvr_legendOvrImg$$ = $dims$$45_options$$199$$._resources.legend_ovr;
    $container$$144_legendDwn_legendDwnImg$$ = $dims$$45_options$$199$$._resources.legend_dwn;
    ...
    "disclosed" == $dims$$45_options$$199$$[dvt.$NBoxConstants$.$LEGEND_DISCLOSURE$] && ($panelDrawer$$3$$.$setDisplayedPanelId$("legend"), $panelDrawer$$3$$.$setDisclosed$($JSCompiler_alias_TRUE$$, $JSCompiler_alias_TRUE$$));
    $dims$$45_options$$199$$ = $panelDrawer$$3$$.$getDimensions$();
    $panelDrawer$$3$$.$setTranslate$($rtl$$16$$ ? 0 : $availSpace$$99$$.$w$, 0);
    $rtl$$16$$ && ($availSpace$$99$$.x += $dims$$45_options$$199$$.$w$);
    $availSpace$$99$$.$w$ -= $dims$$45_options$$199$$.$w$;
...
$DvtNBoxRenderer$$.$_renderTitles$ = function $$DvtNBoxRenderer$$$$_renderTitles$$($nbox$$17$$, $container$$145$$, $availSpace$$100$$) {
  var $i$$508_options$$200$$ = $nbox$$17$$.$getOptions$(), $columnCount$$ = $DvtNBoxDataUtils$$.$getColumnCount$($nbox$$17$$), $rowCount$$ = $DvtNBoxDataUtils$$.$getRowCount$($nbox$$17$$), $componentGap_maximizedColumnIndex$$ = $i$$508_options$$200$$.__layout.componentGap, $rowHeaderWidth_titleGap$$3$$ = $i$$508_options$$200$$.__layout.titleGap, $columnHeaderHeight_titleComponentGap$$ = $i$$508_options$$200$$.__layout.titleComponentGap, $rtl$$17$$ = dvt.$Agent$.$isRightToLeft$($nbox$$17$$.$getCtx$());
  ...
  $i$$508_options$$200$$[dvt.$NBoxConstants$.$COLUMNS_TITLE$] && ($cellDims_columnsTitle$$ = $DvtNBoxRenderer$$.$createText$($nbox$$17$$.$getCtx$(), $i$$508_options$$200$$[dvt.$NBoxConstants$.$COLUMNS_TITLE$], $i$$508_options$$200$$[dvt.$NBoxConstants$.$STYLE_DEFAULTS$][dvt.$NBoxConstants$.$COLUMNS_TITLE_STYLE$], dvt.$OutputText$.$H_ALIGN_CENTER$, dvt.$OutputText$.$V_ALIGN_MIDDLE$), $container$$145$$.$addChild$($cellDims_columnsTitle$$), $columnsTitleHeight$$ = dvt.$TextUtils$.$guessTextDimensions$($cellDims_columnsTitle$$).$h$);
  $i$$508_options$$200$$[dvt.$NBoxConstants$.$ROWS_TITLE$] && ($rowsTitle$$ = $DvtNBoxRenderer$$.$createText$($nbox$$17$$.$getCtx$(), $i$$508_options$$200$$[dvt.$NBoxConstants$.$ROWS_TITLE$], $i$$508_options$$200$$[dvt.$NBoxConstants$.$STYLE_DEFAULTS$][dvt.$NBoxConstants$.$ROWS_TITLE_STYLE$], dvt.$OutputText$.$H_ALIGN_CENTER$, dvt.$OutputText$.$V_ALIGN_MIDDLE$), $container$$145$$.$addChild$($rowsTitle$$), $rowsTitleWidth$$ = dvt.$TextUtils$.$guessTextDimensions$($rowsTitle$$).$h$);
  for($i$$508_options$$200$$ = 0;$i$$508_options$$200$$ < $columnCount$$;$i$$508_options$$200$$++) {
    var $column_rowLabel$$ = $DvtNBoxDataUtils$$.$getColumn$($nbox$$17$$, $i$$508_options$$200$$);
    if($column_rowLabel$$[dvt.$NBoxConstants$.$LABEL$]) {
      var $columnLabel$$ = $DvtNBoxRenderer$$.$createText$($nbox$$17$$.$getCtx$(), $column_rowLabel$$[dvt.$NBoxConstants$.$LABEL$], $DvtNBoxStyleUtils$$.$getColumnLabelStyle$($nbox$$17$$, $i$$508_options$$200$$), dvt.$OutputText$.$H_ALIGN_CENTER$, dvt.$OutputText$.$V_ALIGN_MIDDLE$), $columnLabelsHeight$$ = Math.max($columnLabelsHeight$$, dvt.$TextUtils$.$guessTextDimensions$($columnLabel$$).$h$);
      if(!$maximizedColumn$$4_row$$4$$ || $maximizedColumn$$4_row$$4$$ == $column_rowLabel$$[dvt.$NBoxConstants$.ID]) {
        $columnLabels$$[$i$$508_options$$200$$] = $columnLabel$$, $container$$145$$.$addChild$($columnLabels$$[$i$$508_options$$200$$])
      }
    }
  }
  for($i$$508_options$$200$$ = 0;$i$$508_options$$200$$ < $rowCount$$;$i$$508_options$$200$$++) {
    if($maximizedColumn$$4_row$$4$$ = $DvtNBoxDataUtils$$.$getRow$($nbox$$17$$, $i$$508_options$$200$$), $maximizedColumn$$4_row$$4$$[dvt.$NBoxConstants$.$LABEL$] && ($column_rowLabel$$ = $DvtNBoxRenderer$$.$createText$($nbox$$17$$.$getCtx$(), $maximizedColumn$$4_row$$4$$[dvt.$NBoxConstants$.$LABEL$], $DvtNBoxStyleUtils$$.$getRowLabelStyle$($nbox$$17$$, $i$$508_options$$200$$), dvt.$OutputText$.$H_ALIGN_CENTER$, dvt.$OutputText$.$V_ALIGN_MIDDLE$), $rowLabelsWidth$$ = Math.max($rowLabelsWidth$$, dvt.$TextUtils$.$guessTextDimensions$($column_rowLabel$$).$h$), 
    !$maximizedRow$$4$$ || $maximizedRow$$4$$ == $maximizedColumn$$4_row$$4$$[dvt.$NBoxConstants$.ID])) {
      $rowLabels$$[$i$$508_options$$200$$] = $column_rowLabel$$, $container$$145$$.$addChild$($rowLabels$$[$i$$508_options$$200$$])
    }
  }
  ...
  for($i$$508_options$$200$$ = 0;$i$$508_options$$200$$ < $columnCount$$;$i$$508_options$$200$$++) {
    $columnLabels$$[$i$$508_options$$200$$] && ($cellDims_columnsTitle$$ = $DvtNBoxCellRenderer$$.$getCellDimensions$($nbox$$17$$, -1 == $maximizedRowIndex$$ ? 0 : $maximizedRowIndex$$, $i$$508_options$$200$$, $availSpace$$100$$), dvt.$TextUtils$.$fitText$($columnLabels$$[$i$$508_options$$200$$], $cellDims_columnsTitle$$.$w$, $columnLabelsHeight$$, $container$$145$$) && ($DvtNBoxRenderer$$.$positionText$($columnLabels$$[$i$$508_options$$200$$], $cellDims_columnsTitle$$.x + $cellDims_columnsTitle$$.$w$ / 
    2, $availSpace$$100$$.y + $availSpace$$100$$.$h$ + $columnTitleComponentGap$$ + $columnLabelsHeight$$ / 2), $DvtNBoxDataUtils$$.$setDisplayable$($nbox$$17$$, $DvtNBoxDataUtils$$.$getColumn$($nbox$$17$$, $i$$508_options$$200$$), $columnLabels$$[$i$$508_options$$200$$], dvt.$NBoxConstants$.$LABEL$)))
  }
  for($i$$508_options$$200$$ = 0;$i$$508_options$$200$$ < $rowCount$$;$i$$508_options$$200$$++) {
    $rowLabels$$[$i$$508_options$$200$$] && ($cellDims_columnsTitle$$ = $DvtNBoxCellRenderer$$.$getCellDimensions$($nbox$$17$$, $i$$508_options$$200$$, -1 == $componentGap_maximizedColumnIndex$$ ? 0 : $componentGap_maximizedColumnIndex$$, $availSpace$$100$$), dvt.$TextUtils$.$fitText$($rowLabels$$[$i$$508_options$$200$$], $cellDims_columnsTitle$$.$h$, $rowLabelsWidth$$, $container$$145$$) && ($DvtNBoxRenderer$$.$positionText$($rowLabels$$[$i$$508_options$$200$$], $availSpace$$100$$.x + ($rtl$$17$$ ? 
    $availSpace$$100$$.$w$ : 0) + ($rtl$$17$$ ? 1 : -1) * ($rowTitleComponentGap$$ + $rowLabelsWidth$$ / 2), $cellDims_columnsTitle$$.y + $cellDims_columnsTitle$$.$h$ / 2, $rtl$$17$$ ? Math.PI / 2 : -Math.PI / 2), $DvtNBoxDataUtils$$.$setDisplayable$($nbox$$17$$, $DvtNBoxDataUtils$$.$getRow$($nbox$$17$$, $i$$508_options$$200$$), $rowLabels$$[$i$$508_options$$200$$], dvt.$NBoxConstants$.$LABEL$)))
  }
};
        ...
        if(!(0 == $cellRows_gridXOrigin_prevNode$$ || 0 == $cellColumns_overflowContainer$$ || 1 == $cellRows_gridXOrigin_prevNode$$ && 1 == $cellColumns_overflowContainer$$ && $cellIndex$$5_cellLayout$$1$$.overflow)) {
          for(var $maxNodes$$ = $cellRows_gridXOrigin_prevNode$$ * $cellColumns_overflowContainer$$ - ($cellIndex$$5_cellLayout$$1$$.overflow ? 1 : 0), $n$$16$$ = 0;$n$$16$$ < $nodes$$13$$.length;$n$$16$$++) {
            ...
            if(0 > $maxNodes$$ || $n$$16$$ < $maxNodes$$) {
              var $cellContainer$$1$$ = $DvtNBoxDataUtils$$.$getDisplayable$($nbox$$23$$, $cell$$12$$).$getChildContainer$(), $scrolling$$ = $cellContainer$$1$$ instanceof dvt.$SimpleScrollableContainer$, $nodeContainer$$ = $DvtNBoxNode$$.newInstance($nbox$$23$$, $node$$253$$), $cellRows_gridXOrigin_prevNode$$ = $cell$$12$$.__childArea.x + ($cell$$12$$.__childArea.$w$ - $cellIndex$$5_cellLayout$$1$$.cellColumns * $hGridSize$$ + $gridGap$$) / 2, $gridYOrigin$$ = $scrolling$$ ? $gridGap$$ : $cell$$12$$.__childArea.y, 
...
$DvtNBoxRenderer$$.$_renderCategoryNodes$ = function $$DvtNBoxRenderer$$$$_renderCategoryNodes$$($nbox$$24$$, $cellCount$$5_columnCount$$5_container$$149$$, $availSpace$$104_layouts$$) {
  ...
  for($i$$512_n$$17_otherGroups$$1_rowCount$$5$$ = 0;$i$$512_n$$17_otherGroups$$1_rowCount$$5$$ < $nodeContainer$$1_nodeCount$$6$$;$i$$512_n$$17_otherGroups$$1_rowCount$$5$$++) {
    if($highlightedItems$$4_node$$254_positions$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$24$$, $i$$512_n$$17_otherGroups$$1_rowCount$$5$$), !$DvtNBoxDataUtils$$.$isNodeHidden$($nbox$$24$$, $highlightedItems$$4_node$$254_positions$$)) {
      ...
      if($groupBehavior$$1_scale$$44$$ == dvt.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$) {
        var $groupId$$23_j$$73$$ = $DvtNBoxDataUtils$$.$getCellIndex$($nbox$$24$$, $highlightedItems$$4_node$$254_positions$$) + "", $groupContainer_scrolling$$1_yPos$$ = $groups$$9$$[$groupId$$23_j$$73$$];
        $groupContainer_scrolling$$1_yPos$$ || ($groupContainer_scrolling$$1_yPos$$ = {}, $groups$$9$$[$groupId$$23_j$$73$$] = $groupContainer_scrolling$$1_yPos$$)
      }
      var $groupId$$23_j$$73$$ = $DvtNBoxDataUtils$$.$getNodeGroupId$($highlightedItems$$4_node$$254_positions$$), $group$$27$$ = $groupContainer_scrolling$$1_yPos$$[$groupId$$23_j$$73$$];
      $group$$27$$ || ($group$$27$$ = {}, $group$$27$$[dvt.$NBoxConstants$.ID] = $groupId$$23_j$$73$$, $groupBehavior$$1_scale$$44$$ == dvt.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$ && ($group$$27$$[dvt.$NBoxConstants$.$CELL$] = $DvtNBoxDataUtils$$.$getCellIndex$($nbox$$24$$, $highlightedItems$$4_node$$254_positions$$)), $group$$27$$.nodeIndices = [], $group$$27$$.highlightedCount = 0, $groupContainer_scrolling$$1_yPos$$[$groupId$$23_j$$73$$] = $group$$27$$);
  ...
  if($groupBehavior$$1_scale$$44$$ == dvt.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$) {
    var $i$$512_n$$17_otherGroups$$1_rowCount$$5$$ = {}, $cellId_center$$6_sortedGroups$$;
    for($cellId_center$$6_sortedGroups$$ in $groups$$9$$) {
      $i$$512_n$$17_otherGroups$$1_rowCount$$5$$[$cellId_center$$6_sortedGroups$$] = $DvtNBoxRenderer$$.$_processOtherThreshold$($nbox$$24$$, $groups$$9$$[$cellId_center$$6_sortedGroups$$])
    }
  }else {
  ...
  if($groupBehavior$$1_scale$$44$$ == dvt.$NBoxConstants$.$GROUP_BEHAVIOR_ACROSS_CELLS$) {
    $cellId_center$$6_sortedGroups$$ = [];
    for($group$$27$$ in $groups$$9$$) {
      $cellId_center$$6_sortedGroups$$.push($group$$27$$)
    }
    $cellId_center$$6_sortedGroups$$.sort(function($nbox$$24$$, $cellCount$$5_columnCount$$5_container$$149$$) {
    ...
    for($i$$512_n$$17_otherGroups$$1_rowCount$$5$$ = 0;$i$$512_n$$17_otherGroups$$1_rowCount$$5$$ < $cellId_center$$6_sortedGroups$$.length;$i$$512_n$$17_otherGroups$$1_rowCount$$5$$++) {
      $group$$27$$ = $cellId_center$$6_sortedGroups$$[$i$$512_n$$17_otherGroups$$1_rowCount$$5$$];
      ...
      for($groupId$$23_j$$73$$ = 0;$groupId$$23_j$$73$$ < $nodeContainer$$1_nodeCount$$6$$;$groupId$$23_j$$73$$++) {
        $highlightedItems$$4_node$$254_positions$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$24$$, $groups$$9$$[$group$$27$$].nodeIndices[$groupId$$23_j$$73$$]), $childContainer_highlightedMap$$4_xPos$$ += $DvtNBoxDataUtils$$.$getXPercentage$($nbox$$24$$, $highlightedItems$$4_node$$254_positions$$), $groupContainer_scrolling$$1_yPos$$ += $DvtNBoxDataUtils$$.$getYPercentage$($nbox$$24$$, $highlightedItems$$4_node$$254_positions$$)
      }
    ...
    if($groupBehavior$$1_scale$$44$$ == dvt.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$) {
      ...
      for($i$$512_n$$17_otherGroups$$1_rowCount$$5$$ = 0;$i$$512_n$$17_otherGroups$$1_rowCount$$5$$ < $cellCount$$5_columnCount$$5_container$$149$$;$i$$512_n$$17_otherGroups$$1_rowCount$$5$$++) {
        if($groups$$9$$[$i$$512_n$$17_otherGroups$$1_rowCount$$5$$] && !$DvtNBoxDataUtils$$.$isCellMinimized$($nbox$$24$$, $i$$512_n$$17_otherGroups$$1_rowCount$$5$$)) {
          for($group$$27$$ in $highlightedItems$$4_node$$254_positions$$ = $availSpace$$104_layouts$$[$i$$512_n$$17_otherGroups$$1_rowCount$$5$$].positions, $cellId_center$$6_sortedGroups$$ = $availSpace$$104_layouts$$[$i$$512_n$$17_otherGroups$$1_rowCount$$5$$].center, $cell$$13_rtl$$19$$ = $DvtNBoxDataUtils$$.$getCell$($nbox$$24$$, $i$$512_n$$17_otherGroups$$1_rowCount$$5$$), $childContainer_highlightedMap$$4_xPos$$ = $DvtNBoxDataUtils$$.$getDisplayable$($nbox$$24$$, $cell$$13_rtl$$19$$).$getChildContainer$(), 
...
$DvtNBoxRenderer$$.$positionText$ = function $$DvtNBoxRenderer$$$$positionText$$($text$$66$$, $x$$167$$, $y$$145$$, $angle$$35$$) {
  $text$$66$$.$setX$($x$$167$$);
  $text$$66$$.$setY$($y$$145$$);
  if($angle$$35$$) {
    var $matrix$$10$$ = $text$$66$$.$getMatrix$();
    $matrix$$10$$.translate(-$x$$167$$, -$y$$145$$);
      ...
      if($DvtNBoxDataUtils$$.$getGrouping$($nbox$$27$$)) {
        for($i$$513$$ = 0;$i$$513$$ < $objects$$4$$.length;$i$$513$$++) {
          if($objects$$4$$[$i$$513$$] instanceof $DvtNBoxCategoryNode$$) {
            for(var $nodeIndices$$3_selectedItems$$2$$ = $objects$$4$$[$i$$513$$].getData().nodeIndices, $selected$$32$$ = $JSCompiler_alias_TRUE$$, $j$$74$$ = 0;$j$$74$$ < $nodeIndices$$3_selectedItems$$2$$.length;$j$$74$$++) {
              var $node$$255$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$27$$, $nodeIndices$$3_selectedItems$$2$$[$j$$74$$]);
              if(!$selectedMap$$2$$[$node$$255$$[dvt.$NBoxConstants$.ID]]) {
                $selected$$32$$ = $JSCompiler_alias_FALSE$$;
                break
              }
            }
            $selected$$32$$ && $selectedIds$$6$$.push($objects$$4$$[$i$$513$$].getId())
          }
        }
      }
    }
...
$DvtNBoxRenderer$$.$_forceLayoutGroups$ = function $$DvtNBoxRenderer$$$$_forceLayoutGroups$$($groups$$10$$, $width$$82$$, $height$$74$$) {
  ...
  $sortedGroups$$1$$.sort(function($width$$82$$, $height$$74$$) {
    return $DvtNBoxCategoryNode$$.$compareSize$($groups$$10$$[$width$$82$$], $groups$$10$$[$height$$74$$])
  });
  ...
  for(var $alpha$$23_left$$11_thetaStep$$ = 1, $right$$11_xGravity$$ = -0.25 * $height$$74$$ / Math.max($width$$82$$, $height$$74$$), $top$$8_yGravity$$ = -0.25 * $width$$82$$ / Math.max($width$$82$$, $height$$74$$);0.005 < $alpha$$23_left$$11_thetaStep$$;) {
  ...
  return{scale:Math.min($width$$82$$ / ($right$$11_xGravity$$ - $alpha$$23_left$$11_thetaStep$$), $height$$74$$ / ($bottom$$8_displacement$$3$$ - $top$$8_yGravity$$)), center:new dvt.$Point$(($alpha$$23_left$$11_thetaStep$$ + $right$$11_xGravity$$) / 2, ($top$$8_yGravity$$ + $bottom$$8_displacement$$3$$) / 2), positions:$positions$$1$$}
};
  ...
  if($groupInfo$$4$$) {
    if($cellCount$$6_groupBehavior$$3_rowCount$$7$$ == dvt.$NBoxConstants$.$GROUP_BEHAVIOR_WITHIN_CELL$) {
      for(var $cellCount$$6_groupBehavior$$3_rowCount$$7$$ = $DvtNBoxDataUtils$$.$getRowCount$($nbox$$30$$), $columnCount$$7_i$$518$$ = $DvtNBoxDataUtils$$.$getColumnCount$($nbox$$30$$), $cellCount$$6_groupBehavior$$3_rowCount$$7$$ = $cellCount$$6_groupBehavior$$3_rowCount$$7$$ * $columnCount$$7_i$$518$$, $columnCount$$7_i$$518$$ = 0;$columnCount$$7_i$$518$$ < $cellCount$$6_groupBehavior$$3_rowCount$$7$$;$columnCount$$7_i$$518$$++) {
        for(var $cellGroupNodes$$ = $DvtNBoxRenderer$$.$_getSortedGroupsFromContainer$($nbox$$30$$, $groupInfo$$4$$[$columnCount$$7_i$$518$$ + ""]), $j$$76$$ = 0;$j$$76$$ < $cellGroupNodes$$.length;$j$$76$$++) {
          $groupNodes$$2$$.push($cellGroupNodes$$[$j$$76$$])
        }
      }
    }else {
...
$DvtNBoxCellRenderer$$.$render$ = function $$DvtNBoxCellRenderer$$$$render$$($nbox$$34$$, $cellData$$10$$, $cellContainer$$4_childArea$$, $availSpace$$109_cellIndex$$6_childContainer$$1$$) {
  var $cellBottomGap_options$$203$$ = $nbox$$34$$.$getOptions$(), $cellGap_cellRect$$ = $cellBottomGap_options$$203$$.__layout.cellGap, $cellStartGap$$ = $cellBottomGap_options$$203$$.__layout.cellStartGap, $cellEndGap$$ = $cellBottomGap_options$$203$$.__layout.cellEndGap, $cellTopGap$$ = $cellBottomGap_options$$203$$.__layout.cellTopGap, $cellBottomGap_options$$203$$ = $cellBottomGap_options$$203$$.__layout.cellBottomGap, $cellLayout$$2$$ = $DvtNBoxCellRenderer$$.$getCellLayout$($nbox$$34$$), $addedHeader_keyboardFocusEffect$$1_r$$32_style$$81$$ = 
  ...
  $addedHeader_keyboardFocusEffect$$1_r$$32_style$$81$$ ? ($cellContainer$$4_childArea$$ = $DvtNBoxCellRenderer$$.$_isLabelVertical$($nbox$$34$$, $cellData$$10$$) ? new dvt.$Rectangle$($cellLayout$$2$$.headerSize, $cellTopGap$$, $cellGap_cellRect$$.getWidth() - $cellLayout$$2$$.headerSize - $cellEndGap$$, $cellGap_cellRect$$.getHeight() - $cellTopGap$$ - $cellBottomGap_options$$203$$) : new dvt.$Rectangle$($cellStartGap$$, $cellLayout$$2$$.headerSize, $cellGap_cellRect$$.getWidth() - $cellStartGap$$ - 
  $cellEndGap$$, $cellGap_cellRect$$.getHeight() - $cellLayout$$2$$.headerSize - $cellBottomGap_options$$203$$), $availSpace$$109_cellIndex$$6_childContainer$$1$$ instanceof dvt.$SimpleScrollableContainer$ && $availSpace$$109_cellIndex$$6_childContainer$$1$$.$setTranslate$(0, $cellLayout$$2$$.headerSize)) : $cellContainer$$4_childArea$$ = new dvt.$Rectangle$($cellStartGap$$, $cellTopGap$$, $cellGap_cellRect$$.getWidth() - $cellStartGap$$ - $cellEndGap$$, $cellGap_cellRect$$.getHeight() - $cellTopGap$$ - 
  $cellBottomGap_options$$203$$);
...
$DvtNBoxCellRenderer$$.$renderHeader$ = function $$DvtNBoxCellRenderer$$$$renderHeader$$($nbox$$35$$, $cellData$$11$$, $cellContainer$$5$$, $cellCountLabel_countLabelFunc$$inline_4470_noCount$$) {
  ...
  if($cellData$$11$$) {
    var $closeEnaImg_countLabelWidth_countLabelX_options$$204$$ = $nbox$$35$$.$getOptions$(), $countLabelGap_oldClose_oldCountLabel_oldLabel$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$.__layout.countLabelGap, $cellCloseGap_labelHeight$$6$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$.__layout.cellCloseGap, $cellStartGap$$1_labelX$$3$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$.__layout.cellStartGap, $cellEndGap$$1$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$.__layout.cellEndGap, 
    $cellTopGap$$1$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$.__layout.cellTopGap, $cellLayout$$3_countLabel$$ = $DvtNBoxCellRenderer$$.$getCellLayout$($nbox$$35$$), $cellCounts$$2_countLabelOffset_labelWidth$$6$$ = $DvtNBoxRenderer$$.$getCellCounts$($nbox$$35$$), $cellRect$$1$$ = $DvtNBoxDataUtils$$.$getDisplayable$($nbox$$35$$, $cellData$$11$$, "background"), $r$$33_rtl$$21$$ = $DvtNBoxDataUtils$$.$getRowIndex$($nbox$$35$$, $cellData$$11$$[dvt.$NBoxConstants$.$ROW$]), $c$$25_cellIndex$$7_label$$58$$ = 
    ...
    if($DvtNBoxDataUtils$$.$isCellMaximized$($nbox$$35$$, $c$$25_cellIndex$$7_label$$58$$)) {
      var $closeEna_countLabelY$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$._resources.close_ena, $closeWidth_halign$$8$$ = $closeEna_countLabelY$$.width;
      $cellRect$$1$$.getWidth() - $cellStartGap$$1_labelX$$3$$ - $cellEndGap$$1$$ > $closeWidth_halign$$8$$ && ($addedHeader$$1_closeButton$$2_closeOvr_closeOvrImg$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$._resources.close_ovr, $cellCloseWidthWithGap_closeButtonX_closeDwn_closeDwnImg$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$._resources.close_dwn, $closeEnaImg_countLabelWidth_countLabelX_options$$204$$ = new dvt.$Image$($nbox$$35$$.$getCtx$(), $closeEna_countLabelY$$.src, 
    ...
    if($cellData$$11$$[dvt.$NBoxConstants$.$LABEL$]) {
      var $cellCloseGap_labelHeight$$6$$ = $cellLayout$$3_countLabel$$.labelHeight, $skipLabel$$ = $JSCompiler_alias_FALSE$$, $closeWidth_halign$$8$$ = $DvtNBoxStyleUtils$$.$getLabelHalign$($nbox$$35$$, $cellData$$11$$), $countLabelWidthWithGap$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$ = 0, $cellLayout$$3_countLabel$$ = $JSCompiler_alias_NULL$$, $closeEna_countLabelY$$ = $closeEnaImg_countLabelWidth_countLabelX_options$$204$$ = 0, $countText$$ = $JSCompiler_alias_NULL$$, $showCount$$ = 
      $DvtNBoxStyleUtils$$.$getCellShowCount$($nbox$$35$$, $cellData$$11$$);
      if(!$cellCountLabel_countLabelFunc$$inline_4470_noCount$$ && "off" != $showCount$$) {
        var $JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$ = $DvtNBoxDataUtils$$.$getDisplayable$($nbox$$35$$, $cellData$$11$$), $JSCompiler_temp_const$$5549_data$$inline_4469$$ = $JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$.getData();
        if($cellCountLabel_countLabelFunc$$inline_4470_noCount$$ = $JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$.$_nbox$.$getOptions$().countLabel) {
          var $JSCompiler_temp_const$$5550$$ = $JSCompiler_temp_const$$5549_data$$inline_4469$$.row, $JSCompiler_temp_const$$5549_data$$inline_4469$$ = $JSCompiler_temp_const$$5549_data$$inline_4469$$.column, $JSCompiler_temp_const$$5548$$ = $JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$.$getNodeCount$(), $JSCompiler_inline_result$$5551_cellCounts$$inline_6537$$;
          $JSCompiler_inline_result$$5551_cellCounts$$inline_6537$$ = $DvtNBoxRenderer$$.$getCellCounts$($JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$.$_nbox$);
          $JSCompiler_inline_result$$5551_cellCounts$$inline_6537$$ = $JSCompiler_inline_result$$5551_cellCounts$$inline_6537$$.highlighted ? $JSCompiler_inline_result$$5551_cellCounts$$inline_6537$$.highlighted[$JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$.$getCellIndex$()] : $JSCompiler_alias_NULL$$;
          $JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$ = {row:$JSCompiler_temp_const$$5550$$, column:$JSCompiler_temp_const$$5549_data$$inline_4469$$, nodeCount:$JSCompiler_temp_const$$5548$$, highlightedNodeCount:$JSCompiler_inline_result$$5551_cellCounts$$inline_6537$$, totalNodeCount:$DvtNBoxDataUtils$$.$getNodeCount$($JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$.$_nbox$)};
          $cellCountLabel_countLabelFunc$$inline_4470_noCount$$ = $cellCountLabel_countLabelFunc$$inline_4470_noCount$$($JSCompiler_StaticMethods_getCountLabel$self$$inline_4468_dataContext$$inline_4471$$)
        }else {
          $cellCountLabel_countLabelFunc$$inline_4470_noCount$$ = $JSCompiler_temp_const$$5549_data$$inline_4469$$.countLabel
        }
        $cellCountLabel_countLabelFunc$$inline_4470_noCount$$ ? $countText$$ = $cellCountLabel_countLabelFunc$$inline_4470_noCount$$ : "on" == $showCount$$ && ($countText$$ = "" + $cellCounts$$2_countLabelOffset_labelWidth$$6$$.total[$c$$25_cellIndex$$7_label$$58$$], $cellCounts$$2_countLabelOffset_labelWidth$$6$$.highlighted && ($countText$$ = dvt.$Bundle$.$getTranslatedString$(dvt.$Bundle$.$NBOX_PREFIX$, "HIGHLIGHTED_COUNT", [$cellCounts$$2_countLabelOffset_labelWidth$$6$$.highlighted[$c$$25_cellIndex$$7_label$$58$$], 
        $countText$$])))
      }
...
$DvtNBoxCellRenderer$$.$_calculateCellLayout$ = function $$DvtNBoxCellRenderer$$$$_calculateCellLayout$$($minimizedHeaderSize_nbox$$41$$) {
  var $options$$206$$ = $minimizedHeaderSize_nbox$$41$$.$getOptions$(), $cellCounts$$4_count$$17_countLabelHeight$$ = $DvtNBoxRenderer$$.$getCellCounts$($minimizedHeaderSize_nbox$$41$$), $cellTopGap$$3_headerSize$$ = $options$$206$$.__layout.cellTopGap, $cellBottomGap$$1$$ = $options$$206$$.__layout.cellBottomGap, $cellLabelGap$$ = $options$$206$$.__layout.cellLabelGap, $cellLayout$$6_minimumCellSize$$ = $options$$206$$.__layout.minimumCellSize, $label$$59_labelHeight$$7$$ = 0, $cellData$$14$$ = 
  ...
  $DvtNBoxDataUtils$$.$getMaximizedRow$($minimizedHeaderSize_nbox$$41$$) && $DvtNBoxDataUtils$$.$getMaximizedColumn$($minimizedHeaderSize_nbox$$41$$) && ($label$$59_labelHeight$$7$$ = Math.max($label$$59_labelHeight$$7$$, $options$$206$$._resources.close_ena.height));
  ...
  return $options$$206$$.__layout.__cellLayout = $cellLayout$$6_minimumCellSize$$
};
...
$DvtNBoxNodeRenderer$$.$calculateNodeLayout$ = function $$DvtNBoxNodeRenderer$$$$calculateNodeLayout$$($nbox$$47$$, $cellNodes$$2$$) {
  for(var $options$$207$$ = $nbox$$47$$.$getOptions$(), $container$$152_gridGap$$1$$ = $options$$207$$.__layout.gridGap, $cellLayouts_nodeStartLabelGap$$ = $options$$207$$.__layout.nodeStartLabelGap, $nodeLabelOnlyStartLabelGap_startLabelGap$$ = $options$$207$$.__layout.nodeLabelOnlyStartLabelGap, $nodeEndLabelGap_overflow$$4$$ = $options$$207$$.__layout.nodeEndLabelGap, $cellIndices$$2_nodeSwatchSize$$ = $options$$207$$.__layout.nodeSwatchSize, $columnsPerRow_labelVisible_maximumLabelWidth$$ = $options$$207$$.__layout.maximumLabelWidth, 
  ...
  if($cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ && $cellArea_ci$$3_maximizedColumn$$7$$) {
    ...
    if($nodes$$14_simpleLayout$$.labelSectionWidth != $JSCompiler_alias_NULL$$) {
      ...
      if("ifRequired" != $options$$207$$.labelTruncation) {
        ...
        ($nodeHeight$$3_nodeLayout$$3$$ + $container$$152_gridGap$$1$$)), $indicatorIcon$$2_maxColumns$$ = Math.floor(($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $container$$152_gridGap$$1$$) / ($indicatorSectionWidth$$ + $iconSectionWidth$$ + $options$$207$$.__layout.minimumLabelWidth + $nodeLabelOnlyStartLabelGap_startLabelGap$$ + $nodeEndLabelGap_overflow$$4$$ + $container$$152_gridGap$$1$$)), $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ * $indicatorIcon$$2_maxColumns$$ < 
        $maximizedCellIndex$$1_nodeCounts$$[$maxCellIndex_node$$258$$]) {
          $labelSectionWidth_rowCount$$9$$ = Math.floor(Math.min($options$$207$$.__layout.maximumLabelWidth + $nodeLabelOnlyStartLabelGap_startLabelGap$$ + $nodeEndLabelGap_overflow$$4$$, ($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $container$$152_gridGap$$1$$) / $indicatorIcon$$2_maxColumns$$ - ($indicatorSectionWidth$$ + $iconSectionWidth$$ + $container$$152_gridGap$$1$$))), $cellRows$$1_i$$522_labelHeight$$8_secondaryLabelHeight$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$, 
          ...
          for($labelSectionWidth_rowCount$$9$$ = Math.floor(Math.min($options$$207$$.__layout.maximumLabelWidth + $nodeLabelOnlyStartLabelGap_startLabelGap$$ + $nodeEndLabelGap_overflow$$4$$, ($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $container$$152_gridGap$$1$$) / $columnsPerRow_labelVisible_maximumLabelWidth$$ - ($indicatorSectionWidth$$ + $iconSectionWidth$$ + $container$$152_gridGap$$1$$)));$labelSectionWidth_rowCount$$9$$ < $options$$207$$.__layout.maximumLabelWidth + $nodeLabelOnlyStartLabelGap_startLabelGap$$ + 
          $nodeEndLabelGap_overflow$$4$$;) {
            if(($columnsPerRow_labelVisible_maximumLabelWidth$$ - 1) * $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ >= $maximizedCellIndex$$1_nodeCounts$$[$maxCellIndex_node$$258$$]) {
              $columnsPerRow_labelVisible_maximumLabelWidth$$--, $labelSectionWidth_rowCount$$9$$ = Math.floor(Math.min($options$$207$$.__layout.maximumLabelWidth + $nodeLabelOnlyStartLabelGap_startLabelGap$$ + $nodeEndLabelGap_overflow$$4$$, ($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $container$$152_gridGap$$1$$) / $columnsPerRow_labelVisible_maximumLabelWidth$$ - ($indicatorSectionWidth$$ + $iconSectionWidth$$ + $container$$152_gridGap$$1$$)))
            }else {
              break
            }
          }
        ...
        ($nodeHeight$$3_nodeLayout$$3$$ + $container$$152_gridGap$$1$$)), $indicatorIcon$$2_maxColumns$$ = Math.floor(($cellArea_ci$$3_maximizedColumn$$7$$.$w$ + $container$$152_gridGap$$1$$) / ($indicatorSectionWidth$$ + $iconSectionWidth$$ + $options$$207$$.__layout.minimumLabelWidth + $nodeLabelOnlyStartLabelGap_startLabelGap$$ + $nodeEndLabelGap_overflow$$4$$ + $container$$152_gridGap$$1$$)), $cellRows$$1_i$$522_labelHeight$$8_secondaryLabelHeight$$ = $cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$, 
        ...
        $labelSectionWidth_rowCount$$9$$ < $options$$207$$.__layout.minimumLabelWidth && ($cell$$16_cellColumns$$1_maxRows_maximizedColumnIndex$$2_maximizedRow$$7_maximizedRowIndex$$2$$ = 0)
      }
    }
  ...
  return $options$$207$$.__layout.__nodeLayout = $nodeHeight$$3_nodeLayout$$3$$
};
$DvtNBoxNodeRenderer$$.$calculateNodeDrawerLayout$ = function $$DvtNBoxNodeRenderer$$$$calculateNodeDrawerLayout$$($nbox$$48_nodeDrawerLayout$$, $childArea$$3_data$$79$$, $columns_nodes$$15$$) {
  var $options$$208$$ = $nbox$$48_nodeDrawerLayout$$.$getOptions$(), $container$$153_gridGap$$2$$ = $options$$208$$.__layout.gridGap, $nodeStartLabelGap$$1_startLabelGap$$1$$ = $options$$208$$.__layout.nodeStartLabelGap, $label$$61_nodeLabelOnlyStartLabelGap$$1_secondaryLabel$$1$$ = $options$$208$$.__layout.nodeLabelOnlyStartLabelGap, $nodeEndLabelGap$$1$$ = $options$$208$$.__layout.nodeEndLabelGap, $nodeSwatchSize$$1$$ = $options$$208$$.__layout.nodeSwatchSize, $labelVisible$$1_maximumLabelWidth$$1$$ = 
  $options$$208$$.__layout.maximumLabelWidth, $node$$259$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$48_nodeDrawerLayout$$, 0), $indicatorIcon$$3$$ = $DvtNBoxDataUtils$$.$getIndicatorIcon$($nbox$$48_nodeDrawerLayout$$, $node$$259$$), $icon$$41$$ = $DvtNBoxDataUtils$$.$getIcon$($nbox$$48_nodeDrawerLayout$$, $node$$259$$), $labelSectionWidth$$1_simpleLayout$$1$$ = $DvtNBoxNodeRenderer$$.$_calculateSimpleNodeLayout$($nbox$$48_nodeDrawerLayout$$), $nodeHeight$$4$$ = $labelSectionWidth$$1_simpleLayout$$1$$.nodeHeight, 
  ...
  $labelSectionWidth$$1_simpleLayout$$1$$ == $JSCompiler_alias_NULL$$ && ($labelSectionWidth$$1_simpleLayout$$1$$ = "ifRequired" != $options$$208$$.labelTruncation ? $labelVisible$$1_maximumLabelWidth$$1$$ + $nodeStartLabelGap$$1_startLabelGap$$1$$ + $nodeEndLabelGap$$1$$ : Math.max($labelVisible$$1_maximumLabelWidth$$1$$, $DvtNBoxNodeRenderer$$.$_getMaxLabelWidth$($nbox$$48_nodeDrawerLayout$$, $columns_nodes$$15$$)) + $nodeStartLabelGap$$1_startLabelGap$$1$$ + $nodeEndLabelGap$$1$$, $labelSectionWidth$$1_simpleLayout$$1$$ = 
  ...
  return $options$$208$$.__layout.__nodeDrawerLayout = $nbox$$48_nodeDrawerLayout$$
};
$DvtNBoxNodeRenderer$$.$_calculateSimpleNodeLayout$ = function $$DvtNBoxNodeRenderer$$$$_calculateSimpleNodeLayout$$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$) {
  var $nodeHeight$$5_options$$209$$ = $nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$.$getOptions$(), $label$$62_labelHeight$$10_nodeIndicatorGap$$ = $nodeHeight$$5_options$$209$$.__layout.nodeIndicatorGap, $nodeSingleLabelGap$$ = $nodeHeight$$5_options$$209$$.__layout.nodeSingleLabelGap, $nodeDualLabelGap_padding$$21$$ = $nodeHeight$$5_options$$209$$.__layout.nodeDualLabelGap, $iconHeight$$9_nodeInterLabelGap$$ = $nodeHeight$$5_options$$209$$.__layout.nodeInterLabelGap, $nodeSwatchSize$$2$$ = 
  $nodeHeight$$5_options$$209$$.__layout.nodeSwatchSize, $node$$260$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$, 0), $indicatorSectionWidth$$2$$ = $nodeHeight$$5_options$$209$$ = 0, $iconSectionWidth$$2_preferredSize$$5$$ = 0, $labelSectionWidth$$2$$ = $JSCompiler_alias_NULL$$, $indicatorIcon$$4$$ = $DvtNBoxDataUtils$$.$getIndicatorIcon$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$, $node$$260$$), $indicatorColor_indicatorIconHeight$$ = $DvtNBoxStyleUtils$$.$getNodeIndicatorColor$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$, 
  $node$$260$$), $icon$$42$$ = $DvtNBoxDataUtils$$.$getIcon$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$, $node$$260$$);
  $indicatorIcon$$4$$ ? ($indicatorColor_indicatorIconHeight$$ = $indicatorIcon$$4$$[dvt.$NBoxConstants$.$HEIGHT$], $indicatorSectionWidth$$2$$ = $indicatorIcon$$4$$[dvt.$NBoxConstants$.$WIDTH$] + 2 * $label$$62_labelHeight$$10_nodeIndicatorGap$$, $nodeHeight$$5_options$$209$$ = Math.max($nodeHeight$$5_options$$209$$, $indicatorColor_indicatorIconHeight$$ + 2 * $label$$62_labelHeight$$10_nodeIndicatorGap$$)) : $indicatorColor_indicatorIconHeight$$ && ($indicatorSectionWidth$$2$$ = $nodeSwatchSize$$2$$);
  if($node$$260$$[dvt.$NBoxConstants$.$LABEL$]) {
    $label$$62_labelHeight$$10_nodeIndicatorGap$$ = $DvtNBoxDataUtils$$.$getNodeLabel$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$, $node$$260$$), $label$$62_labelHeight$$10_nodeIndicatorGap$$ = dvt.$TextUtils$.$guessTextDimensions$($label$$62_labelHeight$$10_nodeIndicatorGap$$).$h$, $nodeHeight$$5_options$$209$$ = Math.max($nodeHeight$$5_options$$209$$, $label$$62_labelHeight$$10_nodeIndicatorGap$$ + 2 * $nodeSingleLabelGap$$), $node$$260$$[dvt.$NBoxConstants$.$SECONDARY_LABEL$] && ($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$ = 
    $DvtNBoxDataUtils$$.$getNodeSecondaryLabel$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$, $node$$260$$), $nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$ = dvt.$TextUtils$.$guessTextDimensions$($nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$).$h$, $nodeHeight$$5_options$$209$$ = Math.max($nodeHeight$$5_options$$209$$, $label$$62_labelHeight$$10_nodeIndicatorGap$$ + $nbox$$49_secondaryLabel$$2_secondaryLabelHeight$$2$$ + 2 * $nodeDualLabelGap_padding$$21$$ + $iconHeight$$9_nodeInterLabelGap$$))
  }else {
  ...
  $icon$$42$$ && ($iconSectionWidth$$2_preferredSize$$5$$ = Math.max($nodeHeight$$5_options$$209$$, dvt.$Agent$.$isTouchDevice$() ? $icon$$42$$.preferredSizeTouch : $icon$$42$$.preferredSize), $nodeDualLabelGap_padding$$21$$ = ($icon$$42$$[dvt.$NBoxConstants$.$SOURCE$] ? $icon$$42$$.sourcePaddingRatio : $icon$$42$$.shapePaddingRatio) * $iconSectionWidth$$2_preferredSize$$5$$, $iconHeight$$9_nodeInterLabelGap$$ = $icon$$42$$[dvt.$NBoxConstants$.$HEIGHT$] ? $icon$$42$$[dvt.$NBoxConstants$.$HEIGHT$] : 
  $iconSectionWidth$$2_preferredSize$$5$$ - 2 * $nodeDualLabelGap_padding$$21$$, $iconSectionWidth$$2_preferredSize$$5$$ = ($icon$$42$$[dvt.$NBoxConstants$.$WIDTH$] ? $icon$$42$$[dvt.$NBoxConstants$.$WIDTH$] : $iconSectionWidth$$2_preferredSize$$5$$ - 2 * $nodeDualLabelGap_padding$$21$$) + 2 * $nodeDualLabelGap_padding$$21$$, $nodeHeight$$5_options$$209$$ = Math.max($nodeHeight$$5_options$$209$$, $iconHeight$$9_nodeInterLabelGap$$ + 2 * $nodeDualLabelGap_padding$$21$$));
  return{nodeHeight:$nodeHeight$$5_options$$209$$, indicatorSectionWidth:$indicatorSectionWidth$$2$$, iconSectionWidth:$iconSectionWidth$$2_preferredSize$$5$$, labelSectionWidth:$labelSectionWidth$$2$$}
};
$DvtNBoxNodeRenderer$$.$_renderNodeBackground$ = function $$DvtNBoxNodeRenderer$$$$_renderNodeBackground$$($nbox$$50$$, $node$$261$$, $nodeContainer$$3$$, $borderRadius$$5_color$$44_nodeLayout$$4$$) {
  var $nodeRect_width$$83$$ = $borderRadius$$5_color$$44_nodeLayout$$4$$.indicatorSectionWidth + $borderRadius$$5_color$$44_nodeLayout$$4$$.iconSectionWidth + $borderRadius$$5_color$$44_nodeLayout$$4$$.labelSectionWidth, $height$$75$$ = $borderRadius$$5_color$$44_nodeLayout$$4$$.nodeHeight;
  $borderRadius$$5_color$$44_nodeLayout$$4$$ = $DvtNBoxStyleUtils$$.$getNodeBorderRadius$($nbox$$50$$);
  var $hoverColor$$3$$ = $DvtNBoxStyleUtils$$.$getNodeHoverColor$($nbox$$50$$), $selectionColor$$1$$ = $DvtNBoxStyleUtils$$.$getNodeSelectionColor$($nbox$$50$$), $selectionRect$$ = new dvt.$Rect$($nbox$$50$$.$getCtx$(), 0, 0, $nodeRect_width$$83$$, $height$$75$$);
  $selectionRect$$.$setFill$($JSCompiler_alias_NULL$$);
  $borderRadius$$5_color$$44_nodeLayout$$4$$ && ($selectionRect$$.$setRx$($borderRadius$$5_color$$44_nodeLayout$$4$$), $selectionRect$$.$setRy$($borderRadius$$5_color$$44_nodeLayout$$4$$));
  ...
  $nodeRect_width$$83$$ = new dvt.$Rect$($nbox$$50$$.$getCtx$(), 0, 0, $nodeRect_width$$83$$, $height$$75$$);
  $borderRadius$$5_color$$44_nodeLayout$$4$$ && ($nodeRect_width$$83$$.$setRx$($borderRadius$$5_color$$44_nodeLayout$$4$$), $nodeRect_width$$83$$.$setRy$($borderRadius$$5_color$$44_nodeLayout$$4$$));
  $borderRadius$$5_color$$44_nodeLayout$$4$$ = $DvtNBoxStyleUtils$$.$getNodeColor$($nbox$$50$$, $node$$261$$);
  $nodeRect_width$$83$$.$setSolidFill$($borderRadius$$5_color$$44_nodeLayout$$4$$);
  $DvtNBoxStyleUtils$$.$getNodeBorderColor$($nbox$$50$$, $node$$261$$) && $DvtNBoxStyleUtils$$.$getNodeBorderWidth$($nbox$$50$$, $node$$261$$) && $nodeRect_width$$83$$.$setSolidStroke$($DvtNBoxStyleUtils$$.$getNodeBorderColor$($nbox$$50$$, $node$$261$$), $JSCompiler_alias_NULL$$, $DvtNBoxStyleUtils$$.$getNodeBorderWidth$($nbox$$50$$, $node$$261$$));
  $nodeContainer$$3$$.$addChild$($nodeRect_width$$83$$);
  $DvtNBoxDataUtils$$.$setDisplayable$($nbox$$50$$, $node$$261$$, $nodeRect_width$$83$$, "background")
};
...
$DvtNBoxNodeRenderer$$.$_renderNodeIcon$ = function $$DvtNBoxNodeRenderer$$$$_renderNodeIcon$$($nbox$$52$$, $node$$263$$, $nodeContainer$$5$$, $nodeLayout$$6$$) {
  ...
  if($icon$$43$$) {
    ...
    $contrastColor$$1_iconColor$$1$$, $iconBorderColor$$ = $icon$$43$$[dvt.$NBoxConstants$.$BORDER_COLOR$], $iconBorderWidth$$ = $icon$$43$$[dvt.$NBoxConstants$.$BORDER_WIDTH$], $iconBorderRadius$$ = $icon$$43$$[dvt.$NBoxConstants$.$BORDER_RADIUS$], $iconPattern$$ = $icon$$43$$[dvt.$NBoxConstants$.$PATTERN$];
    $icon$$43$$[dvt.$NBoxConstants$.$SOURCE$] ? ($iconMarker$$1_iconWidth$$12$$ = new dvt.$ImageMarker$($nbox$$52$$.$getCtx$(), $iconX$$2_rtl$$25$$, $iconY$$2$$, $iconMarker$$1_iconWidth$$12$$, $iconHeight$$10_padding$$22$$, $icon$$43$$[dvt.$NBoxConstants$.$SOURCE$]), $iconBorderRadius$$ && $iconMarker$$1_iconWidth$$12$$.$setBorderRadius$($iconBorderRadius$$)) : $iconMarker$$1_iconWidth$$12$$ = new dvt.$SimpleMarker$($nbox$$52$$.$getCtx$(), $icon$$43$$[dvt.$NBoxConstants$.$SHAPE$], dvt.$CSSStyle$.$SKIN_ALTA$, 
    $iconX$$2_rtl$$25$$, $iconY$$2$$, $iconMarker$$1_iconWidth$$12$$ - $iconBorderWidth$$, $iconHeight$$10_padding$$22$$ - $iconBorderWidth$$);
...
$DvtNBoxNodeRenderer$$.$_renderNodeLabels$ = function $$DvtNBoxNodeRenderer$$$$_renderNodeLabels$$($nbox$$53$$, $node$$264$$, $nodeContainer$$6_yOffset$$4$$, $nodeLayout$$7$$) {
  var $nodeEndLabelGap$$2_options$$210$$ = $nbox$$53$$.$getOptions$(), $nodeInterLabelGap$$1$$ = $nodeEndLabelGap$$2_options$$210$$.__layout.nodeInterLabelGap, $nodeLabelOnlyStartLabelGap$$2_startLabelGap$$2$$ = $nodeEndLabelGap$$2_options$$210$$.__layout.nodeLabelOnlyStartLabelGap, $color$$47_contrastColor$$2_nodeStartLabelGap$$2$$ = $nodeEndLabelGap$$2_options$$210$$.__layout.nodeStartLabelGap, $nodeEndLabelGap$$2_options$$210$$ = $nodeEndLabelGap$$2_options$$210$$.__layout.nodeEndLabelGap, $nodeLabelOnlyStartLabelGap$$2_startLabelGap$$2$$ = 
...
$DvtNBoxNodeRenderer$$.$_getMaxLabelWidth$ = function $$DvtNBoxNodeRenderer$$$$_getMaxLabelWidth$$($nbox$$54$$, $nodes$$16$$) {
  for(var $container$$154$$ = new dvt.$Container$, $n$$21_width$$84$$ = 0;$n$$21_width$$84$$ < $nodes$$16$$.length;$n$$21_width$$84$$++) {
    var $node$$265$$ = $nodes$$16$$[$n$$21_width$$84$$];
  ...
  for($n$$21_width$$84$$ = $container$$154$$.$getDimensions$().$w$;0 < $container$$154$$.$getNumChildren$();) {
    $container$$154$$.removeChild($container$$154$$.$getChildAt$(0))
  }
  $nbox$$54$$.removeChild($container$$154$$);
  return $n$$21_width$$84$$
};
$DvtNBoxNodeRenderer$$.$_clipIfNecessary$ = function $$DvtNBoxNodeRenderer$$$$_clipIfNecessary$$($borderRadius$$6_nbox$$55$$, $displayable$$53$$, $nodeHeight$$6_nodeLayout$$8$$) {
  if($borderRadius$$6_nbox$$55$$ = $DvtNBoxStyleUtils$$.$getNodeBorderRadius$($borderRadius$$6_nbox$$55$$)) {
    ...
    $clipPath$$9$$.$addRect$(0, 0, $nodeWidth$$3$$, $nodeHeight$$6_nodeLayout$$8$$, $borderRadius$$6_nbox$$55$$, $borderRadius$$6_nbox$$55$$);
...
$DvtNBoxCategoryNodeRenderer$$.$_renderNodeBackground$ = function $$DvtNBoxCategoryNodeRenderer$$$$_renderNodeBackground$$($color$$48_nbox$$58$$, $node$$266$$, $nodeContainer$$8$$, $borderRadius$$7_scale$$47$$, $gap$$24_nodeRect$$1_side$$22$$) {
  $node$$266$$.__scale = $borderRadius$$7_scale$$47$$;
  ...
  $borderRadius$$7_scale$$47$$ = $DvtNBoxStyleUtils$$.$getNodeBorderRadius$($color$$48_nbox$$58$$);
  ...
  $borderRadius$$7_scale$$47$$ && ($selectionRect$$1$$.$setRx$($borderRadius$$7_scale$$47$$), $selectionRect$$1$$.$setRy$($borderRadius$$7_scale$$47$$));
  ...
  $borderRadius$$7_scale$$47$$ && ($gap$$24_nodeRect$$1_side$$22$$.$setRx$($borderRadius$$7_scale$$47$$), $gap$$24_nodeRect$$1_side$$22$$.$setRy$($borderRadius$$7_scale$$47$$));
...
$DvtNBoxCategoryNodeRenderer$$.$_renderNodeIndicator$ = function $$DvtNBoxCategoryNodeRenderer$$$$_renderNodeIndicator$$($nbox$$59$$, $node$$268$$, $nodeContainer$$9$$, $color$$49_scale$$48$$, $gap$$25_indicatorIcon$$6$$) {
  ...
  $indicatorIconScale$$, $gap$$25_indicatorIcon$$6$$[dvt.$NBoxConstants$.$HEIGHT$] * $indicatorIconScale$$), $gap$$25_indicatorIcon$$6$$[dvt.$NBoxConstants$.$PATTERN$] && "none" != $gap$$25_indicatorIcon$$6$$[dvt.$NBoxConstants$.$PATTERN$] ? $indicatorMarker$$1_rtl$$27$$.$setFill$(new dvt.$PatternFill$($gap$$25_indicatorIcon$$6$$[dvt.$NBoxConstants$.$PATTERN$], $bgRect$$4_indicatorIconColor$$1_retVal$$4$$, $color$$49_scale$$48$$)) : $indicatorMarker$$1_rtl$$27$$.$setSolidFill$($bgRect$$4_indicatorIconColor$$1_retVal$$4$$), 
  $nodeContainer$$9$$.$addChild$($indicatorMarker$$1_rtl$$27$$), $DvtNBoxDataUtils$$.$setDisplayable$($nbox$$59$$, $node$$268$$, $indicatorMarker$$1_rtl$$27$$, dvt.$NBoxConstants$.$INDICATOR_ICON$), $bgRect$$4_indicatorIconColor$$1_retVal$$4$$ = $JSCompiler_alias_TRUE$$);
  return $bgRect$$4_indicatorIconColor$$1_retVal$$4$$
};
$DvtNBoxCategoryNodeRenderer$$.$_renderNodeCount$ = function $$DvtNBoxCategoryNodeRenderer$$$$_renderNodeCount$$($fontSize$$7_nbox$$60$$, $node$$269$$, $nodeContainer$$10$$, $scale$$49_side$$24$$, $bIndicator$$1_width$$85$$, $color$$50_contrastColor$$4_gap$$26$$) {
  ...
  $bIndicator$$1_width$$85$$ = $bIndicator$$1_width$$85$$ ? 0.75 * $scale$$49_side$$24$$ : $scale$$49_side$$24$$;
  $countX_rtl$$28$$ = ($countX_rtl$$28$$ ? -1 : 1) * ($scale$$49_side$$24$$ - $bIndicator$$1_width$$85$$) / 2;
  ...
  $alphaFade$$1_labelBounds$$12$$ = new dvt.$Rectangle$(0, 0, $bIndicator$$1_width$$85$$ - 2 * $labelGap$$1$$, $scale$$49_side$$24$$ - 2 * $labelGap$$1$$);
  ...
  dvt.$TextUtils$.$fitText$($label$$64$$, $bIndicator$$1_width$$85$$ - 2 * $labelGap$$1$$, $scale$$49_side$$24$$ - 2 * $labelGap$$1$$, $nodeContainer$$10$$) && ($DvtNBoxRenderer$$.$positionText$($label$$64$$, $countX_rtl$$28$$, 0), $label$$64$$.$setSolidFill$($color$$50_contrastColor$$4_gap$$26$$))
};
...
$DvtNBoxDrawerRenderer$$.$_renderHeader$ = function $$DvtNBoxDrawerRenderer$$$$_renderHeader$$($categoryLabel_nbox$$63$$, $data$$81_drawerBounds$$1$$, $drawerContainer$$3$$) {
  var $closeHeight_countColor_options$$213$$ = $categoryLabel_nbox$$63$$.$getOptions$(), $drawerButtonGap$$ = $closeHeight_countColor_options$$213$$.__layout.drawerButtonGap, $drawerStartGap$$ = $closeHeight_countColor_options$$213$$.__layout.drawerStartGap, $drawerLabelGap$$ = $closeHeight_countColor_options$$213$$.__layout.drawerLabelGap, $categoryText_drawerCountHGap_labelOffset$$ = $closeHeight_countColor_options$$213$$.__layout.drawerCountHorizontalGap, $countIndicatorHeight_drawerCountVGap$$ = 
  $closeHeight_countColor_options$$213$$.__layout.drawerCountVerticalGap, $drawerHeaderHeight$$ = $closeHeight_countColor_options$$213$$.__layout.drawerHeaderHeight, $countIndicatorWidth_indicatorGap$$ = $closeHeight_countColor_options$$213$$.__layout.nodeIndicatorGap, $countIndicatorSectionWidth_swatchSize$$ = $closeHeight_countColor_options$$213$$.__layout.nodeSwatchSize, $rtl$$29$$ = dvt.$Agent$.$isRightToLeft$($categoryLabel_nbox$$63$$.$getCtx$()), $categoryNode$$4$$ = $DvtNBoxDataUtils$$.$getCategoryNode$($categoryLabel_nbox$$63$$, 
  ...
  var $closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$ = $closeHeight_countColor_options$$213$$._resources.close_ena, $closeWidth$$1$$ = $closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$.width;
  if($data$$81_drawerBounds$$1$$.$w$ > $closeWidth$$1$$) {
    var $closeButton$$3_closeOvr$$1_closeOvrImg$$1_contrastColor$$5$$ = $closeHeight_countColor_options$$213$$._resources.close_ovr, $closeButtonX$$1_closeDwn$$1_closeDwnImg$$1_indicatorColor$$3$$ = $closeHeight_countColor_options$$213$$._resources.close_dwn, $closeHeight_countColor_options$$213$$ = $closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$.height, $closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$ = new dvt.$Image$($categoryLabel_nbox$$63$$.$getCtx$(), $closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$.src, 
    ...
    $closeButton$$3_closeOvr$$1_closeOvrImg$$1_contrastColor$$5$$.$setTranslate$($closeButtonX$$1_closeDwn$$1_closeDwnImg$$1_indicatorColor$$3$$, $drawerHeaderHeight$$ / 2 - $closeHeight_countColor_options$$213$$ / 2);
    $drawerContainer$$3$$.$addChild$($closeButton$$3_closeOvr$$1_closeOvrImg$$1_contrastColor$$5$$)
  }
  var $closeHeight_countColor_options$$213$$ = $DvtNBoxStyleUtils$$.$getCategoryNodeColor$($categoryLabel_nbox$$63$$, $categoryNode$$4$$), $closeButton$$3_closeOvr$$1_closeOvrImg$$1_contrastColor$$5$$ = dvt.$ColorUtils$.$getContrastingTextColor$($closeHeight_countColor_options$$213$$), $closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$ = ($closeButtonX$$1_closeDwn$$1_closeDwnImg$$1_indicatorColor$$3$$ = $DvtNBoxStyleUtils$$.$getCategoryNodeIndicatorColor$($categoryLabel_nbox$$63$$, $categoryNode$$4$$)) ? 
  ...
  $countIndicatorPath_countIndicatorShape$$ = new dvt.$Path$($categoryLabel_nbox$$63$$.$getCtx$(), $countIndicatorPath_countIndicatorShape$$), $countIndicatorPath_countIndicatorShape$$.$setSolidFill$($closeHeight_countColor_options$$213$$), $drawerContainer$$3$$.$addChild$($countIndicatorPath_countIndicatorShape$$), $countLabelDims_indicatorX$$2$$ = $rtl$$29$$ ? $countLabelSectionWidth_indicatorIconWidth$$3$$ : 0, 0 < $countIndicatorSectionWidth_swatchSize$$ && ($closeButtonX$$1_closeDwn$$1_closeDwnImg$$1_indicatorColor$$3$$ && 
  ...
  $indicatorIcon$$7$$[dvt.$NBoxConstants$.$SHAPE$], dvt.$CSSStyle$.$SKIN_ALTA$, $countLabelDims_indicatorX$$2$$ + $countIndicatorSectionWidth_swatchSize$$ / 2, $countIndicatorHeight_drawerCountVGap$$ / 2, $indicatorIcon$$7$$[dvt.$NBoxConstants$.$WIDTH$] * $indicatorMarker$$2_scale$$50$$, $indicatorIcon$$7$$[dvt.$NBoxConstants$.$HEIGHT$] * $indicatorMarker$$2_scale$$50$$), $indicatorIcon$$7$$[dvt.$NBoxConstants$.$PATTERN$] && "none" != $indicatorIcon$$7$$[dvt.$NBoxConstants$.$PATTERN$] ? $indicatorMarker$$2_scale$$50$$.$setFill$(new dvt.$PatternFill$($indicatorIcon$$7$$[dvt.$NBoxConstants$.$PATTERN$], 
  $closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$, $closeButtonX$$1_closeDwn$$1_closeDwnImg$$1_indicatorColor$$3$$ ? $closeButtonX$$1_closeDwn$$1_closeDwnImg$$1_indicatorColor$$3$$ : $closeHeight_countColor_options$$213$$)) : $indicatorMarker$$2_scale$$50$$.$setSolidFill$($closeEna$$1_closeEnaImg$$1_indicatorIconColor$$2$$), $countIndicatorPath_countIndicatorShape$$.$addChild$($indicatorMarker$$2_scale$$50$$))), $countIndicatorPath_countIndicatorShape$$.$addChild$($countLabel$$1_nodeCount$$9$$), 
  $countLabel$$1_nodeCount$$9$$.$setSolidFill$($closeButton$$3_closeOvr$$1_closeOvrImg$$1_contrastColor$$5$$), $DvtNBoxRenderer$$.$positionText$($countLabel$$1_nodeCount$$9$$, $rtl$$29$$ ? $countLabelSectionWidth_indicatorIconWidth$$3$$ - $categoryText_drawerCountHGap_labelOffset$$ : $countIndicatorSectionWidth_swatchSize$$ + $categoryText_drawerCountHGap_labelOffset$$, $countIndicatorHeight_drawerCountVGap$$ / 2));
...
$DvtNBoxDrawerRenderer$$.$_renderBody$ = function $$DvtNBoxDrawerRenderer$$$$_renderBody$$($nbox$$64$$, $data$$82$$, $alphaFade$$2_drawerContainer$$4$$) {
  var $options$$214_rtl$$30$$ = $nbox$$64$$.$getOptions$(), $gridGap$$3$$ = $options$$214_rtl$$30$$.__layout.gridGap, $drawerHeaderHeight$$1_highlightedItems$$6$$ = $options$$214_rtl$$30$$.__layout.drawerHeaderHeight, $drawerBounds$$2_highlightedMap$$5_scrollContainer$$2$$ = $data$$82$$.__drawerBounds, $options$$214_rtl$$30$$ = dvt.$Agent$.$isRightToLeft$($nbox$$64$$.$getCtx$()), $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$ = $DvtNBoxStyleUtils$$.$getDrawerBorderRadius$($nbox$$64$$), $borderColor$$39_i$$524_nodes$$17$$ = 
  $DvtNBoxStyleUtils$$.$getDrawerBorderColor$($nbox$$64$$), $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$ = dvt.$PathUtils$.$roundedRectangle$(0, 0, $drawerBounds$$2_highlightedMap$$5_scrollContainer$$2$$.$w$, $drawerBounds$$2_highlightedMap$$5_scrollContainer$$2$$.$h$, $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$, $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$, $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$, $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$), $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$ = 
  new dvt.$Path$($nbox$$64$$.$getCtx$(), $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$);
  $DvtNBoxRenderer$$.$setFill$($body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$, $DvtNBoxStyleUtils$$.$getDrawerBackground$($nbox$$64$$));
  $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.$setSolidStroke$($borderColor$$39_i$$524_nodes$$17$$);
  $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.$setPixelHinting$();
  $alphaFade$$2_drawerContainer$$4$$.$addChild$($body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$);
  $DvtNBoxDataUtils$$.$setDisplayable$($nbox$$64$$, $data$$82$$, $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$, "background");
  ...
  for(var $borderColor$$39_i$$524_nodes$$17$$ = $DvtNBoxDrawerRenderer$$.$calculateNodeOrders$($nbox$$64$$, $data$$82$$), $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$ = $DvtNBoxNodeRenderer$$.$calculateNodeDrawerLayout$($nbox$$64$$, $data$$82$$, $borderColor$$39_i$$524_nodes$$17$$), $hGridSize$$1$$ = $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.indicatorSectionWidth + $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.iconSectionWidth + $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.labelSectionWidth + 
  $gridGap$$3$$, $vGridSize$$1$$ = $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.nodeHeight + $gridGap$$3$$, $container$$155$$ = $DvtNBoxDataUtils$$.$getDisplayable$($nbox$$64$$, $data$$82$$).$getChildContainer$(), $n$$22$$ = 0;$n$$22$$ < $borderColor$$39_i$$524_nodes$$17$$.length;$n$$22$$++) {
    var $node$$270$$ = $borderColor$$39_i$$524_nodes$$17$$[$n$$22$$];
    if(0 != $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.drawerLayout[dvt.$NBoxConstants$.$COLUMNS$] && 0 != $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.drawerLayout[dvt.$NBoxConstants$.$ROWS$]) {
      var $nodeContainer$$11_prevNode$$1$$ = $DvtNBoxNode$$.newInstance($nbox$$64$$, $node$$270$$), $gridXOrigin$$1$$ = $data$$82$$.__childArea.x + ($data$$82$$.__childArea.$w$ - $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.drawerLayout[dvt.$NBoxConstants$.$COLUMNS$] * $hGridSize$$1$$ + $gridGap$$3$$) / 2, $gridYOrigin$$1$$ = $gridGap$$3$$, $gridColumn$$1$$ = $n$$22$$ % $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.drawerLayout[dvt.$NBoxConstants$.$COLUMNS$];
      $options$$214_rtl$$30$$ && ($gridColumn$$1$$ = $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.drawerLayout[dvt.$NBoxConstants$.$COLUMNS$] - $gridColumn$$1$$ - 1);
      $nodeContainer$$11_prevNode$$1$$.$setTranslate$($gridXOrigin$$1$$ + $hGridSize$$1$$ * $gridColumn$$1$$, $gridYOrigin$$1$$ + $vGridSize$$1$$ * Math.floor($n$$22$$ / $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$.drawerLayout[dvt.$NBoxConstants$.$COLUMNS$]));
      $nodeContainer$$11_prevNode$$1$$.$render$($container$$155$$.$_container$, $body$$1_bodyPath_borderRadius$$8_nodeLayout$$11$$);
...
$DvtNBoxDataUtils$$.$processDataObject$ = function $$DvtNBoxDataUtils$$$$processDataObject$$($legend$$29_nbox$$68$$) {
  var $options$$216$$ = $legend$$29_nbox$$68$$.$getOptions$(), $cells$$1_columnMap_hiddenCategories$$11$$ = $options$$216$$[dvt.$NBoxConstants$.$CELLS$], $cellMap_nodeMap$$6_section$$10$$ = {};
  if($cells$$1_columnMap_hiddenCategories$$11$$) {
    for(var $i$$526_rowMap$$ = 0;$i$$526_rowMap$$ < $cells$$1_columnMap_hiddenCategories$$11$$.length;$i$$526_rowMap$$++) {
      var $cell$$18_newCells$$1_nodeObj$$ = $cells$$1_columnMap_hiddenCategories$$11$$[$i$$526_rowMap$$], $grouping_j$$77_row$$5_rowObj$$ = $cell$$18_newCells$$1_nodeObj$$[dvt.$NBoxConstants$.$ROW$];
      $cellMap_nodeMap$$6_section$$10$$[$grouping_j$$77_row$$5_rowObj$$] || ($cellMap_nodeMap$$6_section$$10$$[$grouping_j$$77_row$$5_rowObj$$] = {});
      var $column$$1_columnObj_item$$39_n$$24$$ = $cell$$18_newCells$$1_nodeObj$$[dvt.$NBoxConstants$.$COLUMN$];
      $cellMap_nodeMap$$6_section$$10$$[$grouping_j$$77_row$$5_rowObj$$][$column$$1_columnObj_item$$39_n$$24$$] = $cell$$18_newCells$$1_nodeObj$$
    }
  }
  for(var $cell$$18_newCells$$1_nodeObj$$ = [], $i$$526_rowMap$$ = {}, $cells$$1_columnMap_hiddenCategories$$11$$ = {}, $r$$36$$ = 0;$r$$36$$ < $DvtNBoxDataUtils$$.$getRowCount$($legend$$29_nbox$$68$$);$r$$36$$++) {
    $grouping_j$$77_row$$5_rowObj$$ = $DvtNBoxDataUtils$$.$getRow$($legend$$29_nbox$$68$$, $r$$36$$), $i$$526_rowMap$$[$grouping_j$$77_row$$5_rowObj$$[dvt.$NBoxConstants$.ID]] = $r$$36$$
  }
  $options$$216$$.__rowMap = $i$$526_rowMap$$;
  for(var $c$$28$$ = 0;$c$$28$$ < $DvtNBoxDataUtils$$.$getColumnCount$($legend$$29_nbox$$68$$);$c$$28$$++) {
    $column$$1_columnObj_item$$39_n$$24$$ = $DvtNBoxDataUtils$$.$getColumn$($legend$$29_nbox$$68$$, $c$$28$$), $cells$$1_columnMap_hiddenCategories$$11$$[$column$$1_columnObj_item$$39_n$$24$$[dvt.$NBoxConstants$.ID]] = $c$$28$$
  }
  $options$$216$$.__columnMap = $cells$$1_columnMap_hiddenCategories$$11$$;
  for($r$$36$$ = 0;$r$$36$$ < $DvtNBoxDataUtils$$.$getRowCount$($legend$$29_nbox$$68$$);$r$$36$$++) {
    $grouping_j$$77_row$$5_rowObj$$ = $DvtNBoxDataUtils$$.$getRow$($legend$$29_nbox$$68$$, $r$$36$$);
    $grouping_j$$77_row$$5_rowObj$$ = $grouping_j$$77_row$$5_rowObj$$[dvt.$NBoxConstants$.ID];
    for($c$$28$$ = 0;$c$$28$$ < $DvtNBoxDataUtils$$.$getColumnCount$($legend$$29_nbox$$68$$);$c$$28$$++) {
      $column$$1_columnObj_item$$39_n$$24$$ = $DvtNBoxDataUtils$$.$getColumn$($legend$$29_nbox$$68$$, $c$$28$$), $column$$1_columnObj_item$$39_n$$24$$ = $column$$1_columnObj_item$$39_n$$24$$[dvt.$NBoxConstants$.ID], $cellMap_nodeMap$$6_section$$10$$[$grouping_j$$77_row$$5_rowObj$$] && $cellMap_nodeMap$$6_section$$10$$[$grouping_j$$77_row$$5_rowObj$$][$column$$1_columnObj_item$$39_n$$24$$] ? $cell$$18_newCells$$1_nodeObj$$.push($cellMap_nodeMap$$6_section$$10$$[$grouping_j$$77_row$$5_rowObj$$][$column$$1_columnObj_item$$39_n$$24$$]) : 
      $cell$$18_newCells$$1_nodeObj$$.push({row:$grouping_j$$77_row$$5_rowObj$$, column:$column$$1_columnObj_item$$39_n$$24$$})
    }
  }
  $options$$216$$[dvt.$NBoxConstants$.$CELLS$] = $cell$$18_newCells$$1_nodeObj$$;
  $cellMap_nodeMap$$6_section$$10$$ = {};
  $grouping_j$$77_row$$5_rowObj$$ = $JSCompiler_alias_FALSE$$;
  for($column$$1_columnObj_item$$39_n$$24$$ = 0;$column$$1_columnObj_item$$39_n$$24$$ < $DvtNBoxDataUtils$$.$getNodeCount$($legend$$29_nbox$$68$$);$column$$1_columnObj_item$$39_n$$24$$++) {
    if($cell$$18_newCells$$1_nodeObj$$ = $DvtNBoxDataUtils$$.$getNode$($legend$$29_nbox$$68$$, $column$$1_columnObj_item$$39_n$$24$$), $cellMap_nodeMap$$6_section$$10$$[$cell$$18_newCells$$1_nodeObj$$[dvt.$NBoxConstants$.ID]] = $column$$1_columnObj_item$$39_n$$24$$, !$grouping_j$$77_row$$5_rowObj$$ && ($cell$$18_newCells$$1_nodeObj$$[dvt.$NBoxConstants$.$GROUP_CATEGORY$] || $cell$$18_newCells$$1_nodeObj$$._groupCategories || $cell$$18_newCells$$1_nodeObj$$._groupLabels)) {
      $grouping_j$$77_row$$5_rowObj$$ = $JSCompiler_alias_TRUE$$
    }
  }
  $options$$216$$.__nodeMap = $cellMap_nodeMap$$6_section$$10$$;
  $options$$216$$.__grouping = "none" != $options$$216$$[dvt.$NBoxConstants$.$GROUP_BEHAVIOR$] ? $grouping_j$$77_row$$5_rowObj$$ : $JSCompiler_alias_FALSE$$;
  $DvtNBoxDataUtils$$.$getGrouping$($legend$$29_nbox$$68$$) && $DvtNBoxDataUtils$$.$getGroupBehavior$($legend$$29_nbox$$68$$) == dvt.$NBoxConstants$.$GROUP_BEHAVIOR_ACROSS_CELLS$ && ($options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_ROW$] = $JSCompiler_alias_NULL$$, $DvtNBoxDataUtils$$.$fireSetPropertyEvent$($legend$$29_nbox$$68$$, dvt.$NBoxConstants$.$MAXIMIZED_ROW$), $options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$] = $JSCompiler_alias_NULL$$, $DvtNBoxDataUtils$$.$fireSetPropertyEvent$($legend$$29_nbox$$68$$, 
  dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$));
  if($options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_ROW$] && isNaN($i$$526_rowMap$$[$options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_ROW$]]) || $options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$] && isNaN($cells$$1_columnMap_hiddenCategories$$11$$[$options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$]])) {
    $options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_ROW$] = $JSCompiler_alias_NULL$$, $DvtNBoxDataUtils$$.$fireSetPropertyEvent$($legend$$29_nbox$$68$$, dvt.$NBoxConstants$.$MAXIMIZED_ROW$), $options$$216$$[dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$] = $JSCompiler_alias_NULL$$, $DvtNBoxDataUtils$$.$fireSetPropertyEvent$($legend$$29_nbox$$68$$, dvt.$NBoxConstants$.$MAXIMIZED_COLUMN$)
  }
  if(($legend$$29_nbox$$68$$ = $options$$216$$[dvt.$NBoxConstants$.$LEGEND$]) && $legend$$29_nbox$$68$$.sections) {
    ...
    $legend$$29_nbox$$68$$.sections.sort(function($legend$$29_nbox$$68$$, $options$$216$$) {
      return dvt.$ArrayUtils$.$getIndex$($legendPrecedence$$, $legend$$29_nbox$$68$$.type) - dvt.$ArrayUtils$.$getIndex$($legendPrecedence$$, $options$$216$$.type)
    });
    $cells$$1_columnMap_hiddenCategories$$11$$ = $options$$216$$[dvt.$NBoxConstants$.$HIDDEN_CATEGORIES$];
    $legend$$29_nbox$$68$$.hideAndShowBehavior = "on";
    $legend$$29_nbox$$68$$.textStyle = $options$$216$$.styleDefaults.__legendDefaults.itemStyle;
    ...
    for($i$$526_rowMap$$ = 0;$i$$526_rowMap$$ < $legend$$29_nbox$$68$$.sections.length;$i$$526_rowMap$$++) {
      ...
      $cellMap_nodeMap$$6_section$$10$$.titleStyle = $options$$216$$.styleDefaults.__legendDefaults.sectionStyle;
      for($grouping_j$$77_row$$5_rowObj$$ = 0;$grouping_j$$77_row$$5_rowObj$$ < $cellMap_nodeMap$$6_section$$10$$.items.length;$grouping_j$$77_row$$5_rowObj$$++) {
        $column$$1_columnObj_item$$39_n$$24$$ = $cellMap_nodeMap$$6_section$$10$$.items[$grouping_j$$77_row$$5_rowObj$$], $column$$1_columnObj_item$$39_n$$24$$.categoryVisibility = -1 != dvt.$ArrayUtils$.$getIndex$($cells$$1_columnMap_hiddenCategories$$11$$, $column$$1_columnObj_item$$39_n$$24$$.categories && 0 < $column$$1_columnObj_item$$39_n$$24$$.categories.length ? $column$$1_columnObj_item$$39_n$$24$$.categories[0] : $column$$1_columnObj_item$$39_n$$24$$.id) ? "hidden" : $JSCompiler_alias_NULL$$, 
        $column$$1_columnObj_item$$39_n$$24$$.indicatorColor && ($column$$1_columnObj_item$$39_n$$24$$.color = $column$$1_columnObj_item$$39_n$$24$$.indicatorColor), $column$$1_columnObj_item$$39_n$$24$$.color || ($column$$1_columnObj_item$$39_n$$24$$.color = $options$$216$$.styleDefaults.__legendDefaults.markerColor), $column$$1_columnObj_item$$39_n$$24$$.shape && ($column$$1_columnObj_item$$39_n$$24$$.markerShape = $column$$1_columnObj_item$$39_n$$24$$.shape)
      }
    }
  }
};
...
$DvtNBoxDataUtils$$.$isNodeHidden$ = function $$DvtNBoxDataUtils$$$$isNodeHidden$$($nbox$$108$$, $node$$280$$) {
  var $options$$217$$ = $nbox$$108$$.$getOptions$();
  $options$$217$$[dvt.$NBoxConstants$.$HIDDEN_CATEGORIES$] && !$options$$217$$.__hiddenMap && ($options$$217$$.__hiddenMap = dvt.$ArrayUtils$.$createBooleanMap$($options$$217$$[dvt.$NBoxConstants$.$HIDDEN_CATEGORIES$]));
  return dvt.$ArrayUtils$.$hasAnyMapItem$($options$$217$$.__hiddenMap, $node$$280$$[dvt.$NBoxConstants$.$CATEGORIES$])
};
$DvtNBoxDataUtils$$.$isNodeHighlighted$ = function $$DvtNBoxDataUtils$$$$isNodeHighlighted$$($nbox$$109$$, $node$$281$$) {
  var $options$$218$$ = $nbox$$109$$.$getOptions$();
  $options$$218$$[dvt.$NBoxConstants$.$HIGHLIGHTED_CATEGORIES$] && !$options$$218$$.__highlightedMap && ($options$$218$$.__highlightedMap = dvt.$ArrayUtils$.$createBooleanMap$($options$$218$$[dvt.$NBoxConstants$.$HIGHLIGHTED_CATEGORIES$]));
  return"all" == $options$$218$$[dvt.$NBoxConstants$.$HIGHLIGHT_MATCH$] ? dvt.$ArrayUtils$.$hasAllMapItems$($options$$218$$.__highlightedMap, $node$$281$$[dvt.$NBoxConstants$.$CATEGORIES$]) : dvt.$ArrayUtils$.$hasAnyMapItem$($options$$218$$.__highlightedMap, $node$$281$$[dvt.$NBoxConstants$.$CATEGORIES$])
};
...
$DvtNBoxDataUtils$$.$isDrawerSelected$ = function $$DvtNBoxDataUtils$$$$isDrawerSelected$$($nbox$$115$$, $categoryNode$$7$$) {
  var $i$$528_selected$$33$$ = $JSCompiler_alias_FALSE$$, $nodeIndices$$4_selectedItems$$5$$ = $DvtNBoxDataUtils$$.$getSelectedItems$($nbox$$115$$);
  if($nodeIndices$$4_selectedItems$$5$$) {
    for(var $selectedMap$$4$$ = {}, $i$$528_selected$$33$$ = 0;$i$$528_selected$$33$$ < $nodeIndices$$4_selectedItems$$5$$.length;$i$$528_selected$$33$$++) {
      $selectedMap$$4$$[$nodeIndices$$4_selectedItems$$5$$[$i$$528_selected$$33$$]] = $JSCompiler_alias_TRUE$$
    }
    for(var $nodeIndices$$4_selectedItems$$5$$ = $categoryNode$$7$$.getData().nodeIndices, $i$$528_selected$$33$$ = $JSCompiler_alias_TRUE$$, $j$$78$$ = 0;$j$$78$$ < $nodeIndices$$4_selectedItems$$5$$.length;$j$$78$$++) {
      var $node$$285$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$115$$, $nodeIndices$$4_selectedItems$$5$$[$j$$78$$]);
      if(!$selectedMap$$4$$[$node$$285$$[dvt.$NBoxConstants$.ID]]) {
        $i$$528_selected$$33$$ = $JSCompiler_alias_FALSE$$;
        break
      }
    }
  }
  return $i$$528_selected$$33$$
};
$DvtNBoxDataUtils$$.$buildAriaDesc$ = function $$DvtNBoxDataUtils$$$$buildAriaDesc$$($nbox$$116_nodeCount$$11$$, $object$$13$$, $baseDesc_datatip$$16$$, $selected$$34$$) {
  ...
  var $states$$12$$ = [];
  $selected$$34$$ ? $states$$12$$.push(dvt.$Bundle$.$getTranslatedString$(dvt.$Bundle$.$UTIL_PREFIX$, "STATE_SELECTED")) : $states$$12$$.push(dvt.$Bundle$.$getTranslatedString$(dvt.$Bundle$.$UTIL_PREFIX$, "STATE_UNSELECTED"));
...
$DvtNBoxStyleUtils$$.$getCellStyle$ = function $$DvtNBoxStyleUtils$$$$getCellStyle$$($nbox$$125$$, $cellIndex$$15$$) {
  var $defaults$$2_options$$221$$ = $nbox$$125$$.$getOptions$(), $styleKey$$ = dvt.$NBoxConstants$.$STYLE$, $cell$$24_maximizedRow$$11$$ = $DvtNBoxDataUtils$$.$getMaximizedRow$($nbox$$125$$), $maximizedColumn$$11$$ = $DvtNBoxDataUtils$$.$getMaximizedColumn$($nbox$$125$$);
  ...
  $defaults$$2_options$$221$$ = $defaults$$2_options$$221$$[dvt.$NBoxConstants$.$STYLE_DEFAULTS$][dvt.$NBoxConstants$.$CELL_DEFAULTS$][$styleKey$$];
  $cell$$24_maximizedRow$$11$$ = $DvtNBoxDataUtils$$.$getCell$($nbox$$125$$, $cellIndex$$15$$);
  return $cell$$24_maximizedRow$$11$$[$styleKey$$] ? dvt.$JsonUtils$.$merge$(new dvt.$CSSStyle$($cell$$24_maximizedRow$$11$$[$styleKey$$]), $defaults$$2_options$$221$$) : $defaults$$2_options$$221$$
};
...
$DvtNBoxStyleUtils$$.$getNodeBorderWidth$ = function $$DvtNBoxStyleUtils$$$$getNodeBorderWidth$$($nbox$$135$$, $node$$290$$) {
  var $width$$86$$ = $node$$290$$[dvt.$NBoxConstants$.$BORDER_WIDTH$] ? $node$$290$$[dvt.$NBoxConstants$.$BORDER_WIDTH$] : $nbox$$135$$.$getOptions$()[dvt.$NBoxConstants$.$STYLE_DEFAULTS$][dvt.$NBoxConstants$.$NODE_DEFAULTS$][dvt.$NBoxConstants$.$BORDER_WIDTH$];
  return $width$$86$$ ? $width$$86$$ : $JSCompiler_alias_NULL$$
};
...
$DvtNBoxStyleUtils$$.$getStyledCategoryIndicatorIcon$ = function $$DvtNBoxStyleUtils$$$$getStyledCategoryIndicatorIcon$$($nbox$$143$$, $categoryNode$$10$$) {
  ...
  if(!$DvtNBoxDataUtils$$.$getGroupAttributes$($nbox$$143$$) || -1 != $DvtNBoxDataUtils$$.$getGroupAttributes$($nbox$$143$$).indexOf("indicatorIconShape")) {
    for(var $color$$54_k$$4_shape$$64$$ = $baseIcon_pattern$$7$$[dvt.$NBoxConstants$.$SHAPE$], $i$$531_j$$79$$ = 1;$i$$531_j$$79$$ < $nodeIndices$$7$$.length;$i$$531_j$$79$$++) {
      var $nodeIcon$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$143$$, $nodeIndices$$7$$[$i$$531_j$$79$$])[dvt.$NBoxConstants$.$INDICATOR_ICON$];
      $nodeIcon$$ && $color$$54_k$$4_shape$$64$$ != $nodeIcon$$[dvt.$NBoxConstants$.$SHAPE$] && ($match$$4$$ = $JSCompiler_alias_FALSE$$)
    }
    $indicatorIcon$$9$$[dvt.$NBoxConstants$.$SHAPE$] = $match$$4$$ ? $color$$54_k$$4_shape$$64$$ : $nbox$$143$$.$getOptions$()[dvt.$NBoxConstants$.$STYLE_DEFAULTS$][dvt.$NBoxConstants$.$NODE_DEFAULTS$][dvt.$NBoxConstants$.$INDICATOR_ICON_DEFAULTS$][dvt.$NBoxConstants$.$SHAPE$]
  }
  ...
  if(!$DvtNBoxDataUtils$$.$getGroupAttributes$($nbox$$143$$) || -1 != $DvtNBoxDataUtils$$.$getGroupAttributes$($nbox$$143$$).indexOf("indicatorIconColor")) {
    $color$$54_k$$4_shape$$64$$ = $baseIcon_pattern$$7$$[dvt.$NBoxConstants$.$COLOR$];
    for($i$$531_j$$79$$ = 1;$i$$531_j$$79$$ < $nodeIndices$$7$$.length;$i$$531_j$$79$$++) {
      ($nodeIcon$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$143$$, $nodeIndices$$7$$[$i$$531_j$$79$$])[dvt.$NBoxConstants$.$INDICATOR_ICON$]) && $color$$54_k$$4_shape$$64$$ != $nodeIcon$$[dvt.$NBoxConstants$.$COLOR$] && ($match$$4$$ = $JSCompiler_alias_FALSE$$)
    }
    $indicatorIcon$$9$$[dvt.$NBoxConstants$.$COLOR$] = $match$$4$$ ? $color$$54_k$$4_shape$$64$$ : $nbox$$143$$.$getOptions$()[dvt.$NBoxConstants$.$STYLE_DEFAULTS$][dvt.$NBoxConstants$.$NODE_DEFAULTS$][dvt.$NBoxConstants$.$INDICATOR_ICON_DEFAULTS$][dvt.$NBoxConstants$.$COLOR$]
  }
  $match$$4$$ = $JSCompiler_alias_TRUE$$;
  if(!$DvtNBoxDataUtils$$.$getGroupAttributes$($nbox$$143$$) || -1 != $DvtNBoxDataUtils$$.$getGroupAttributes$($nbox$$143$$).indexOf("indicatorIconPattern")) {
    ...
    for($color$$54_k$$4_shape$$64$$ = 1;$color$$54_k$$4_shape$$64$$ < $nodeIndices$$7$$.length;$color$$54_k$$4_shape$$64$$++) {
      ($nodeIcon$$ = $DvtNBoxDataUtils$$.$getNode$($nbox$$143$$, $nodeIndices$$7$$[$color$$54_k$$4_shape$$64$$])[dvt.$NBoxConstants$.$INDICATOR_ICON$]) && $baseIcon_pattern$$7$$ != $nodeIcon$$[dvt.$NBoxConstants$.$PATTERN$] && ($match$$4$$ = $JSCompiler_alias_FALSE$$)
    }
