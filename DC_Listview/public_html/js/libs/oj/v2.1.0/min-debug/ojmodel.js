...
define(["ojs/ojcore", "jquery", "promise"], function($oj$$1$$, $$$$1$$) {
  ...
  $oj$$1$$.$Model$.prototype.clone = function $$oj$$1$$$$Model$$$clone$() {
    var $c$$26$$ = new this.constructor, $prop$$24$$;
    for ($prop$$24$$ in this) {
      this.hasOwnProperty($prop$$24$$) && this[$prop$$24$$] !== this.attributes && ($c$$26$$[$prop$$24$$] = this[$prop$$24$$]);
    }
    $c$$26$$.attributes = $oj$$1$$.$Model$.$_cloneAttributes$(this.attributes, null);
    delete $c$$26$$.cid;
    $c$$26$$.$SetCid$();
    $c$$26$$.$SetupId$();
    return $c$$26$$;
  ...
  $oj$$1$$.$Model$.prototype.fetch = function $$oj$$1$$$$Model$$$fetch$($options$$27$$) {
    ...
    return $oj$$1$$.$Model$.$_internalSync$("read", this, $opts$$2$$);
  };
  ...
  $oj$$1$$.$Model$.prototype.save = function $$oj$$1$$$$Model$$$save$($attributes$$5$$, $options$$34$$) {
    ...
    if (!$argResults_forceNew$$ && !this.$isNew$()) {
      return $success$$9$$ = $opts$$3$$.success, $opts$$3$$.success = function $$opts$$3$$$success$($resp$$) {
        ...
        if ($resp$$ && !$oj$$1$$.$Object$.$isEmpty$($resp$$)) {
          $attrs$$4$$ = $$$$1$$.isFunction($self$$3$$.parse) ? $self$$3$$.parse($resp$$) : $resp$$;
          $self$$3$$.attributes = $$$$1$$.extend(!0, $self$$3$$.attributes, $attrs$$4$$);
          if ($opts$$3$$.wait) {
            for (var $prop$$33$$ in $attrArgs$$) {
              $attrs$$4$$.hasOwnProperty($prop$$33$$) && ($attrArgs$$[$prop$$33$$] = $attrs$$4$$[$prop$$33$$]);
            }
          }
          $self$$3$$.$SetupId$();
        }
    ...
    $opts$$3$$.success = function $$opts$$3$$$success$($resp$$1$$) {
      var $attrs$$5$$;
      $opts$$3$$.xhr && ($options$$34$$.xhr = $opts$$3$$.xhr);
      if ($resp$$1$$ && !$oj$$1$$.$Object$.$isEmpty$($resp$$1$$)) {
        ...
        if ($opts$$3$$.wait) {
          for (var $prop$$34$$ in $attrArgs$$) {
            $attrs$$5$$.hasOwnProperty($prop$$34$$) && ($attrArgs$$[$prop$$34$$] = $attrs$$5$$[$prop$$34$$]);
          }
        }
        $self$$3$$.$SetupId$();
      }
  ...
  $oj$$1$$.$Model$.prototype.$_attrUnion$ = function $$oj$$1$$$$Model$$$$_attrUnion$$($attrs$$6$$) {
    var $attrReturn$$ = {}, $prop$$35$$;
    for ($prop$$35$$ in this.attributes) {
      this.attributes.hasOwnProperty($prop$$35$$) && ($attrReturn$$[$prop$$35$$] = this.attributes[$prop$$35$$]);
    }
    for ($prop$$35$$ in $attrs$$6$$) {
      $attrs$$6$$.hasOwnProperty($prop$$35$$) && ($attrReturn$$[$prop$$35$$] = $attrs$$6$$[$prop$$35$$]);
    }
    return $attrReturn$$;
  };
  ...
  $oj$$1$$.$Model$.prototype.$_hasAttrs$ = function $$oj$$1$$$$Model$$$$_hasAttrs$$($attrs$$7$$) {
    for (var $prop$$36$$ in $attrs$$7$$) {
      if ($attrs$$7$$.hasOwnProperty($prop$$36$$)) {
        if (!this.attributes.hasOwnProperty($prop$$36$$)) {
          return!1;
        }
        for (var $val$$16$$ = Array.isArray($attrs$$7$$[$prop$$36$$]) ? $attrs$$7$$[$prop$$36$$] : [$attrs$$7$$[$prop$$36$$]], $i$$28$$ = 0;$i$$28$$ < $val$$16$$.length;$i$$28$$++) {
          if ($oj$$1$$.$Model$.$IsComplexValue$($val$$16$$[$i$$28$$])) {
            ...
            if (!$comparator$$1$$(this, $prop$$36$$, $value$$62$$)) {
              return!1;
            }
          } else {
            if ($attrs$$7$$[$prop$$36$$] !== this.attributes[$prop$$36$$]) {
              return!1;
            }
          }
        }
  ...
  $oj$$1$$.$Model$.prototype.matches = function $$oj$$1$$$$Model$$$matches$($JSCompiler_inline_result$$4_attrs$$8$$) {
    a: {
      for (var $prop$$inline_363$$ in $JSCompiler_inline_result$$4_attrs$$8$$) {
        if (this.get($prop$$inline_363$$) !== $JSCompiler_inline_result$$4_attrs$$8$$[$prop$$inline_363$$]) {
  ...
  $oj$$1$$.$Model$.prototype.$changedAttributes$ = function $$oj$$1$$$$Model$$$$changedAttributes$$($attributes$$6$$) {
    if ($attributes$$6$$) {
      var $internalChanges$$ = {}, $prop$$38$$;
      for ($prop$$38$$ in $attributes$$6$$) {
        $attributes$$6$$.hasOwnProperty($prop$$38$$) && ($oj$$1$$.$Object$.$__innerEquals$($attributes$$6$$[$prop$$38$$], this.attributes[$prop$$38$$]) || ($internalChanges$$[$prop$$38$$] = $attributes$$6$$[$prop$$38$$]));
      }
  ...
  $oj$$1$$.$Model$.prototype.toJSON = function $$oj$$1$$$$Model$$$toJSON$() {
    var $retObj$$4$$ = {}, $prop$$39$$;
    for ($prop$$39$$ in this.attributes) {
      this.attributes.hasOwnProperty($prop$$39$$) && (Array.isArray(this.attributes[$prop$$39$$]) ? $retObj$$4$$[$prop$$39$$] = this.attributes[$prop$$39$$].slice(0) : $retObj$$4$$[$prop$$39$$] = this.attributes[$prop$$39$$]);
    }
    return $retObj$$4$$;
  };
  ...
  $oj$$1$$.$Model$.$_internalSync$ = function $$oj$$1$$$$Model$$$_internalSync$$($method$$3$$, $model$$10$$, $options$$41$$) {
    ...
    var $newOpt$$ = {};
    if ($options$$41$$) {
      for (var $prop$$40$$ in $options$$41$$) {
        $newOpt$$[$prop$$40$$] = $options$$41$$[$prop$$40$$];
      }
    }
    $recordId_urlOpt$$ = $oj$$1$$.$Model$.$SetCustomURLOptions$($recordId_urlOpt$$, $model$$10$$, $options$$41$$);
    for ($prop$$40$$ in $recordId_urlOpt$$) {
      $newOpt$$[$prop$$40$$] = $recordId_urlOpt$$[$prop$$40$$];
    }
  ...
  $oj$$1$$.$RestImpl$.$addOptions$ = function $$oj$$1$$$$RestImpl$$$addOptions$$($starter$$, $options$$44$$, $customOptions$$) {
    ...
    for ($prop$$41$$ in $options$$44$$) {
      $options$$44$$.hasOwnProperty($prop$$41$$) && "oauthHeader" !== $prop$$41$$ && ($starter$$.hasOwnProperty($prop$$41$$) || ($starter$$[$prop$$41$$] = $options$$44$$[$prop$$41$$]), $prop$$41$$ === $oj$$1$$.$RestImpl$.$_HEADER_PROP$ && ($starter$$[$prop$$41$$] = $$$$1$$.extend(!0, $starter$$[$prop$$41$$], $options$$44$$[$prop$$41$$])));
    }
    if ($options$$44$$.oauthHeader) {
      for ($prop$$41$$ in $starter$$[$oj$$1$$.$RestImpl$.$_HEADER_PROP$] || ($starter$$[$oj$$1$$.$RestImpl$.$_HEADER_PROP$] = {}), $options$$44$$.oauthHeader) {
        $options$$44$$.oauthHeader.hasOwnProperty($prop$$41$$) && ($starter$$[$oj$$1$$.$RestImpl$.$_HEADER_PROP$].hasOwnProperty($prop$$41$$) || ($starter$$[$oj$$1$$.$RestImpl$.$_HEADER_PROP$][$prop$$41$$] = $options$$44$$.oauthHeader[$prop$$41$$]));
      }
    }
    return $starter$$;
  };
  ...
  $oj$$1$$.$OAuth$.$_initAccessToken$ = function $$oj$$1$$$$OAuth$$$_initAccessToken$$($oauthObj$$, $data$$39$$) {
    var $prop$$42$$;
    $data$$39$$ = $data$$39$$ || {};
    for ($prop$$42$$ in $data$$39$$) {
      $oauthObj$$[$prop$$42$$] = $data$$39$$[$prop$$42$$];
    }
  };
  ...
  $oj$$1$$.$OAuth$.$_base64_encode$ = function $$oj$$1$$$$OAuth$$$_base64_encode$$($a$$73$$) {
    var $d$$, $e$$20$$, $f$$, $b$$44$$, $g$$ = 0, $h$$4$$ = 0, $c$$27$$ = [];
    do {
      $d$$ = $a$$73$$.charCodeAt($g$$++), $e$$20$$ = $a$$73$$.charCodeAt($g$$++), $f$$ = $a$$73$$.charCodeAt($g$$++), $b$$44$$ = $d$$ << 16 | $e$$20$$ << 8 | $f$$, $d$$ = $b$$44$$ >> 18 & 63, $e$$20$$ = $b$$44$$ >> 12 & 63, $f$$ = $b$$44$$ >> 6 & 63, $b$$44$$ &= 63, $c$$27$$[$h$$4$$++] = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt($d$$) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt($e$$20$$) + "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt($f$$) + 
      "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/\x3d".charAt($b$$44$$);
    } while ($g$$ < $a$$73$$.length);
    $c$$27$$ = $c$$27$$.join("");
    $d$$ = $a$$73$$.length % 3;
    return($d$$ ? $c$$27$$.slice(0, $d$$ - 3) : $c$$27$$) + "\x3d\x3d\x3d".slice($d$$ || 3);
  };
  ...
  $oj$$1$$.$Collection$.extend = function $$oj$$1$$$$Collection$$extend$($properties$$5$$, $classProperties$$1$$) {
    ...
    if ($classProperties$$1$$) {
      for (var $prop$$43$$ in $classProperties$$1$$) {
        $classProperties$$1$$.hasOwnProperty($prop$$43$$) && ($Collection$$[$prop$$43$$] = $classProperties$$1$$[$prop$$43$$]);
      }
    }
    if ($properties$$5$$) {
      for ($prop$$43$$ in $properties$$5$$) {
        $properties$$5$$.hasOwnProperty($prop$$43$$) && ($obj$$47$$[$prop$$43$$] = $properties$$5$$[$prop$$43$$]);
      }
    }
  ...
  $oj$$1$$.$Collection$._init = function $$oj$$1$$$$Collection$$_init$($collection$$3$$, $models$$2$$, $options$$61$$, $properties$$6$$) {
    var $i$$31_prop$$44$$, $modelList_optionlist$$;
    $collection$$3$$.Init();
    $oj$$1$$.$Events$.$Mixin$($collection$$3$$);
    if ($properties$$6$$) {
      for ($i$$31_prop$$44$$ in $properties$$6$$) {
        $properties$$6$$.hasOwnProperty($i$$31_prop$$44$$) && ($collection$$3$$[$i$$31_prop$$44$$] = $properties$$6$$[$i$$31_prop$$44$$]);
      }
    }
    ...
    for ($i$$31_prop$$44$$ = 0;$i$$31_prop$$44$$ < $modelList_optionlist$$.length;$i$$31_prop$$44$$++) {
      $options$$61$$.hasOwnProperty($modelList_optionlist$$[$i$$31_prop$$44$$]) && void 0 !== $options$$61$$[$modelList_optionlist$$[$i$$31_prop$$44$$]] && ($collection$$3$$[$modelList_optionlist$$[$i$$31_prop$$44$$]] = $options$$61$$[$modelList_optionlist$$[$i$$31_prop$$44$$]]);
    }
    ...
    if (null != $models$$2$$) {
      for ($options$$61$$.$noparse$ = !0, $modelList_optionlist$$ = $models$$2$$ instanceof Array ? $models$$2$$ : [$models$$2$$], $i$$31_prop$$44$$ = 0;$i$$31_prop$$44$$ < $modelList_optionlist$$.length;$i$$31_prop$$44$$ += 1) {
        $collection$$3$$.add($modelList_optionlist$$[$i$$31_prop$$44$$], $options$$61$$);
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$_setChangeAt$ = function $$oj$$1$$$$Collection$$$$_setChangeAt$$($start$$6$$, $count$$8$$) {
    for (var $at$$ = $start$$6$$;$at$$ < $start$$6$$ + $count$$8$$;$at$$++) {
      -1 === this.changes.indexOf($at$$) && (this.changes.push($at$$), this.changes.sort(function($a$$74$$, $b$$45$$) {
        return $a$$74$$ - $b$$45$$;
      }));
    }
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_cloneInternal$ = function $$oj$$1$$$$Collection$$$$_cloneInternal$$($i$$41_withProperties$$) {
    var $c$$28$$ = new this.constructor, $model$$20$$;
    this.$IsVirtual$() && ($c$$28$$ = this.$_copyFetchProperties$($c$$28$$), $c$$28$$.$_resetModelsToFullLength$());
    $c$$28$$ = this.$_copyProperties$($c$$28$$);
    if ($i$$41_withProperties$$) {
      ...
      $indices$$.sort(function($a$$75$$, $b$$46$$) {
        return $a$$75$$ - $b$$46$$;
      });
      var $index$$56$$;
      for ($i$$41_withProperties$$ = 0;$i$$41_withProperties$$ < $indices$$.length;$i$$41_withProperties$$++) {
        $index$$56$$ = $indices$$[$i$$41_withProperties$$], ($model$$20$$ = this.$_atInternal$($index$$56$$, null, !0, !1)) && $c$$28$$.$_addInternal$($model$$20$$.clone(), {at:$index$$56$$}, !0, !1);
      }
    }
    return $c$$28$$;
  };
  $oj$$1$$.$Collection$.prototype.$_copyProperties$ = function $$oj$$1$$$$Collection$$$$_copyProperties$$($collection$$5$$) {
    var $props$$2$$ = ["comparator", "model", "modelId"], $prop$$45$$, $i$$42$$;
    for ($i$$42$$ = 0;$i$$42$$ < $props$$2$$.length;$i$$42$$++) {
      $prop$$45$$ = $props$$2$$[$i$$42$$], $collection$$5$$[$prop$$45$$] = this[$prop$$45$$];
    }
    return $collection$$5$$;
  };
  $oj$$1$$.$Collection$.prototype.$_copyFetchProperties$ = function $$oj$$1$$$$Collection$$$$_copyFetchProperties$$($collection$$6$$) {
    var $props$$3$$ = ["totalResults", "hasMore", $oj$$1$$.$Collection$.$_FETCH_SIZE_PROP$], $prop$$46$$, $i$$43$$;
    for ($i$$43$$ = 0;$i$$43$$ < $props$$3$$.length;$i$$43$$++) {
      $prop$$46$$ = $props$$3$$[$i$$43$$], $collection$$6$$[$prop$$46$$] = this[$prop$$46$$];
    }
    return $collection$$6$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_addInternal$ = function $$oj$$1$$$$Collection$$$$_addInternal$$($m$$2$$, $options$$67$$, $fillIn$$, $deferred$$2$$) {
    function $mergeAttrs$$($collection$$10$$, $modelToTryAndMerge_sortOpt$$inline_397$$, $modelFoundInCollection$$1$$, $newModel$$3$$, $deferred$$4$$) {
      ...
      $needSort$$1$$ && void 0 === $existingModel$$1$$ && !$sort$$ && void 0 === $at$$1$$ && 1 < $collection$$10$$.$_getLength$() && (-1 < $index$$57$$ && ($cid$$1$$ = $collection$$10$$.$_getModel$($index$$57$$).cid), $modelToTryAndMerge_sortOpt$$inline_397$$ = {}, $oj$$1$$.$CollectionUtils$.$copyInto$($modelToTryAndMerge_sortOpt$$inline_397$$, $options$$67$$), $modelToTryAndMerge_sortOpt$$inline_397$$.add = !0, $collection$$10$$.sort($modelToTryAndMerge_sortOpt$$inline_397$$), -1 < $index$$57$$ && 
  ...
  $oj$$1$$.$Collection$.prototype.sort = function $$oj$$1$$$$Collection$$$sort$($options$$68$$) {
    ...
    $self$$7$$ = this;
    this.$_getModels$().sort(function($a$$76$$, $b$$47$$) {
      return $oj$$1$$.$Collection$.$SortFunc$($a$$76$$, $b$$47$$, $comparator$$2$$, $self$$7$$, $self$$7$$);
    });
  ...
  $oj$$1$$.$Collection$.$SortFunc$ = function $$oj$$1$$$$Collection$$$SortFunc$$($a$$77$$, $b$$48$$, $attrs$$12_comparator$$3$$, $collection$$13$$, $self$$8$$) {
    var $attrs1_keyA$$, $keyB_retVal$$2$$, $i$$45$$;
    if ($$$$1$$.isFunction($attrs$$12_comparator$$3$$)) {
      if (1 === $attrs$$12_comparator$$3$$.length) {
        $attrs1_keyA$$ = $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$77$$);
        $keyB_retVal$$2$$ = $attrs$$12_comparator$$3$$.call($self$$8$$, $b$$48$$);
      ...
      return $attrs$$12_comparator$$3$$.call($self$$8$$, $a$$77$$, $b$$48$$);
    }
    if ($oj$$1$$.$StringUtils$.$isString$($attrs$$12_comparator$$3$$)) {
      for ($attrs$$12_comparator$$3$$ = $attrs$$12_comparator$$3$$.split(","), $i$$45$$ = 0;$i$$45$$ < $attrs$$12_comparator$$3$$.length;$i$$45$$++) {
        if ($attrs1_keyA$$ = $oj$$1$$.$Collection$.$_getKey$($a$$77$$, $attrs$$12_comparator$$3$$[$i$$45$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_getKey$($b$$48$$, $attrs$$12_comparator$$3$$[$i$$45$$]), $keyB_retVal$$2$$ = $oj$$1$$.$Collection$.$_compareKeys$($attrs1_keyA$$, $keyB_retVal$$2$$, $collection$$13$$.sortDirection), 0 !== $keyB_retVal$$2$$) {
          return $keyB_retVal$$2$$;
        }
      }
    }
  ...
  $oj$$1$$.$Collection$.prototype.$sortedIndex$ = function $$oj$$1$$$$Collection$$$$sortedIndex$$($model$$23$$, $comparator$$4$$) {
    ...
    $self$$9$$ = this;
    return $oj$$1$$.$Collection$.$_find$(this.$_getModels$(), $model$$23$$, function($a$$78$$, $b$$49$$) {
      var $attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$;
      if ($$$$1$$.isFunction($comp$$)) {
        if (1 === $comp$$.length) {
          $attrs1$$1_keyA$$1$$ = $comp$$.call($self$$9$$, $a$$78$$);
          $attrs2$$1_keyB$$1$$ = $comp$$.call($self$$9$$, $b$$49$$);
        ...
        return $comp$$.call($self$$9$$, $a$$78$$, $b$$49$$);
      }
      return $oj$$1$$.$StringUtils$.$isString$($comp$$) ? ($attrs1$$1_keyA$$1$$ = $a$$78$$.get($comp$$), $attrs2$$1_keyB$$1$$ = $b$$49$$.get($comp$$), $oj$$1$$.$Collection$.$_compareKeys$($attrs1$$1_keyA$$1$$, $attrs2$$1_keyB$$1$$, $self$$9$$.sortDirection)) : 0;
    });
  };
      ...
      return new Promise(function($resolve$$3$$, $reject$$3$$) {
        if (!$self$$16$$.$IsVirtual$()) {
          ...
          try {
            ...
            var $opt$$7_startIndex$$1$$ = {}, $prop$$47$$;
            for ($prop$$47$$ in $options$$79$$) {
              $options$$79$$.hasOwnProperty($prop$$47$$) && ($opt$$7_startIndex$$1$$[$prop$$47$$] = $options$$79$$[$prop$$47$$]);
            }
    ...
    if (this.$IsVirtual$()) {
      ...
      return new Promise(function($resolve$$10$$, $reject$$10$$) {
        ...
        $opts$$7$$.success = function $$opts$$7$$$success$($collection$$17$$, $response$$3$$) {
          if (null != $response$$3$$) {
            var $index$$inline_400$$ = $self$$20$$.$_getOffset$(), $model$$inline_401$$ = $self$$20$$.$_getModel$($index$$inline_400$$);
            void 0 !== $model$$inline_401$$ && $model$$inline_401$$.$Match$($id$$9$$, $cid$$4$$) ? $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$($index$$inline_400$$, $model$$inline_401$$)) : $resolve$$10$$($oj$$1$$.$Collection$.$_getModinfo$(-1, void 0));
          } else {
  ...
  $oj$$1$$.$Collection$.prototype.parse = function $$oj$$1$$$$Collection$$$parse$($response$$4$$) {
    ...
    for ($prop$$48$$ in $response$$4$$) {
      if ($response$$4$$.hasOwnProperty($prop$$48$$) && $response$$4$$[$prop$$48$$] instanceof Array) {
        return $response$$4$$[$prop$$48$$];
      }
    }
    return $response$$4$$;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$_setRangeLocalFetch$ = function $$oj$$1$$$$Collection$$$$_setRangeLocalFetch$$($start$$19$$, $count$$15$$, $actual$$3_placement$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) {
    ...
    $newStart_opts$$8$$.success = function $$newStart_opts$$8$$$success$() {
      var $actual$$inline_403$$ = $self$$23$$.$_getLocalRange$($original$$2$$.start, $original$$2$$.count);
      if ($fill$$ && $self$$23$$.$_hasTotalResults$() && $actual$$inline_403$$.count < $original$$2$$.count) {
        var $newPlacement$$inline_404$$ = $actual$$inline_403$$.start + $actual$$inline_403$$.count, $newStart$$inline_405$$ = $start$$19$$ + $count$$15$$;
        $newStart$$inline_405$$ < $self$$23$$.totalResults ? $self$$23$$.$_setRangeLocalFetch$($newStart$$inline_405$$, $count$$15$$, $newPlacement$$inline_404$$, $original$$2$$, $resolve$$14$$, $reject$$14$$, $fill$$) : $resolve$$14$$($actual$$inline_403$$);
      } else {
        $resolve$$14$$($actual$$inline_403$$);
      }
    };
    try {
  ...
  $oj$$1$$.$Collection$.prototype.$_getLocalRange$ = function $$oj$$1$$$$Collection$$$$_getLocalRange$$($start$$23$$, $count$$19$$) {
    if (!this.$IsVirtual$()) {
      if (0 < this.$_getModelsLength$()) {
        if ($start$$23$$ + $count$$19$$ > this.$_getModelsLength$()) {
          var $c$$29_limit$$2$$ = this.$_getModelsLength$() - $start$$23$$;
          return{start:$start$$23$$, count:$c$$29_limit$$2$$, models:this.$_getModelArray$($start$$23$$, $c$$29_limit$$2$$)};
        }
        return{start:$start$$23$$, count:$count$$19$$, models:this.$_getModelArray$($start$$23$$, $count$$19$$)};
      }
      return{start:$start$$23$$, count:0, models:[]};
    }
    $c$$29_limit$$2$$ = this.$_getMaxLength$($start$$23$$, $count$$19$$);
    if (!this.$_hasTotalResults$() && $c$$29_limit$$2$$ < $start$$23$$ + $count$$19$$) {
      return{start:$start$$23$$, count:$c$$29_limit$$2$$ - $start$$23$$, models:this.$_getModelArray$($start$$23$$, $c$$29_limit$$2$$ - $start$$23$$)};
    }
    if (0 === $c$$29_limit$$2$$) {
      return{start:$start$$23$$, count:0, models:[]};
    }
    var $firstMissingModel$$ = this.$_getFirstMissingModel$($start$$23$$, $c$$29_limit$$2$$);
    ...
    $start$$23$$ > $c$$29_limit$$2$$ ? $count$$19$$ = 0 : $start$$23$$ + $count$$19$$ > $c$$29_limit$$2$$ && ($count$$19$$ = $c$$29_limit$$2$$ - $start$$23$$);
    return{start:$start$$23$$, count:$count$$19$$, models:this.$_getModelArray$($start$$23$$, $count$$19$$)};
  };
  ...
  $oj$$1$$.$Collection$.$_getProp$ = function $$oj$$1$$$$Collection$$$_getProp$$($custom$$1$$, $response$$10$$, $prop$$49$$) {
    return $custom$$1$$.hasOwnProperty($prop$$49$$) ? $custom$$1$$[$prop$$49$$] : $response$$10$$ ? $response$$10$$[$prop$$49$$] : void 0;
  };
  ...
  $oj$$1$$.$Collection$.prototype.$sortBy$ = function $$oj$$1$$$$Collection$$$$sortBy$$($iterator$$2$$, $context$$25$$) {
    ...
    $self$$29$$ = this;
    $retArr$$2$$.sort(function($a$$79$$, $b$$50$$) {
      var $keyA$$3$$, $keyB$$3$$;
      if ($$$$1$$.isFunction($iterator$$2$$)) {
        return $keyA$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$29$$, $a$$79$$), $keyB$$3$$ = $iterator$$2$$.call($context$$25$$ || $self$$29$$, $b$$50$$), $oj$$1$$.$Collection$.$_compareKeys$($keyA$$3$$, $keyB$$3$$, $self$$29$$.sortDirection);
      }
      $keyA$$3$$ = $a$$79$$.get($iterator$$2$$);
      $keyB$$3$$ = $b$$50$$.get($iterator$$2$$);
  ...
  $oj$$1$$.$Collection$.$_getQueryString$ = function $$oj$$1$$$$Collection$$$_getQueryString$$($q_queries$$) {
    ...
    var $str$$12$$ = "", $query$$3$$, $exp_value$$66$$, $i$$73$$, $prop$$50$$;
    for ($i$$73$$ = 0;$i$$73$$ < $q_queries$$.length;$i$$73$$++) {
      $query$$3$$ = $q_queries$$[$i$$73$$];
      for ($prop$$50$$ in $query$$3$$) {
        if ($query$$3$$.hasOwnProperty($prop$$50$$)) {
          for (var $val$$18$$ = Array.isArray($query$$3$$[$prop$$50$$]) ? $query$$3$$[$prop$$50$$] : [$query$$3$$[$prop$$50$$]], $j$$4$$ = 0;$j$$4$$ < $val$$18$$.length;$j$$4$$++) {
            if ($oj$$1$$.$Model$.$IsComplexValue$($val$$18$$[$j$$4$$])) {
              $exp_value$$66$$ = $val$$18$$[$j$$4$$].value;
              var $comparator$$6_compare$$ = null, $comparator$$6_compare$$ = $val$$18$$[$j$$4$$].comparator, $comparator$$6_compare$$ = $$$$1$$.isFunction($comparator$$6_compare$$) ? $comparator$$6_compare$$(null, $prop$$50$$, $exp_value$$66$$) : $comparator$$6_compare$$;
              $exp_value$$66$$ = $prop$$50$$ + $comparator$$6_compare$$ + $exp_value$$66$$;
            } else {
              $exp_value$$66$$ = $prop$$50$$ + "\x3d" + $query$$3$$[$prop$$50$$];
            }
            $str$$12$$ += $exp_value$$66$$ + "+";
          }
        }
  ...
  $oj$$1$$.$Collection$.prototype.$ModifyOptionsForCustomURL$ = function $$oj$$1$$$$Collection$$$$ModifyOptionsForCustomURL$$($attrs$$17_comparator$$7_options$$110$$) {
    var $opt$$16$$ = {}, $i$$74_prop$$51$$;
    for ($i$$74_prop$$51$$ in $attrs$$17_comparator$$7_options$$110$$) {
      $attrs$$17_comparator$$7_options$$110$$.hasOwnProperty($i$$74_prop$$51$$) && ($opt$$16$$[$i$$74_prop$$51$$] = $attrs$$17_comparator$$7_options$$110$$[$i$$74_prop$$51$$]);
    }
    if (($attrs$$17_comparator$$7_options$$110$$ = this.comparator) && $oj$$1$$.$StringUtils$.$isString$($attrs$$17_comparator$$7_options$$110$$)) {
      ...
      for ($i$$74_prop$$51$$ = 0;$i$$74_prop$$51$$ < $attrs$$17_comparator$$7_options$$110$$.length;$i$$74_prop$$51$$++) {
        $opt$$16$$.sort = 0 === $i$$74_prop$$51$$ ? $attrs$$17_comparator$$7_options$$110$$[$i$$74_prop$$51$$] : $opt$$16$$.sort + ("," + $attrs$$17_comparator$$7_options$$110$$[$i$$74_prop$$51$$]);
      }
