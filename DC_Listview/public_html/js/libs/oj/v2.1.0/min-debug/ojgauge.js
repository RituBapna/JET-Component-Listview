...
define(["ojs/ojcore", "jquery", "ojs/ojcomponentcore", "ojs/ojdvt-base", "ojs/internal-deps/dvt/DvtGauge"], function($oj$$16$$, $$$$16$$, $comp$$6$$, $base$$4$$, $dvt$$2$$) {
  $oj$$16$$.$__registerWidget$("oj.dvtBaseGauge", $$$$16$$.oj.dvtBaseComponent, {$_ProcessStyles$:function() {
    ...
    return $ret$$32$$;
  }, $_HandleEvent$:function($event$$333$$) {
    if ("valueChange" === $event$$333$$.type) {
      var $newValue$$11$$ = $event$$333$$.newValue;
      $event$$333$$.complete ? this.$_UserOptionChange$("value", $newValue$$11$$) : (this._trigger("input", null, {value:$newValue$$11$$}), this.$_UserOptionChange$("rawValue", $newValue$$11$$));
    } else {
      this._super($event$$333$$);
    }
  }, _setOption:function($key$$93$$, $value$$228$$, $flags$$25$$) {
    "rawValue" === $key$$93$$ ? $oj$$16$$.$Logger$.error("'rawValue' is a read-only option and cannot be set") : ("value" === $key$$93$$ && this.option("rawValue", $value$$228$$, {_context:{$writeback$:!0, $internalSet$:!0}}), this._super($key$$93$$, $value$$228$$, $flags$$25$$));
  ...
  $oj$$16$$.$__registerWidget$("oj.ojLedGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{}, $_CreateDvtComponent$:function($context$$75$$, $callback$$104$$, $callbackObj$$1$$) {
    return $dvt$$2$$.LedGauge.newInstance($context$$75$$, $callback$$104$$, $callbackObj$$1$$);
  ...
  $oj$$16$$.$__registerWidget$("oj.ojRatingGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$76$$, $callback$$105$$, $callbackObj$$2$$) {
    return $dvt$$2$$.RatingGauge.newInstance($context$$76$$, $callback$$105$$, $callbackObj$$2$$);
    ...
    this.element.attr("title") ? (this.options.shortDesc = this.element.attr("title"), this.element.data(this.element, "title", this.element.attr("title")), this.element.removeAttr("title")) : this.element.data("title") && (this.options.shortDesc = this.element.data("title"));
    this._super();
  }, $_UserOptionChange$:function($key$$94$$, $value$$229$$) {
    this._superApply(arguments);
    "value" == $key$$94$$ && this.$_UserOptionChange$("changed", !0);
  }});
  $oj$$16$$.$__registerWidget$("oj.ojDialGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$77$$, $callback$$106$$, $callbackObj$$3$$) {
    return $dvt$$2$$.DialGauge.newInstance($context$$77$$, $callback$$106$$, $callbackObj$$3$$);
  ...
  $oj$$16$$.$__registerWidget$("oj.ojStatusMeterGauge", $$$$16$$.oj.dvtBaseGauge, {widgetEventPrefix:"oj", options:{input:null, optionChange:null, rawValue:void 0}, $_CreateDvtComponent$:function($context$$78$$, $callback$$107$$, $callbackObj$$4$$) {
    return $dvt$$2$$.StatusMeterGauge.newInstance($context$$78$$, $callback$$107$$, $callbackObj$$4$$);
