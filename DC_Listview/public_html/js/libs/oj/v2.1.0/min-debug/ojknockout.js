...
define(["ojs/ojcore", "jquery", "knockout", "jqueryui-amd/widget"], function($oj$$7$$, $$$$7$$, $ko$$1$$) {
  ...
  function $_extractValueFromChangeEvent$$($event$$63$$, $eventData$$1$$) {
    var $nameVal$$ = {};
    $nameVal$$.value = $eventData$$1$$.value;
    return $nameVal$$;
  }
  function $_extractOptionChange$$($event$$64$$, $eventData$$2$$) {
  ...
  function $_getDiagramNodeRenderer$$($bindingContext$$4$$, $template$$4$$) {
    return function($context$$45$$) {
      ...
      $ko$$1$$.renderTemplate($template$$4$$, $model$$57$$, {afterRender:function($renderedElement$$1$$) {
        $$$$7$$($renderedElement$$1$$)._ojDetectCleanData();
      }}, $context$$45$$.parentElement);
      return null;
    };
  }
  ...
  function $_getDataGridHeaderRenderer$$($bindingContext$$12$$, $template$$5$$) {
    return function($context$$46$$) {
      ...
      $ko$$1$$.renderTemplate($template$$5$$, $childContext$$1$$, {afterRender:function($renderedElement$$2$$) {
  ...
  function $_getDataGridCellRenderer$$($bindingContext$$13$$, $template$$6$$) {
    return function($context$$47$$) {
      ...
      $ko$$1$$.renderTemplate($template$$6$$, $childContext$$2$$, {afterRender:function($renderedElement$$3$$) {
  ...
  function $_getTableColumnTemplateRenderer$$($bindingContext$$14$$, $type$$77$$, $template$$7$$) {
    ...
    (function($template$$8$$, $type$$78$$) {
      $rendererOption$$ = function $$rendererOption$$$($params$$13$$) {
        ...
        $ko$$1$$.renderTemplate($template$$8$$, $childContext$$3$$, {afterRender:function($renderedElement$$4$$) {
  ...
  function $_getTableRowTemplateRenderer$$($bindingContext$$15$$, $template$$9$$) {
    return function($params$$14$$) {
      ...
      $ko$$1$$.renderTemplate($template$$9$$, $childContext$$4$$, {afterRender:function($renderedElement$$5$$) {
        $$$$7$$($renderedElement$$5$$)._ojDetectCleanData();
      }}, $params$$14$$.rowContext.parentElement, "replaceNode");
    };
  }
  function $_getListViewItemRenderer$$($bindingContext$$16$$, $template$$10$$) {
    return function($context$$48$$) {
      ...
      $ko$$1$$.renderTemplate($template$$10$$, $childContext$$5$$, {afterRender:function($renderedElement$$6$$) {
  ...
  $oj$$7$$.$ComponentBinding$.prototype._init = function $$oj$$7$$$$ComponentBinding$$$_init$($element$$44$$, $valueAccessor$$, $allBindingsAccessor$$, $viewModel$$1$$, $bindingContext$$18$$) {
    $ko$$1$$.applyBindingsToDescendants($bindingContext$$18$$, $element$$44$$);
    return{controlsDescendantBindings:!0};
  };
  $oj$$7$$.$ComponentBinding$.prototype.$_update$ = function $$oj$$7$$$$ComponentBinding$$$$_update$$($element$$45$$, $valueAccessor$$1$$, $allBindingsAccessor$$1$$, $viewModel$$2$$, $bindingContext$$19$$) {
    ...
    function $createComponent$$($componentName$$3$$, $nameOption$$, $bindingValue$$) {
      if (null != $componentName$$3$$) {
        ...
        if ("function" !== typeof $comp$$2$$) {
          ...
          $component$$7$$ = this.$_initComponent$($element$$45$$, {$component$:$comp$$2$$, $changeTracker$:$changeTracker$$, $componentName$:$componentName$$3$$, $specifiedOptions$:$specifiedOptions$$, $computeds$:$componentComputeds$$, $valueAccessor$:function() {
            return $bindingValue$$;
    ...
    var $componentComputeds$$ = [], $stage$$ = 0, $component$$7$$, $changeTracker$$, $jelem$$4$$ = $$$$7$$($element$$45$$);
    $ko$$1$$.ignoreDependencies(function() {
      ...
      }, this, {disposeWhenNodeIsRemoved:$element$$45$$});
    }, this);
    $ko$$1$$.utils.domNodeDisposal.addDisposeCallback($element$$45$$, $cleanup$$.bind(this, [!1]));
  };
  $oj$$7$$.$ComponentBinding$.prototype.$_initComponent$ = function $$oj$$7$$$$ComponentBinding$$$$_initComponent$$($element$$46$$, $ctx$$) {
    function $propertyReadFunc$$() {
      var $initProps_prop$$59_updateProps$$ = this.$_property$, $updateKeys_value$$157$$ = $oj$$7$$.$ComponentBinding$.$_toJS$($ctx$$.$valueAccessor$()[$initProps_prop$$59_updateProps$$]);
      if (0 === $stage$$1$$) {
        var $initFunc_k$$5_managedPropEntry_updateFunc$$ = $managedAttrMap$$[$initProps_prop$$59_updateProps$$];
        null != $initFunc_k$$5_managedPropEntry_updateFunc$$ ? ($specifiedManagedAttrs$$[$initProps_prop$$59_updateProps$$] = $initFunc_k$$5_managedPropEntry_updateFunc$$, $initFunc_k$$5_managedPropEntry_updateFunc$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$.$init$, null != $initFunc_k$$5_managedPropEntry_updateFunc$$ && ($initProps_prop$$59_updateProps$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$($initProps_prop$$59_updateProps$$, $updateKeys_value$$157$$, $element$$46$$, $comp$$3$$, $ctx$$.$valueAccessor$, 
        $ctx$$.$allBindingsAccessor$, $ctx$$.$bindingContext$) || {}, $oj$$7$$.$CollectionUtils$.$copyInto$($resolvedInitialOptions$$, $initProps_prop$$59_updateProps$$))) : $resolvedInitialOptions$$[$initProps_prop$$59_updateProps$$] = $updateKeys_value$$157$$;
      } else {
        if (!$disposed$$) {
          if (null != $managedAttrMap$$[$initProps_prop$$59_updateProps$$]) {
            if ($initFunc_k$$5_managedPropEntry_updateFunc$$ = $managedAttrMap$$[$initProps_prop$$59_updateProps$$].update, null != $initFunc_k$$5_managedPropEntry_updateFunc$$) {
              for ($initProps_prop$$59_updateProps$$ = $initFunc_k$$5_managedPropEntry_updateFunc$$($initProps_prop$$59_updateProps$$, $updateKeys_value$$157$$, $element$$46$$, $comp$$3$$, $ctx$$.$valueAccessor$, $ctx$$.$allBindingsAccessor$, $ctx$$.$bindingContext$) || {}, $updateKeys_value$$157$$ = Object.keys($initProps_prop$$59_updateProps$$), $initFunc_k$$5_managedPropEntry_updateFunc$$ = 0;$initFunc_k$$5_managedPropEntry_updateFunc$$ < $updateKeys_value$$157$$.length;$initFunc_k$$5_managedPropEntry_updateFunc$$++) {
            ...
            $ctx$$.$changeTracker$.$addChange$($initProps_prop$$59_updateProps$$, $updateKeys_value$$157$$);
          }
        }
      }
    }
    var $disposed$$ = !1, $stage$$1$$ = 0, $specifiedManagedAttrs$$ = {}, $createCallback_jelem$$5_mutationOptions$$ = $$$$7$$($element$$46$$), $comp$$3$$ = $ctx$$.$component$, $componentName$$5_defaultManagedMap_k$$4_mutationKeys$$ = $ctx$$.$componentName$, $self$$51$$ = this;
    $createCallback_jelem$$5_mutationOptions$$.on("ojdestroy" + $oj$$7$$.$ComponentBinding$.$_HANDLER_NAMESPACE$, function($destroyCallback_evt$$18$$) {
      $destroyCallback_evt$$18$$.target && $destroyCallback_evt$$18$$.target == $element$$46$$ && ($ctx$$.$destroyCallback$(), ($destroyCallback_evt$$18$$ = $self$$51$$.$_bindingOptions$.beforeDestroy) && $destroyCallback_evt$$18$$($element$$46$$, $comp$$3$$, $ctx$$.$valueAccessor$, $ctx$$.$allBindingsAccessor$, $ctx$$.$bindingContext$), $oj$$7$$.$ComponentBinding$.$_deliverCreateDestroyEventToManagedProps$(!1, $specifiedManagedAttrs$$, $element$$46$$, $comp$$3$$, $ctx$$.$valueAccessor$, $ctx$$.$allBindingsAccessor$, 
    ...
    ($createCallback_jelem$$5_mutationOptions$$ = this.$_bindingOptions$.afterCreate) && $createCallback_jelem$$5_mutationOptions$$($element$$46$$, $comp$$3$$, $ctx$$.$valueAccessor$, $ctx$$.$allBindingsAccessor$, $ctx$$.$bindingContext$);
    $oj$$7$$.$ComponentBinding$.$_deliverCreateDestroyEventToManagedProps$(!0, $specifiedManagedAttrs$$, $element$$46$$, $comp$$3$$, $ctx$$.$valueAccessor$, $ctx$$.$allBindingsAccessor$, $ctx$$.$bindingContext$);
  ...
  $oj$$7$$.$ComponentBinding$.$_deliverCreateDestroyEventToManagedProps$ = function $$oj$$7$$$$ComponentBinding$$$_deliverCreateDestroyEventToManagedProps$$($isCreate$$, $managedAttrMap$$2$$, $element$$47$$, $comp$$4$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$21$$) {
    for (var $props$$7$$ = Object.keys($managedAttrMap$$2$$), $i$$131$$ = 0;$i$$131$$ < $props$$7$$.length;$i$$131$$++) {
      var $prop$$61$$ = $props$$7$$[$i$$131$$], $callback$$84_entry$$1$$ = $managedAttrMap$$2$$[$prop$$61$$];
      ($callback$$84_entry$$1$$ = $isCreate$$ ? $callback$$84_entry$$1$$.$afterCreate$ : $callback$$84_entry$$1$$.$beforeDestroy$) && $callback$$84_entry$$1$$($prop$$61$$, $element$$47$$, $comp$$4$$, $valueAccessor$$2$$, $allBindingsAccessor$$2$$, $bindingContext$$21$$);
    }
  };
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["optionTemplate"], init:function($name$$91_result$$16$$, $value$$159$$, $element$$48$$, $widgetConstructor$$, $valueAccessor$$3$$, $allBindingsAccessor$$3$$, $bindingContext$$22$$) {
  ...
  }, update:function($name$$92$$, $value$$160$$, $element$$49$$, $widgetConstructor$$1$$, $valueAccessor$$4$$, $allBindingsAccessor$$4$$, $bindingContext$$23$$) {
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["areaLayers", "pointDataLayers"], init:function($name$$93$$, $value$$161$$, $element$$50$$, $widgetConstructor$$2$$, $valueAccessor$$5$$, $allBindingsAccessor$$5$$, $bindingContext$$24$$) {
    return $_handleManagedAttributes$$($name$$93$$, $value$$161$$, $bindingContext$$24$$);
  }, update:function($name$$94$$, $value$$162$$, $element$$51$$, $widgetConstructor$$3$$, $valueAccessor$$6$$, $allBindingsAccessor$$6$$, $bindingContext$$25$$) {
    return $_handleManagedAttributes$$($name$$94$$, $value$$162$$, $bindingContext$$25$$);
  }, "for":"ojThematicMap"});
  $ko$$1$$.bindingHandlers.ojContextMenu = {update:function $$ko$$1$$$bindingHandlers$ojContextMenu$update$($element$$52$$, $valueAccessor$$7$$) {
    function $launch$$1$$($event$$67$$, $eventType$$29_openOptions$$1$$, $pressHold$$1$$) {
      ...
      "touchstart" === $doubleOpenType$$1$$ && "contextmenu" === $event$$67$$.type || "contextmenu" === $doubleOpenType$$1$$ && "touchstart" === $event$$67$$.type ? ($doubleOpenType$$1$$ = null, clearTimeout($doubleOpenTimer$$1$$)) : !$event$$67$$.isDefaultPrevented() && ($eventType$$29_openOptions$$1$$ = {launcher:$$element$$, initialFocus:"menu", position:{mouse:{my:"start top", at:"start bottom", of:$event$$67$$}, touch:{my:"start\x3e40 center", at:"start bottom", of:$event$$67$$, collision:"flipfit"}, 
      keyboard:{my:"start top", at:"start bottom", of:"launcher"}}[$eventType$$29_openOptions$$1$$]}, $menu$$3$$.$__openingContextMenu$ = !0, $menu$$3$$.open($event$$67$$, $eventType$$29_openOptions$$1$$), $menu$$3$$.$__openingContextMenu$ = !1, $getContextMenuNode$$().is(":visible") && ($event$$67$$.preventDefault(), document.addEventListener("keyup", $preventKeyUpEventIfMenuOpen$$), "touchstart" === $event$$67$$.type || "contextmenu" === $event$$67$$.type)) && ($doubleOpenType$$1$$ = $event$$67$$.type, 
      $doubleOpenTimer$$1$$ = setTimeout(function() {
        $doubleOpenType$$1$$ = null;
      }, 300));
    }
    function $preventKeyUpEventIfMenuOpen$$($event$$66$$) {
      121 == $event$$66$$.which && $event$$66$$.shiftKey && $getContextMenuNode$$().is(":visible") && $event$$66$$.preventDefault();
    }
    ...
    var $$element$$ = $$$$7$$($element$$52$$), $$menu$$, $_menu$$, $pressHoldTimer$$, $isPressHold$$1$$ = !1, $touchInProgress$$1$$ = !1, $doubleOpenTimer$$1$$, $doubleOpenType$$1$$ = null, $clickListener$$;
    ...
    $$$$7$$.isPlainObject($menuSelector$$) && ($menuSelector$$ = $element$$52$$.getAttribute("contextmenu")) && ($menuSelector$$ = document.getElementById($menuSelector$$));
    $clickListener$$ = function $$clickListener$$$($event$$69$$) {
      if ($isPressHold$$1$$) {
        return $event$$69$$.preventDefault(), $event$$69$$.stopPropagation(), $isPressHold$$1$$ = !1;
      }
    };
    $element$$52$$.addEventListener("click", $clickListener$$, !0);
    $$element$$.on("touchstart.ojContextMenu mousedown.ojContextMenu keydown.ojContextMenu ", function($event$$70$$) {
      if ("mousedown" !== $event$$70$$.type || !$getContextMenu$$().$__contextMenuPressHoldJustEnded$()) {
        return $isPressHold$$1$$ = !1, "touchstart" === $event$$70$$.type && ($touchInProgress$$1$$ = !0, $pressHoldTimer$$ = setTimeout($launch$$1$$.bind(void 0, $event$$70$$, "touch", !0), 750)), !0;
      }
    }).on("touchend.ojContextMenu touchcancel.ojContextMenu", function() {
      $touchInProgress$$1$$ = !1;
      clearTimeout($pressHoldTimer$$);
      return!0;
    }).on("keydown.ojContextMenu contextmenu.ojContextMenu", function($event$$72$$) {
      ("contextmenu" === $event$$72$$.type || 121 == $event$$72$$.which && $event$$72$$.shiftKey) && $launch$$1$$($event$$72$$, $touchInProgress$$1$$ ? "touch" : "keydown" === $event$$72$$.type ? "keyboard" : "mouse", !1);
      return!0;
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["template"], init:function($name$$95$$, $value$$164$$, $element$$53$$, $widgetConstructor$$4$$, $valueAccessor$$8$$, $allBindingsAccessor$$7$$, $bindingContext$$27$$) {
    return "template" === $name$$95$$ ? {_templateFunction:$_getDiagramNodeRenderer$$($bindingContext$$27$$, $value$$164$$)} : null;
  }, update:function($name$$96$$, $value$$165$$, $element$$54$$, $widgetConstructor$$5$$, $valueAccessor$$9$$, $allBindingsAccessor$$8$$, $bindingContext$$28$$) {
    ...
    if (!$ko$$1$$.templates) {
      ...
      $_engine$$.makeTemplateSource = function $$_engine$$$makeTemplateSource$($template$$13$$, $templateDocument$$) {
        if ("string" == typeof $template$$13$$) {
          ...
          var $elem$$20$$ = $templateDocument$$.getElementById($template$$13$$);
          return $elem$$20$$ ? new $ko$$1$$.templateSources.domElement($elem$$20$$) : new $StringTemplate$$($template$$13$$);
        }
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["header", "cell"], init:function($cellTemplate_column_name$$97_row$$, $value$$168$$, $columnTemplate_element$$55_rowTemplate$$, $widgetConstructor$$6$$, $valueAccessor$$10$$, $allBindingsAccessor$$9$$, $bindingContext$$29$$) {
    if ("header" === $cellTemplate_column_name$$97_row$$) {
      return $cellTemplate_column_name$$97_row$$ = $value$$168$$.row, null != $cellTemplate_column_name$$97_row$$ && ($columnTemplate_element$$55_rowTemplate$$ = $cellTemplate_column_name$$97_row$$.template, null != $columnTemplate_element$$55_rowTemplate$$ && ($cellTemplate_column_name$$97_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$29$$, $columnTemplate_element$$55_rowTemplate$$))), $cellTemplate_column_name$$97_row$$ = $value$$168$$.column, null != $cellTemplate_column_name$$97_row$$ && 
      ($columnTemplate_element$$55_rowTemplate$$ = $cellTemplate_column_name$$97_row$$.template, null != $columnTemplate_element$$55_rowTemplate$$ && ($cellTemplate_column_name$$97_row$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$29$$, $columnTemplate_element$$55_rowTemplate$$))), {header:$value$$168$$};
    }
  ...
  }, update:function($cellTemplate$$1_column$$1_name$$98_row$$1$$, $value$$169$$, $columnTemplate$$1_element$$56_rowTemplate$$1$$, $widgetConstructor$$7$$, $valueAccessor$$11$$, $allBindingsAccessor$$10$$, $bindingContext$$30$$) {
    return "header" === $cellTemplate$$1_column$$1_name$$98_row$$1$$ ? ($cellTemplate$$1_column$$1_name$$98_row$$1$$ = $value$$169$$.row, null != $cellTemplate$$1_column$$1_name$$98_row$$1$$ && ($columnTemplate$$1_element$$56_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$98_row$$1$$.template, null != $columnTemplate$$1_element$$56_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$98_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$30$$, $columnTemplate$$1_element$$56_rowTemplate$$1$$))), 
    $cellTemplate$$1_column$$1_name$$98_row$$1$$ = $value$$169$$.column, null != $cellTemplate$$1_column$$1_name$$98_row$$1$$ && ($columnTemplate$$1_element$$56_rowTemplate$$1$$ = $cellTemplate$$1_column$$1_name$$98_row$$1$$.template, null != $columnTemplate$$1_element$$56_rowTemplate$$1$$ && ($cellTemplate$$1_column$$1_name$$98_row$$1$$.renderer = $_getDataGridHeaderRenderer$$($bindingContext$$30$$, $columnTemplate$$1_element$$56_rowTemplate$$1$$))), {header:$value$$169$$}) : "cell" === $cellTemplate$$1_column$$1_name$$98_row$$1$$ ? 
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["columns", "columnsDefault", "rowTemplate"], init:function($name$$99$$, $value$$170$$, $element$$57_i$$132$$, $template$$14_widgetConstructor$$8$$, $footerTemplate_valueAccessor$$12$$, $allBindingsAccessor$$11_headerTemplate$$, $bindingContext$$31$$) {
    if ("columns" == $name$$99$$ || "columnsDefault" == $name$$99$$) {
      for ($element$$57_i$$132$$ = 0;$element$$57_i$$132$$ < $value$$170$$.length;$element$$57_i$$132$$++) {
        var $column$$2$$ = $value$$170$$[$element$$57_i$$132$$];
  ...
  }, update:function($name$$100$$, $value$$171$$, $element$$58_i$$133$$, $widgetConstructor$$9$$, $template$$15_valueAccessor$$13$$, $allBindingsAccessor$$12_footerTemplate$$1$$, $bindingContext$$32$$) {
    if ("columns" == $name$$100$$ || "columnsDefault" == $name$$100$$) {
      var $headerTemplate$$1$$;
      for ($element$$58_i$$133$$ = 0;$element$$58_i$$133$$ < $value$$171$$.length;$element$$58_i$$133$$++) {
        var $column$$3$$ = $value$$171$$[$element$$58_i$$133$$];
  ...
  $oj$$7$$.$ComponentBinding$.$getDefaultInstance$().$setupManagedAttributes$({attributes:["item"], init:function($name$$101_result$$17$$, $value$$172$$, $element$$59$$, $widgetConstructor$$10$$, $valueAccessor$$14$$, $allBindingsAccessor$$13$$, $bindingContext$$33$$) {
  ...
  }, update:function($name$$102$$, $value$$173$$, $element$$60$$, $widgetConstructor$$11$$, $valueAccessor$$15$$, $allBindingsAccessor$$14$$, $bindingContext$$34$$) {
