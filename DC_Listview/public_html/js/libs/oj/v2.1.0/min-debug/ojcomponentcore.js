...
define(["ojs/ojcore", "jquery", "jqueryui-amd/core", "jqueryui-amd/widget", "ojs/ojmessaging"], function($oj$$3$$, $$$$3$$) {
  ...
  function $_defineDynamicProperty$$($self$$39$$, $originalDefaultValue$$, $constructorValue$$, $options$$116$$, $prop$$52$$, $getter$$, $contextCallback$$) {
  ...
  var $_OJ_WIDGET_NAMES_DATA$$ = "oj-component-names", $_OJ_COMPONENT_NODE_CLASS$$ = "oj-component-initnode", $_ojLastTouch$$ = 0, $_hasDocumentTouchEndHandler$$ = !1;
  $$$$3$$.widget("oj.baseComponent", {options:{contextMenu:null, rootAttributes:null, optionChange:void 0, destroy:void 0}, refresh:function() {
    ...
    var $element$$inline_471$$ = this.element, $widgetName$$inline_472$$ = this.widgetName, $data$$inline_473$$ = $element$$inline_471$$.data($_OJ_WIDGET_NAMES_DATA$$);
    $data$$inline_473$$ || ($data$$inline_473$$ = [], $element$$inline_471$$.data($_OJ_WIDGET_NAMES_DATA$$, $data$$inline_473$$));
    0 > $data$$inline_473$$.indexOf($widgetName$$inline_472$$) && $data$$inline_473$$.push($widgetName$$inline_472$$);
    ...
    var $element$$inline_475$$ = this.element, $index$$inline_478_widgetName$$inline_476$$ = this.widgetName, $data$$inline_477$$ = $element$$inline_475$$.data($_OJ_WIDGET_NAMES_DATA$$);
    $data$$inline_477$$ && ($index$$inline_478_widgetName$$inline_476$$ = $data$$inline_477$$.indexOf($index$$inline_478_widgetName$$inline_476$$), 0 <= $index$$inline_478_widgetName$$inline_476$$ && ($data$$inline_477$$.splice($index$$inline_478_widgetName$$inline_476$$, 1), 0 === $data$$inline_477$$.length && $element$$inline_475$$.removeData($_OJ_WIDGET_NAMES_DATA$$)));
  ...
  }, $_AddHoverAndActiveListeners$:function($element$$19$$) {
    if ($oj$$3$$.$DomUtils$.$isTouchSupported$()) {
      $element$$19$$.on("touchstart" + this.eventNamespace, this.$_hoverAndActiveStartHandler$.bind(this, "oj-active")).on("touchend" + this.eventNamespace + " touchcancel" + this.eventNamespace, this.$_hoverAndActiveEndHandler$.bind(this, !0));
    }
    $element$$19$$.on("mouseenter" + this.eventNamespace, this.$_hoverAndActiveStartHandler$.bind(this, "oj-hover")).on("mouseleave" + this.eventNamespace, this.$_hoverAndActiveEndHandler$.bind(this, !1));
    $element$$19$$.on("mousedown" + this.eventNamespace, this.$_hoverAndActiveStartHandler$.bind(this, "oj-active")).on("mouseup" + this.eventNamespace, function($event$$29$$) {
      $$$$3$$($event$$29$$.currentTarget).removeClass("oj-active");
    });
  }, $_RemoveHoverAndActiveListeners$:function($element$$20$$) {
    $element$$20$$ && $$$$3$$($element$$20$$).off(this.eventNamespace);
  }, $_hoverAndActiveStartHandler$:function($markerClass$$, $event$$30$$) {
    var $elem$$15$$ = $$$$3$$($event$$30$$.currentTarget);
    $elem$$15$$.hasClass("oj-disabled") || "touchstart" !== $event$$30$$.type && !this.$_isRealMouseEvent$($event$$30$$) || $elem$$15$$.removeClass("oj-default").addClass($markerClass$$);
  }, $_hoverAndActiveEndHandler$:function($isTouchEvent$$, $event$$31$$) {
    $isTouchEvent$$ && ($_ojLastTouch$$ = Date.now());
    $$$$3$$($event$$31$$.currentTarget).removeClass("oj-hover").removeClass("oj-active").addClass("oj-default");
  }, _hoverable:function($element$$21$$) {
    this._on($element$$21$$, {mouseenter:function($event$$32$$) {
      $$$$3$$($event$$32$$.currentTarget).hasClass("oj-disabled") || $$$$3$$($event$$32$$.currentTarget).addClass("oj-hover");
    }, mouseleave:function($event$$33$$) {
      $$$$3$$($event$$33$$.currentTarget).removeClass("oj-hover");
    }});
  }, _focusable:function($element$$22$$) {
    this._on($element$$22$$, {focusin:function($event$$34$$) {
      $$$$3$$($event$$34$$.currentTarget).addClass("oj-focus");
    }, focusout:function($event$$35$$) {
      $$$$3$$($event$$35$$.currentTarget).removeClass("oj-focus");
    }});
  }, $_activeable$:function($element$$23$$) {
    this._on($element$$23$$, {mousedown:function($event$$36$$) {
      $$$$3$$($event$$36$$.currentTarget).addClass("oj-active");
    }, mouseup:function($event$$37$$) {
      $$$$3$$($event$$37$$.currentTarget).removeClass("oj-active");
    }});
  }, $_UnregisterChildNode$:function($element$$24$$) {
    this.$_RemoveHoverAndActiveListeners$($element$$24$$);
    if ($element$$24$$) {
      var $bindings$$ = this.bindings;
      $bindings$$ && (this.bindings = $$$$3$$($bindings$$.not($element$$24$$)));
    }
    ...
    var $sectionNames$$ = [], $self$$44$$ = this, $index$$80$$ = 0;
    this.$_traverseWidgetHierarchy$(function($name$$66_proto$$1$$) {
      $name$$66_proto$$1$$ = 0 == $index$$80$$ ? $self$$44$$.$_GetTranslationsSectionName$() : $name$$66_proto$$1$$.widgetFullName;
      $index$$80$$++;
    ...
    if (!this.$_propertyContext$) {
      ...
      for (var $element$$25$$ = this.element[0], $elem$$inline_480$$ = $element$$25$$, $containers$$inline_481$$ = [];$elem$$inline_480$$;) {
        var $ga$$inline_482_name$$inline_483$$ = $elem$$inline_480$$.getAttribute, $ga$$inline_482_name$$inline_483$$ = $ga$$inline_482_name$$inline_483$$ ? $ga$$inline_482_name$$inline_483$$.call($elem$$inline_480$$, $oj$$3$$.Components.$_OJ_CONTAINER_ATTR$) : null;
        null != $ga$$inline_482_name$$inline_483$$ && $containers$$inline_481$$.push($ga$$inline_482_name$$inline_483$$);
        $elem$$inline_480$$ = $elem$$inline_480$$.parentNode;
      }
      $c$$30$$.containers = $containers$$inline_481$$;
      $c$$30$$.element = $element$$25$$;
    }
    ...
    if (!$$$$3$$.isEmptyObject($defaults$$1$$)) {
      var $self$$45$$ = this, $allProperties_contextCallback$$1$$ = function $$allProperties_contextCallback$$1$$$() {
        return $self$$45$$.$_getDynamicPropertyContext$();
      }, $prop$$54$$;
      for ($prop$$54$$ in $defaults$$1$$) {
        if ($i$$85_val$$19$$ = $constructorOptions$$3$$[$prop$$54$$], void 0 === $i$$85_val$$19$$ || $$$$3$$.isPlainObject($i$$85_val$$19$$)) {
          $callback$$80_defaultVal$$1_props$$4$$ = $defaults$$1$$[$prop$$54$$], null != $callback$$80_defaultVal$$1_props$$4$$ && $callback$$80_defaultVal$$1_props$$4$$ instanceof $__ojDynamicGetter$$ ? ($callback$$80_defaultVal$$1_props$$4$$ = $callback$$80_defaultVal$$1_props$$4$$.$getCallback$(), $$$$3$$.isFunction($callback$$80_defaultVal$$1_props$$4$$) ? $_defineDynamicProperty$$(this, $originalDefaults$$2$$[$prop$$54$$], $i$$85_val$$19$$, $options$$123$$, $prop$$54$$, $callback$$80_defaultVal$$1_props$$4$$, 
          $allProperties_contextCallback$$1$$) : $oj$$3$$.$Logger$.error("Dynamic getter for property %s is not a function", $prop$$54$$)) : $options$$123$$[$prop$$54$$] = $_mergeOptionLayers$$([$originalDefaults$$2$$[$prop$$54$$], $callback$$80_defaultVal$$1_props$$4$$, $i$$85_val$$19$$]);
        }
      }
    }
  ...
  $$$$3$$(document).ready(function() {
    var $div$$inline_485$$ = $$$$3$$("\x3cdiv style\x3d'border: 1px solid;border-color:red green;position: absolute;top: -999px;background-image: url(data:image/gif;base64,R0lGODlhAQABAIAAAP///wAAACwAAAAAAQABAAACAkQBADs\x3d);'\x3e\x3c/div\x3e"), $bki$$inline_486$$;
    $div$$inline_485$$.appendTo("body");
    $bki$$inline_486$$ = $div$$inline_485$$.css("backgroundImage");
    $div$$inline_485$$.css("borderTopColor") != $div$$inline_485$$.css("borderRightColor") && (null == $bki$$inline_486$$ || "none" != $bki$$inline_486$$ && "url (invalid-url:)" != $bki$$inline_486$$) || $$$$3$$("body").addClass("oj-hicontrast");
    $div$$inline_485$$.remove();
  });
  $oj$$3$$.$DomUtils$ = {};
  ...
  $oj$$3$$.$DomUtils$.$addResizeListener$ = function $$oj$$3$$$$DomUtils$$$addResizeListener$$($elem$$17$$, $listener$$32$$, $collapseEventTimeout$$) {
    var $jelem$$2$$ = $$$$3$$($elem$$17$$), $tracker$$ = $jelem$$2$$.data($oj$$3$$.$DomUtils$.$_RESIZE_TRACKER_KEY$);
    null == $tracker$$ && ($tracker$$ = new $oj$$3$$.$DomUtils$.$_ResizeTracker$($elem$$17$$), $jelem$$2$$.data($oj$$3$$.$DomUtils$.$_RESIZE_TRACKER_KEY$, $tracker$$), $tracker$$.start());
    $tracker$$.addListener($listener$$32$$, $collapseEventTimeout$$);
  };
  $oj$$3$$.$DomUtils$.$removeResizeListener$ = function $$oj$$3$$$$DomUtils$$$removeResizeListener$$($elem$$18$$, $listener$$33$$) {
    var $jelem$$3$$ = $$$$3$$($elem$$18$$), $tracker$$1$$ = $jelem$$3$$.data($oj$$3$$.$DomUtils$.$_RESIZE_TRACKER_KEY$);
  ...
  $oj$$3$$.$DomUtils$.$isChromeEvent$ = function $$oj$$3$$$$DomUtils$$$isChromeEvent$$($JSCompiler_temp$$12_event$$38$$) {
    function $_isChromeEventWebkit$$($event$$41$$) {
      var $domTarget$$ = $event$$41$$.target, $target$$73$$ = $$$$3$$($domTarget$$), $pos$$ = $domTarget$$.getBoundingClientRect(), $sbw$$ = $oj$$3$$.$DomUtils$.$getScrollBarWidth$(), $isLTR$$ = "ltr" === $oj$$3$$.$DomUtils$.$getReadingDirection$();
      return $isLTR$$ && ("HTML" === $domTarget$$.nodeName || "visible" !== $target$$73$$.css("overflow-x")) && $event$$41$$.clientX > $pos$$.right - $sbw$$ ? !0 : !$isLTR$$ && "HTML" === $domTarget$$.nodeName && $event$$41$$.clientX > $pos$$.left - $sbw$$ ? !0 : !$isLTR$$ && "visible" !== $target$$73$$.css("overflow-x") && $event$$41$$.clientX < $pos$$.left + $sbw$$ ? !0 : ("HTML" === $domTarget$$.nodeName || "visible" !== $target$$73$$.css("overflow-y")) && $event$$41$$.clientY > $pos$$.bottom - 
      $sbw$$ ? !0 : !1;
    }
    if (!("clientX" in $JSCompiler_temp$$12_event$$38$$ && "clientY" in $JSCompiler_temp$$12_event$$38$$)) {
      return!1;
    }
    ...
    if ($oj$$3$$.$AgentUtils$.$OS$.$ANDROID$ === $agentInfo$$1$$.os || $oj$$3$$.$AgentUtils$.$OS$.$IOS$ === $agentInfo$$1$$.os) {
      $JSCompiler_temp$$12_event$$38$$ = !1;
    } else {
      var $JSCompiler_temp$$13$$;
      if ($oj$$3$$.$AgentUtils$.$ENGINE$.$GECKO$ === $agentInfo$$1$$.engine) {
        try {
          $JSCompiler_temp$$13$$ = $JSCompiler_temp$$12_event$$38$$.originalTarget.localName ? !1 : !0;
        } catch ($e$$inline_489$$) {
          $JSCompiler_temp$$13$$ = !0;
        }
      } else {
        $JSCompiler_temp$$13$$ = $oj$$3$$.$AgentUtils$.$ENGINE$.$WEBKIT$ === $agentInfo$$1$$.engine ? $_isChromeEventWebkit$$($JSCompiler_temp$$12_event$$38$$) : $oj$$3$$.$AgentUtils$.$BROWSER$.$IE$ === $agentInfo$$1$$.browser ? $_isChromeEventWebkit$$($JSCompiler_temp$$12_event$$38$$) : !1;
      }
      $JSCompiler_temp$$12_event$$38$$ = $JSCompiler_temp$$13$$;
    }
    return $JSCompiler_temp$$12_event$$38$$;
  };
  ...
  $oj$$3$$.$DomUtils$.$isWithinViewport$ = function $$oj$$3$$$$DomUtils$$$isWithinViewport$$($element$$26_parent$$2$$) {
    ...
    function $getRect$$($element$$28$$) {
      var $domElement_rec$$ = $element$$28$$[0];
      return 1 === $domElement_rec$$.nodeType ? ($domElement_rec$$ = $domElement_rec$$.getBoundingClientRect(), $domElement_rec$$.overflowX = $element$$28$$.css("overflow-x"), $domElement_rec$$.overflowY = $element$$28$$.css("overflow-y"), $domElement_rec$$) : $$$$3$$.isWindow($domElement_rec$$) ? $domElement_rec$$ = {width:$domElement_rec$$.innerWidth, height:$domElement_rec$$.innerHeight, top:0, bottom:$domElement_rec$$.innerHeight, left:0, right:$domElement_rec$$.innerWidth} : {height:0, width:0};
    }
    if (!$element$$26_parent$$2$$) {
      return!1;
    }
    var $alignBox$$ = $getRect$$($element$$26_parent$$2$$), $isWithinViewPort$$ = !0;
    for ($element$$26_parent$$2$$ = $element$$26_parent$$2$$.parent();$isWithinViewPort$$ && $element$$26_parent$$2$$ && 0 < $element$$26_parent$$2$$.length && 1 === $element$$26_parent$$2$$[0].nodeType;) {
      if ($hasOverflow$$($element$$26_parent$$2$$)) {
        var $parentBox$$ = $getRect$$($element$$26_parent$$2$$);
        0 < $parentBox$$.height && 0 < $parentBox$$.width && ($isWithinViewPort$$ = $isVisible$$($alignBox$$, $parentBox$$));
      }
      $element$$26_parent$$2$$ = $element$$26_parent$$2$$.parent();
    }
  ...
  $oj$$3$$.$DomUtils$.$setLogicalParent$ = function $$oj$$3$$$$DomUtils$$$setLogicalParent$$($element$$30$$, $parent$$3$$) {
    $element$$30$$ && (null === $parent$$3$$ ? $element$$30$$.removeData($oj$$3$$.$DomUtils$.$_LOGICAL_PARENT_DATA$) : $element$$30$$.data($oj$$3$$.$DomUtils$.$_LOGICAL_PARENT_DATA$, $parent$$3$$));
  };
  ...
  $oj$$3$$.$DomUtils$.$_supressNativeContextMenu$ = function $$oj$$3$$$$DomUtils$$$_supressNativeContextMenu$$() {
    $$$$3$$(document.body).hasClass("oj-hybrid") && document.body.addEventListener("contextmenu", function($event$$42$$) {
      $event$$42$$.preventDefault();
    }, !0);
  };
  ...
  $oj$$3$$.$Test$.$domNodeForLocator$ = function $$oj$$3$$$$Test$$$domNodeForLocator$$($element$$35_locator$$3_widgetConst$$) {
    var $locObj$$ = $element$$35_locator$$3_widgetConst$$;
    if ($oj$$3$$.$StringUtils$.$isString$($element$$35_locator$$3_widgetConst$$)) {
      try {
        $locObj$$ = $$$$3$$.parseJSON($element$$35_locator$$3_widgetConst$$);
      } catch ($e$$30$$) {
        return null;
      }
    }
    return $locObj$$ && $locObj$$.element && ($element$$35_locator$$3_widgetConst$$ = $$$$3$$($locObj$$.element)) ? ($element$$35_locator$$3_widgetConst$$ = $oj$$3$$.Components.$getWidgetConstructor$($element$$35_locator$$3_widgetConst$$[0], $locObj$$.component), delete $locObj$$.element, $element$$35_locator$$3_widgetConst$$("getNodeBySubId", $locObj$$)) : null;
  };
