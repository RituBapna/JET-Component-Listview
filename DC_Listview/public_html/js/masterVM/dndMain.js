requirejs.config({
  paths: {
    ...
    'dndVM' : '../js/masterVM/bindingApp/DnDApp'
  },
  shim: {
    'jquery': {
      exports: ['jQuery', '$']
...
require(['ojs/ojcore', 'knockout', 'dndVM', 'ojs/ojcomponents', 'ojs/ojknockout', 
    'ojs/ojtable', 'ojs/ojtable-model', 'ojs/ojselectcombobox'], // add additional JET component libraries as needed
  function(oj, ko,dndvm) // this callback gets executed when all required modules are loaded
  {
